...
@section('content')
    ...
    <section class="py-24 bg-white relative">
        <div class="max-w-4xl mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-5xl text-gray-900 mb-4 font-black">{{ __('pm_cycle_title') }}</h2>
            ...
            <div class="relative">
                ...
                <div class="space-y-12">
                    ...
                    <div class="relative flex flex-col md:flex-row items-center gap-8 group">
                        ...
                        <div class="absolute left-0 md:relative md:left-auto order-1 md:order-2 w-16 h-16 bg-white border-4 border-blue-100 rounded-full flex items-center justify-center text-3xl shadow-lg z-10 group-hover:scale-110 transition group-hover:border-blue-500 font-black">
                            👔
                        </div>
                    ...
                    <div class="relative flex flex-col md:flex-row items-center gap-8 group">
                        ...
                        <div class="absolute left-0 md:relative md:left-auto order-1 md:order-2 w-16 h-16 bg-white border-4 border-slate-200 rounded-full flex items-center justify-center text-3xl shadow-lg z-10 group-hover:scale-110 transition group-hover:border-slate-500 font-black">
                            📉
                        </div>
                    ...
                    <div class="relative flex flex-col md:flex-row items-center gap-8 group">
                        ...
                        <div class="absolute left-0 md:relative md:left-auto order-1 md:order-2 w-16 h-16 bg-white border-4 border-red-100 rounded-full flex items-center justify-center text-3xl shadow-lg z-10 group-hover:scale-110 transition group-hover:border-red-500 font-black">
                            🏃
                        </div>
                        <div class="order-3 md:w-1/2 hidden md:block"></div>
                    </div>
    ...
    <section class="py-32 bg-slate-900 relative overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div>
                ...
                <h2 class="text-4xl md:text-5xl mb-6 text-white leading-tight font-black">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-4">
                    ...
                    <h2 class="text-4xl mb-6 text-gray-900 leading-tight font-black">
    ...
    <section class="py-24 bg-white border-t border-gray-100">
        <div class="max-w-5xl mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-5xl text-gray-900 mb-6 font-black">{{ __('pm_compare_title') }}</h2>
                    ...
                    <ul class="space-y-6">
                        ...
                        <li class="flex items-center justify-between">
                         ...
                         <li class="flex items-center justify-between pt-4 border-t border-gray-100">
                            ...
                            <span class="text-sm text-white bg-indigo-600 px-3 py-1 rounded-lg shadow-lg shadow-indigo-200">{{ __('pm_table_row_4_col_2') }}</span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            <div class="bg-white border-b-8 border-indigo-600 rounded-[3rem] p-8 md:p-20 shadow-2xl relative overflow-hidden group">
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        <div class="inline-flex items-center gap-2 px-3 py-1 bg-blue-100 text-blue-700 text-[10px] uppercase tracking-[0.4em] mb-12 rounded-full border border-blue-200">
                            🧬 {{ __('pm_science_badge') }}
                        </div>
                        ...
                        <div class="relative py-12 px-12 bg-indigo-50/50 rounded-2xl mb-12 border border-indigo-100 group-hover:bg-indigo-50 transition duration-500">
                             <span class="absolute -top-4 -left-4 text-4xl font-black">📐</span>
                        ...
                        <div class="bg-slate-900 aspect-square rounded-[3rem] p-10 flex flex-col justify-between text-white shadow-2xl transform lg:rotate-3 group-hover:rotate-0 transition duration-700">
                            <div class="flex justify-between items-start">
                                ...
                                <div class="text-right">
                                    <p class="text-[10px] text-indigo-400 uppercase tracking-widest">Efficiency_Index</p>
