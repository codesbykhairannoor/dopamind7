                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between text-sm font-bold text-gray-600">
                         ...
                         <div class="flex items-center gap-3 text-sm font-bold text-indigo-600 bg-indigo-50 p-3 rounded-xl">
                            <span class="animate-pulse">●</span> {{ __('blank_mockup_insight') }}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-center gap-4 group">
                                <div class="w-12 h-12 rounded-xl bg-green-100 text-green-600 flex items-center justify-center text-xl group-hover:scale-110 transition">💰</div>
                                <div>
                            ...
                            <div class="flex items-center gap-4 group">
                                <div class="w-12 h-12 rounded-xl bg-orange-100 text-orange-600 flex items-center justify-center text-xl group-hover:scale-110 transition">⚡</div>
                                <div>
                            ...
                            <div class="flex items-center gap-4 group">
                                <div class="w-12 h-12 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center text-xl group-hover:scale-110 transition">🧠</div>
                                <div>
                    ...
                    <div class="relative h-[400px] bg-gray-50 rounded-[2rem] border-2 border-dashed border-gray-200 flex items-center justify-center">
                        ...
                        <div class="absolute w-64 h-64 border border-gray-300 rounded-full animate-[spin_10s_linear_infinite]">
                            <div class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-white border border-gray-200 shadow-sm rounded-full flex items-center justify-center">💰</div>
                        </div>
                        <div class="absolute w-80 h-80 border border-gray-200 rounded-full animate-[spin_15s_linear_infinite_reverse]">
                            <div class="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-10 h-10 bg-white border border-gray-200 shadow-sm rounded-full flex items-center justify-center">🧠</div>
                        </div>
                    </div>
                </div>
            </div>
