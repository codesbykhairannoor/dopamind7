...
<body hx-boost="true" hx-swap="innerHTML"
                    ...
                    <div>
                        ...
                        <ul class="space-y-4 text-sm font-bold text-slate-700">
                            <li><a href="{{ route('compare.paper') }}" class="hover:text-indigo-600 transition">Vs.
                                    Paper Planner</a></li>
                            <li><a href="{{ route('compare.sheets') }}" class="hover:text-indigo-600 transition">Vs.
                                    Excel/Sheets</a></li>
    ...
    <div x-show="isInterfacing" x-transition:enter="transition ease-out duration-500"
        ...
        <div class="relative z-10 flex flex-col items-center">
            ...
            <div class="relative mb-12">
                ...
                <div
                    class="w-24 h-24 bg-indigo-600 rounded-[2.5rem] flex items-center justify-center shadow-[0_0_50px_rgba(79,70,229,0.2)] animate-bounce duration-[2000ms]">
            ...
            <div class="text-center">
                ...
                <div class="space-y-2">
                    <p class="text-indigo-600 font-mono text-[10px] font-black uppercase tracking-[0.3em] opacity-80"
                        x-data="{ text: 'Syncing cognitive maps...', index: 0 }"
                        x-init="setInterval(() => { index = (index + 1) % 3; text = ['Syncing cognitive maps...', 'Analyzing behavioral patterns...', 'Calibrating growth metrics...'][index] }, 800)"
                        x-text="text"></p>
                </div>
            </div>
        </div>
