...
<head>
    ...
    {{-- Schema is now injected dynamically via Inertia <Head> tags from individual Vue components --}}
    ...
    @if(auth()->check())
        fbq('init', '951954810888805', {
            ...
            fn: '{{ hash("sha256", strtolower(trim(explode(" ", auth()->user()->name)[0]))) }}',
    ...
    <noscript>
        <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=951954810888805&ev=PageView&noscript=1" />
    </noscript>
    <!-- End Meta Pixel Code -->
