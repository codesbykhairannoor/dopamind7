...
@section('content')
 ...
 <div class="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-bl from-indigo-200/40 to-purple-200/40 rounded-full blur-3xl -z-10 "></div>
 ...
 <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-white/90 rounded-full shadow-2xl border border-white flex flex-col items-center justify-center z-20 hover:scale-105 transition duration-500">
 ...
 <div class="absolute top-0 left-0 w-[600px] h-[600px] bg-purple-600 rounded-full mix-blend-screen filter blur-3xl opacity-40 "></div>
 <div class="absolute bottom-0 right-0 w-[600px] h-[600px] bg-indigo-500 rounded-full mix-blend-screen filter blur-3xl opacity-40 delay-1000"></div>
 ...
 <div class="bg-white/10 border border-white/20 rounded-[3rem] p-8 md:p-16 text-left shadow-2xl relative overflow-hidden group transform hover:scale-[1.01] transition duration-500">
 ...
 <div class="bg-white/20 px-4 py-2 rounded-full text-indigo-100 font-bold text-sm tracking-widest uppercase ">Zen Entry</div>
 </div>
 ...
 <span class="bg-black/30 text-white text-xs font-bold px-4 py-2 rounded-full ">Deep Work</span>
 <span class="bg-black/30 text-white text-xs font-bold px-4 py-2 rounded-full ">Clarity</span>
 </div>
 </div>
 </div>
 </section>
