...
@section('content')
 ...
 <div class="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-indigo-400/20 rounded-full blur-3xl opacity-60 animate-pulse -z-10"></div>
 <div class="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-blue-300/20 rounded-full blur-3xl opacity-50 animate-pulse delay-1000 -z-10"></div>
 
 <div class="max-w-5xl mx-auto text-center relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
 
 {{-- Icon / Gambar Dulu --}}
 <div class="flex justify-center mb-8">
 <div class="w-24 h-24 bg-white/80 border border-indigo-100 rounded-[2rem] shadow-xl shadow-indigo-100 flex items-center justify-center text-4xl transform -rotate-3 hover:rotate-0 transition duration-300 font-black">
 🧠
 </div>
 </div>
 ...
 <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-indigo-500 rounded-full blur-3xl opacity-20"></div>

 {{-- Node 1: Capture --}}
 <div class="absolute left-4 md:left-12 top-8 md:top-16 bg-white/10 p-5 rounded-3xl border border-white/10 z-10 transform -rotate-6 animate-[float_4s_ease-in-out_infinite] shadow-2xl">
 ...
 <div class="absolute bg-indigo-600/20 p-8 rounded-[2.5rem] border border-indigo-400/30 shadow-[0_0_50px_rgba(79,70,229,0.3)] z-20 scale-110">
 <div class="flex flex-col items-center">
 <span class="text-4xl mb-3 drop-shadow-lg font-black">🔮</span>
 <h4 class="font-black text-white tracking-widest uppercase text-sm">{{ __('brain_mockup_2') }}</h4>
 </div>
 </div>

 {{-- Node 3: Execute --}}
 <div class="absolute right-4 md:right-12 bottom-8 md:bottom-16 bg-white/10 p-5 rounded-3xl border border-white/10 z-10 transform rotate-6 animate-[float_5s_ease-in-out_infinite_reverse] shadow-2xl">
 ...
 <div class="text-5xl mb-4 animate-bounce font-black">🤯</div>
 ...
 <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-indigo-600/20 rounded-full blur-3xl pointer-events-none -z-10"></div>
 ...
 <div class="flex items-center justify-center w-24 h-24 rounded-full border-8 border-slate-900 bg-indigo-600 text-3xl shadow-xl shrink-0 z-10 transform group-hover:scale-110 transition duration-300 md:order-1 md:absolute md:left-1/2 md:-translate-x-1/2 font-black">🎣</div>
 <div class="w-[calc(100%-7rem)] md:w-[calc(50%-4rem)] bg-slate-800/50 p-8 rounded-3xl border border-slate-700 shadow-xl group-hover:border-indigo-500/50 transition duration-300">
 ...
 <div class="flex items-center justify-center w-24 h-24 rounded-full border-8 border-slate-900 bg-blue-600 text-3xl shadow-xl shrink-0 z-10 transform group-hover:scale-110 transition duration-300 md:order-1 md:absolute md:left-1/2 md:-translate-x-1/2 font-black">🗄️</div>
 <div class="w-[calc(100%-7rem)] md:w-[calc(50%-4rem)] bg-slate-800/50 p-8 rounded-3xl border border-slate-700 shadow-xl group-hover:border-blue-500/50 transition duration-300 md:ml-auto">
 ...
 {{-- Step 3 --}}
 <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
 <div class="flex items-center justify-center w-24 h-24 rounded-full border-8 border-slate-900 bg-emerald-500 text-3xl shadow-xl shrink-0 z-10 transform group-hover:scale-110 transition duration-300 md:order-1 md:absolute md:left-1/2 md:-translate-x-1/2 font-black">✨</div>
 <div class="w-[calc(100%-7rem)] md:w-[calc(50%-4rem)] bg-slate-800/50 p-8 rounded-3xl border border-slate-700 shadow-xl group-hover:border-emerald-500/50 transition duration-300">
 ...
 <div class="w-14 h-14 bg-indigo-500/20 rounded-2xl flex items-center justify-center text-3xl font-black">🧠</div>
 <h3 class="text-3xl text-white font-black">{{ __('brain_hub_title') }}</h3>
 </div>
 ...
 <div class="w-16 h-16 bg-indigo-600 text-white rounded-2xl flex items-center justify-center text-3xl shadow-lg mb-8 font-black">📥</div>
 <div>
 <h4 class="text-2xl text-indigo-950 mb-3">{{ __('brain_feat_1_title') }}</h4>
 ...
 <div class="w-16 h-16 bg-white/10 text-white rounded-2xl flex items-center justify-center text-3xl shadow-lg mb-8 font-black">📓</div>
 <div>
 <h4 class="text-2xl mb-3">{{ __('brain_feat_2_title') }}</h4>
 ...
 <span class="w-12 h-12 rounded-xl bg-rose-50 text-rose-600 flex items-center justify-center text-lg">1</span>
 ...
 <span class="w-12 h-12 rounded-xl bg-orange-50 text-orange-600 flex items-center justify-center text-lg">2</span>
 ...
 <span class="w-12 h-12 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center text-lg">3</span>
 ...
 <div class="text-8xl mb-6 animate-bounce font-black">📁</div>
 <div class="text-white text-3xl font-black">{{ __('brain_extra_1_viz_title') }}</div>
 </div>
 </div>
 </div>
 </div>
 ...
 <span class="px-6 py-3 bg-white/10 rounded-full border border-white/20 text-sm font-bold">{{ __('brain_extra_2_item_1') }}</span>
 <span class="px-6 py-3 bg-white/10 rounded-full border border-white/20 text-sm font-bold">{{ __('brain_extra_2_item_2') }}</span>
 <span class="px-6 py-3 bg-white/10 rounded-full border border-white/20 text-sm font-bold">{{ __('brain_extra_2_item_3') }}</span>
 </div>
 </div>
 </div>
 </section>
 ...
 <div>
 <div class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-[10px] uppercase tracking-[0.3em] mb-10 rounded-lg">
 ...
 <div class="relative py-12 px-10 bg-white/5 border border-white/10 rounded-[3rem] mb-12 shadow-2xl">
 ...
 <p class="text-indigo-100 text-xl md:text-3xl font-serif italic leading-relaxed font-black">
 ...
 <p class="text-[10px] text-indigo-400 uppercase tracking-widest mb-1 group-hover:text-white">Active_Link_01</p>
 ...
 <p class="text-[10px] text-purple-400 uppercase tracking-widest mb-1 group-hover:text-white">Active_Link_02</p>
 ...
 <p class="text-[10px] text-emerald-400 uppercase tracking-widest mb-1 group-hover:text-white">Active_Link_03</p>
 ...
 <div class="bg-black/20 px-6 py-2 rounded-full border border-white/10 inline-block text-xs uppercase tracking-widest">
 ...
 <div class="absolute -top-32 -right-32 w-64 h-64 bg-indigo-500 rounded-full blur-3xl opacity-50"></div>
 <div class="absolute -bottom-32 -left-32 w-64 h-64 bg-purple-500 rounded-full blur-3xl opacity-30"></div>
 ...
 <a hx-boost="false" href="{{ route('register') }}" class="inline-flex items-center justify-center gap-3 bg-white text-indigo-950 px-12 py-5 rounded-full text-xl hover:bg-indigo-50 shadow-[0_10px_25px_rgba(255,255,255,0.2)] transition transform hover:-translate-y-1 w-full sm:w-auto">
 {{ __('brain_cta_btn') }}
