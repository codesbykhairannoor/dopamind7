...
@section('content')
 ...
 <p class="text-indigo-300 text-[10px] font-bold uppercase tracking-widest mb-1">{{ __('finance_mockup_assets') }}</p>
 <h3 class="text-3xl font-black">Rp 42.500.000</h3>
 <div class="mt-4 flex gap-2">
 <span class="px-2 py-1 bg-white/10 rounded-md text-[10px] font-bold">{{ __('finance_mockup_growth') }}</span>
 </div>
 </div>
 
 <div class="grid grid-cols-2 gap-4">
 <div class="p-4 bg-emerald-50 rounded-2xl border border-emerald-100">
 <p class="text-emerald-600 text-[10px] font-bold uppercase mb-1">{{ __('finance_mockup_income') }}</p>
 <p class="font-black text-emerald-950">Rp 12,5M</p>
 </div>
 <div class="p-4 bg-rose-50 rounded-2xl border border-rose-100">
 <p class="text-rose-600 text-[10px] font-bold uppercase mb-1">{{ __('finance_mockup_expenses') }}</p>
 ...
 <h4 class="text-[10px] uppercase text-gray-500">{{ __('finance_mockup_goal') }}</h4>
 ...
 {{-- Elegant subtle glow --}}
 <div class="absolute top-0 right-0 w-[500px] h-[500px] bg-indigo-500/20 rounded-full blur-3xl pointer-events-none"></div>
 ...
 <div class="bg-indigo-500/20 p-6 rounded-full border border-indigo-500/30 mb-4 ">
 <span class="text-5xl font-black">🏦</span>
 </div>
 <h4 class="text-2xl tracking-widest uppercase text-indigo-400">{{ __('finance_science_viz_title') }}</h4>
 <p class="text-slate-400 text-sm mt-2">{{ __('finance_science_viz_sub') }}</p>
 </div>
 </div>
 ...
 <div class="text-4xl mb-4 font-black">☕</div>
 <p class="font-bold text-gray-900">{{ __('finance_synergy_habit_title') }}</p>
 <p class="text-sm text-gray-500">"{{ __('finance_synergy_habit_desc') }}"</p>
 </div>
 ...
 <div class="text-4xl mb-4 font-black">💰</div>
 <p class="font-bold text-indigo-100">{{ __('finance_synergy_alloc_title') }}</p>
 <p class="text-2xl mt-1">{{ __('finance_synergy_alloc_amount') }}</p>
 </div>
 </div>
 </div>
 </section>
 ...
 <div class="inline-block p-8 bg-white/5 rounded-3xl border border-white/10 ">
 <div class="text-6xl text-indigo-400 mb-2 font-black">18</div>
 <div class="text-xs uppercase tracking-widest text-slate-500">{{ __('finance_extra_2_label') }}</div>
 </div>
 </div>
 </section>
 ...
 <div>
 <div class="inline-flex items-center gap-2 px-3 py-1 bg-slate-900 text-white text-[10px] uppercase tracking-[0.3em] mb-10">
 ...
 <div class="space-y-4">
 <div class="flex items-center justify-between p-4 border-b border-slate-100 hover:bg-slate-50 transition uppercase tracking-tighter text-xs text-slate-500">
 <span>Core Principle 01</span>
 <span class="text-slate-900">{{ __('finance_science_principle_1_title') }}</span>
 </div>
 <div class="flex items-center justify-between p-4 border-b border-slate-100 hover:bg-slate-50 transition uppercase tracking-tighter text-xs text-slate-500">
 <span>Core Principle 02</span>
 <span class="text-slate-900">{{ __('finance_science_principle_2_title') }}</span>
 </div>
 <div class="flex items-center justify-between p-4 border-b border-slate-100 hover:bg-slate-50 transition uppercase tracking-tighter text-xs text-slate-500">
 <span>Core Principle 03</span>
 <span class="text-slate-900">{{ __('finance_science_principle_3_title') }}</span>
 </div>
 </div>
 </div>
 ...
 <div class="absolute top-12 right-12 text-6xl opacity-20 font-black">📐</div>
 <div class="absolute bottom-12 right-12 text-right">
 <p class="text-[10px] font-mono text-slate-400 uppercase tracking-widest">{{ __('finance_science_viz_status_badge') }}</p>
 <p class="text-2xl text-slate-900">{{ __('finance_science_viz_status_title') }}</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <a hx-boost="false" href="{{ route('register') }}" class="inline-block bg-indigo-600 text-white px-12 py-5 rounded-full text-xl hover:bg-indigo-700 transition-colors duration-300 shadow-[0_20px_40px_rgba(79,70,229,0.3)]">
