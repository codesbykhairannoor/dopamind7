...
@section('content')
 ...
 <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-indigo-400/20 rounded-full blur-3xl pointer-events-none -z-10"></div>
 ...
 <div class="bg-gradient-to-br from-indigo-600/20 to-purple-600/20 rounded-[3rem] p-12 md:p-20 border border-white/10 ">
 ...
 {{-- Glow Effect --}}
 <div class="absolute -top-24 -left-24 w-96 h-96 bg-indigo-600 rounded-full blur-3xl opacity-20"></div>
 ...
 <div class="relative py-12 px-10 bg-white/5 rounded-[3rem] mb-12 border border-white/10">
