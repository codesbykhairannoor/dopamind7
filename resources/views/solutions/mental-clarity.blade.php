    ...
    <section class="py-24 bg-white">
        <div class="max-w-6xl mx-auto px-6">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-3xl md:text-5xl font-black mb-6 text-gray-900">{{ __('solve_mental_prob_title') }}</h2>
            </div>
            <div class="grid md:grid-cols-2 gap-8">
                <div class="p-10 bg-gray-50 rounded-[2.5rem] border border-gray-100 italic font-serif">
                    <h3 class="text-2xl font-bold mb-4 text-gray-900">{{ __('solve_mental_feat_1_title') }}</h3>
                    <p class="text-gray-600 leading-relaxed text-lg">{{ __('solve_mental_feat_1_desc') }}</p>
                </div>
                <div class="p-10 bg-indigo-950 rounded-[2.5rem] text-white shadow-xl">
                    <h3 class="text-xl font-bold mb-4 text-indigo-300">{{ __('solve_mental_feat_2_title') }}</h3>
                    <p class="text-indigo-100/70 leading-relaxed">{{ __('solve_mental_feat_2_desc') }}</p>
                </div>
            </div>
        </div>
    </section>
