...
<section class="py-16 md:py-32 bg-slate-900 text-white relative overflow-hidden">
 ...
 {{-- Back Card --}}
 <div class="absolute w-64 h-80 md:w-80 md:h-96 bg-white/5 rounded-[2.5rem] md:rounded-[3rem] border border-white/10 transform -rotate-6 translate-x-8 md:translate-x-12 translate-y-6 p-8 flex flex-col justify-end">
 ...
 <div class="absolute w-72 md:w-96 h-auto bg-white/10 rounded-[2.5rem] md:rounded-[3rem] border border-white/20 shadow-2xl p-6 md:p-8 transform rotate-3 hover:rotate-0 transition duration-500 z-10">
