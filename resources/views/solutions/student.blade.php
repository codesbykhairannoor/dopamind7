...
@section('content')
 ...
 <div class="bg-gray-50/90 px-6 py-4 border-b border-gray-100 flex items-center justify-between flex-shrink-0">
 ...
 <span class="bg-rose-100 text-rose-700 text-[10px] uppercase px-3 py-1 rounded-full">{{ __('student_mockup_task_badge') }}</span>
 ...
 <h2 class="text-5xl md:text-6xl mb-6 text-gray-900 font-black">{{ __('student_prob_title') }}</h2>
 ...
 <div class="inline-block bg-white/10 border border-white/20 text-white font-bold px-6 py-3 rounded-full">
 ...
 <h2 class="text-5xl md:text-6xl mb-6 text-gray-900 font-black">{{ __('student_feat_1_title') }}</h2>
 ...
 <h2 class="text-5xl md:text-6xl mb-6 text-gray-900 font-black">{{ __('student_feat_2_title') }}</h2>
 <p class="text-gray-500 text-lg leading-relaxed mb-8">
 ...
 <h2 class="text-5xl md:text-6xl text-gray-900 mb-4 font-black">{{ __('student_bento_title') }}</h2>
 ...
 <div class="text-3xl mb-4 relative z-10 font-black">🚀</div>
 ...
 <div>
 <h2 class="text-5xl md:text-6xl text-gray-900 mb-6 font-black">{{ __('student_extra_1_title') }}</h2>
 ...
 <h2 class="text-5xl md:text-6xl text-indigo-950 mb-8 font-black">{{ __('student_extra_2_title') }}</h2>
 ...
 <div class="text-xs text-indigo-400 uppercase">{{ __('student_extra_2_item_1') }}</div>
 </div>
 <div class="bg-white p-6 rounded-3xl shadow-sm">
 <div class="text-2xl mb-2">📚</div>
 <div class="text-xs text-indigo-400 uppercase">{{ __('student_extra_2_item_2') }}</div>
 </div>
 <div class="bg-white p-6 rounded-3xl shadow-sm">
 <div class="text-2xl mb-2">🍔</div>
 <div class="text-xs text-indigo-400 uppercase">{{ __('student_extra_2_item_3') }}</div>
 </div>
 <div class="bg-white p-6 rounded-3xl shadow-sm border-2 border-indigo-500">
 <div class="text-2xl mb-2">💎</div>
 <div class="text-xs text-indigo-600 uppercase">{{ __('student_extra_2_item_4') }}</div>
 </div>
 </div>
 </div>
 </section>
 ...
 <div>
 <div class="inline-flex items-center gap-2 px-3 py-1 bg-indigo-600 text-white text-[10px] uppercase tracking-[0.2em] mb-8 shadow-lg shadow-indigo-200">
 🧬 {{ __('student_science_badge') }}
 </div>
 
 <h2 class="text-5xl leading-[1.1] md:text-6xl text-gray-900 mb-8 leading-tight tracking-tight font-black">
 ...
 <div class="w-48 h-48 bg-white border border-indigo-100 rounded-[2rem] shadow-xl flex items-center justify-center text-5xl transform rotate-12 group-hover:rotate-0 transition duration-700 font-black">📚</div>
 </div>
 {{-- Orbital Bubbles --}}
 ...
 <h2 class="text-5xl md:text-6xl text-center text-gray-900 mb-16 font-black">{{ __('student_faq_title') }}</h2>
 <div class="space-y-6">
 @foreach([1, 2, 3] as $i)
 ...
 <div class="absolute top-0 right-0 w-[800px] h-[800px] bg-purple-500 rounded-full mix-blend-screen filter blur-3xl opacity-40 -z-10 "></div>
 ...
 <a hx-boost="false" href="{{ route('register') }}" class="inline-block bg-white text-indigo-900 px-12 py-5 rounded-2xl text-lg hover:bg-indigo-50 transition transform hover:scale-105 shadow-2xl">
 {{ __('student_cta_btn') }}
 </a>
 </div>
 </section>
