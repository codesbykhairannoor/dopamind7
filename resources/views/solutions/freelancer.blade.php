...
<header class="pt-32 pb-24 px-6 overflow-hidden bg-gradient-to-br from-gray-50 via-white to-slate-50 relative border-b border-gray-100">
 ...
 {{-- Background Glow --}}
 <div class="absolute inset-0 bg-gradient-to-br from-sky-400 to-indigo-500 rounded-full blur-3xl opacity-20 "></div>
 
 {{-- 1. Center Piece: Freelancer ID Card --}}
 <div class="absolute z-20 w-72 bg-white/90 rounded-3xl shadow-2xl border border-white p-6 transform hover:scale-105 transition duration-500">
 ...
 <div class="absolute bottom-4 right-10 z-10 bg-white/80 rounded-full px-4 py-2 shadow-sm border border-slate-100 flex items-center gap-2">
 ...
 <h2 class="text-5xl md:text-5xl mb-6 text-gray-900 font-black">{{ __('freelance_prob_title') }}</h2>
 ...
 <div class="absolute -right-40 -top-40 w-[600px] h-[600px] bg-indigo-600 rounded-full blur-3xl opacity-20"></div>
 ...
 <div class="bg-slate-800/80 p-4 rounded-2xl border border-slate-700 flex justify-between items-center transform transition hover:translate-x-2 cursor-pointer">
 <div>
 ...
 <h2 class="text-5xl md:text-6xl mb-6 text-white font-black">{{ __('freelance_feat_1_title') }}</h2>
 ...
 <h2 class="text-5xl md:text-6xl text-gray-900 mb-4 font-black">{{ __('freelance_bento_title') }}</h2>
 ...
 <h2 class="text-5xl md:text-6xl mb-6 leading-tight font-black">{{ __('freelance_extra_1_title') }}</h2>
 ...
 <h2 class="text-5xl md:text-6xl text-gray-900 mb-8 font-black">{{ __('freelance_extra_2_title') }}</h2>
 ...
 <div class="bg-slate-800/50 border border-slate-700 rounded-[3rem] p-10 md:p-20 shadow-2xl relative overflow-hidden group">
 ...
 <h2 class="text-5xl md:text-6xl text-white mb-10 leading-tight font-black">
 ...
 <h2 class="text-5xl md:text-6xl text-center text-gray-900 mb-16 font-black">{{ __('freelance_faq_title') }}</h2>
 <div class="space-y-6">
 @foreach([1, 2, 3] as $i)
 ...
 <div class="absolute -right-20 -bottom-20 w-64 h-64 bg-indigo-500 rounded-full blur-3xl opacity-30"></div>
 
 <h2 class="text-6xl md:text-6xl mb-8 text-white tracking-tight font-black">{{ __('freelance_cta_title') }}</h2>
