...
@section('content')
 ...
 <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-indigo-500 rounded-full blur-3xl opacity-20 group-hover:opacity-40 transition duration-700"></div>
 ...
 <div class="relative py-10 px-10 bg-indigo-50/80 border-l-8 border-indigo-600 rounded-r-[2rem] mb-12 shadow-sm">
