...
@section('content')
    ...
    {{-- SECTION 2: THE PROBLEM (DIPERPANJANG JADI 3 KOLOM) --}}
    <section class="py-32 bg-white relative">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-rose-50/50 p-10 rounded-[2.5rem] border border-rose-100 text-center hover:shadow-xl transition-shadow duration-300">
                    <div class="w-16 h-16 mx-auto bg-white rounded-full flex items-center justify-center shadow-sm text-3xl mb-6">📉</div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">{{ __('atomic_prob_1_title') }}</h3>
                    <p class="text-gray-600 leading-relaxed">{{ __('atomic_prob_1_desc') }}</p>
                </div>
                <div class="bg-amber-50/50 p-10 rounded-[2.5rem] border border-amber-100 text-center hover:shadow-xl transition-shadow duration-300">
                    <div class="w-16 h-16 mx-auto bg-white rounded-full flex items-center justify-center shadow-sm text-3xl mb-6">⚖️</div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">{{ __('atomic_prob_2_title') }}</h3>
                    <p class="text-gray-600 leading-relaxed">{{ __('atomic_prob_2_desc') }}</p>
                </div>
                <div class="bg-gray-50 p-10 rounded-[2.5rem] border border-gray-200 text-center hover:shadow-xl transition-shadow duration-300">
                    <div class="w-16 h-16 mx-auto bg-white rounded-full flex items-center justify-center shadow-sm text-3xl mb-6">🛑</div>
                    <h3 class="text-xl font-bold text-gray-900 mb-4">{{ __('atomic_prob_3_title') }}</h3>
                    <p class="text-gray-600 leading-relaxed">{{ __('atomic_prob_3_desc') }}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    {{-- SECTION 4: THE ARSENAL (TAMBAHAN BIAR PANJANG) --}}
    <section class="py-32 bg-indigo-50/50 border-b border-indigo-100">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-20">
                <h2 class="text-3xl md:text-5xl font-black mb-6 text-gray-900">{{ __('atomic_feat_title') }}</h2>
            </div>
            <div class="grid md:grid-cols-2 gap-12">
                <div class="flex gap-6 items-start p-8 rounded-[2.5rem] bg-white border border-gray-100 shadow-sm">
                    <div class="w-14 h-14 bg-indigo-100 text-indigo-600 rounded-2xl flex items-center justify-center text-2xl shrink-0">📊</div>
                    <div>
                        <h4 class="text-xl font-bold text-gray-900 mb-2">{{ __('atomic_feat_1_title') }}</h4>
                        <p class="text-gray-500 leading-relaxed">{{ __('atomic_feat_1_desc') }}</p>
                    </div>
                </div>
                <div class="flex gap-6 items-start p-8 rounded-[2.5rem] bg-white border border-gray-100 shadow-sm">
                    <div class="w-14 h-14 bg-purple-100 text-purple-600 rounded-2xl flex items-center justify-center text-2xl shrink-0">🧩</div>
                    <div>
                        <h4 class="text-xl font-bold text-gray-900 mb-2">{{ __('atomic_feat_2_title') }}</h4>
                        <p class="text-gray-500 leading-relaxed">{{ __('atomic_feat_2_desc') }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- SECTION 5: CTA (DESAIN BARU - LEGA, LUAS, & ELEGAN) --}}
    <section class="py-32 bg-white relative">
