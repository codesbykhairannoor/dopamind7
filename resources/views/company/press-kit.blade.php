...
@section('content')
 ...
 <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[600px] bg-gradient-to-b from-indigo-50/50 via-white to-white rounded-full blur-3xl -z-10"></div>
