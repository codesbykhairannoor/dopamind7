...
@section('content')
 ...
 <div class="absolute bottom-0 right-0 w-[600px] h-[600px] bg-emerald-500/10 rounded-full blur-3xl pointer-events-none"></div>
 ...
 <div class="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 text-indigo-300 font-mono text-[10px] mb-8 uppercase tracking-[0.2em] ">
 ...
 {{-- Status Hub --}}
 <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 p-6 bg-white/5 border border-white/10 rounded-3xl ">
 <div>
 ...
 <div class="w-64 h-64 bg-gradient-to-br from-indigo-600/80 to-purple-800/80 rounded-[2.5rem] p-8 border border-white/20 shadow-[0_0_80px_-10px_rgba(79,70,229,0.5)] transform hover:scale-105 transition duration-500 group">
 ...
 <div class="absolute -right-20 -top-20 w-80 h-80 bg-indigo-500/20 rounded-full blur-3xl pointer-events-none group-hover:scale-110 transition duration-1000"></div>
 ...
 <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-indigo-600/5 rounded-full blur-3xl pointer-events-none"></div>
