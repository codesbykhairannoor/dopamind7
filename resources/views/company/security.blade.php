...
@section('content')
 ...
 <div class="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 font-mono text-[10px] mb-8 uppercase tracking-widest ">
 ...
 <div class="p-6 rounded-3xl bg-white/5 border border-white/10 group hover:border-emerald-500/50 transition">
 ...
 <div class="p-6 rounded-3xl bg-white/5 border border-white/10 group hover:border-indigo-500/50 transition">
 ...
 <div class="p-6 rounded-3xl bg-white/5 border border-white/10 group hover:border-purple-500/50 transition">
 ...
 <div class="absolute -right-20 -top-20 w-[600px] h-[600px] bg-indigo-600/10 rounded-full blur-3xl pointer-events-none group-hover:scale-110 transition duration-1000"></div>
 
 <div class="relative z-10 flex flex-col md:flex-row gap-12 items-start">
 <div class="w-20 h-20 bg-white/5 rounded-3xl flex items-center justify-center text-4xl border border-white/10 shrink-0 shadow-lg group-hover:rotate-6 transition duration-500 font-black">🔐</div>
 <div>
 ...
 {{-- Decorative Blur --}}
 <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[500px] bg-indigo-600/5 rounded-full blur-3xl pointer-events-none"></div>
