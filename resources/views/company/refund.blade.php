...
@section('content')
 ...
 <div class="absolute top-0 left-1/4 w-[500px] h-[500px] bg-rose-500/10 rounded-full blur-3xl pointer-events-none"></div>
 
 <div class="max-w-7xl mx-auto relative z-10 text-center">
 <div class="inline-flex items-center gap-2 px-3 py-1 rounded border border-rose-500/30 bg-rose-500/10 text-rose-400 font-mono text-[10px] mb-8 uppercase tracking-widest ">
 🛑 {{ __('refund_badge') }}
 </div>
 ...
 <div class="px-10 py-4 bg-white/5 border border-white/10 rounded-full font-black text-indigo-300 w-fit mx-auto ">
