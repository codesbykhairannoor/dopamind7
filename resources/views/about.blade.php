...
@section('content')
 ...
 {{-- Background Accents --}}
 <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-indigo-50/50 rounded-full blur-3xl -z-10 animate-pulse"></div>
 ...
 {{-- Schematic Overlay --}}
 <div class="absolute bottom-10 left-10 p-8 border border-white/10 rounded-3xl bg-white/5">
 ...
 <div class="absolute top-0 right-0 w-[800px] h-[800px] bg-white rounded-full blur-3xl opacity-10 -mr-40 -mt-40"></div>
 <div class="absolute bottom-0 left-0 w-[600px] h-[600px] bg-purple-400 rounded-full blur-3xl opacity-10 -ml-20 -mb-20"></div>
 ...
 <div class="bg-white/5 p-12 rounded-[4rem] border border-white/10 hover:border-white transition-all duration-500 group">
 ...
 {{-- THE BUILDER --}}
 <div class="bg-white/5 border border-white/10 p-16 rounded-[5rem] group hover:bg-white/10 transition duration-700 overflow-hidden relative">
 <div class="absolute -top-20 -right-20 w-64 h-64 bg-indigo-600/20 rounded-full blur-3xl group-hover:opacity-40 transition"></div>
 ...
 {{-- THE VISIONARY --}}
 <div class="bg-white/5 border border-white/10 p-16 rounded-[5rem] group hover:bg-white/10 transition duration-700 overflow-hidden relative">
 <div class="absolute -bottom-20 -left-20 w-64 h-64 bg-purple-600/20 rounded-full blur-3xl group-hover:opacity-40 transition"></div>
 ...
 {{-- Background Blobs --}}
 <div class="absolute -bottom-20 -left-20 w-80 h-80 bg-indigo-200 rounded-full blur-3xl opacity-30"></div>
 </section>
@endsection
