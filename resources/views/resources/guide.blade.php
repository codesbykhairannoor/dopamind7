...
@section('content')
 ...
 <div class="w-14 h-14 bg-white rounded-2xl shadow-xl border border-gray-100 flex items-center justify-center text-2xl animate-bounce [animation-duration:4000ms]">🌱</div>
 <div class="w-14 h-14 bg-white rounded-2xl shadow-xl border border-gray-100 flex items-center justify-center text-2xl animate-bounce [animation-duration:5000ms] delay-500 ml-12">💰</div>
 </div>
 ...
 <div class="w-14 h-14 bg-white rounded-2xl shadow-xl border border-gray-100 flex items-center justify-center text-2xl animate-bounce [animation-duration:4200ms] delay-300">📔</div>
 <div class="w-14 h-14 bg-white rounded-2xl shadow-xl border border-gray-100 flex items-center justify-center text-2xl animate-bounce [animation-duration:3800ms] mr-12">⚡</div>
 </div>
 ...
 <div class="relative flex items-center bg-white/90 rounded-[2rem] shadow-2xl border border-white overflow-hidden p-2 transition-all duration-300">
 ...
 <div class="w-24 h-24 bg-white/20 rounded-full flex items-center justify-center group-hover:scale-125 transition-transform">
 ...
 <div class="bg-indigo-50 text-indigo-600 px-8 py-4 rounded-full">{{ __('gui_step2') }}</div>
 <div class="hidden md:block">➔</div>
 <div class="bg-indigo-50 text-indigo-600 px-8 py-4 rounded-full">{{ __('gui_step3') }}</div>
 </div>
 </div>
 </section>
 ...
 <a href="#" class="bg-white/5 text-white border border-white/10 px-12 py-5 rounded-2xl font-black text-lg hover:bg-white/10 transition flex items-center justify-center gap-3">
