...
@section('content')
 ...
 <div class="absolute -top-24 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-indigo-600/20 rounded-full blur-3xl pointer-events-none"></div>

 <div class="max-w-4xl mx-auto relative z-10 text-center">
 <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 font-mono text-[10px] mb-8 uppercase tracking-widest ">
 ...
 <h1 class="text-5xl md:text-7xl text-white tracking-tighter leading-none mb-8 font-black">
 Neural OS <br>
 ...
 <div class="w-16 h-16 bg-white rounded-2xl shadow-xl flex items-center justify-center text-4xl shrink-0 group-hover:scale-110 transition font-black">🛡️</div>
 <div class="prose prose-lg max-w-none">
 <h2 class="text-3xl text-slate-900 mb-6 tracking-tight font-black">The Data Sovereignty Protocol</h2>
 ...
 <article class="group bg-slate-50 p-10 md:p-16 rounded-[3.5rem] border border-slate-100 hover:border-indigo-600/30 transition duration-500">
 <div class="flex flex-col md:flex-row gap-12 items-start">
 <div class="w-16 h-16 bg-white rounded-2xl shadow-xl flex items-center justify-center text-4xl shrink-0 group-hover:scale-110 transition font-black">🔗</div>
 <div class="prose prose-lg max-w-none">
 <h2 class="text-3xl text-slate-900 mb-6 tracking-tight font-black">Logical Bridge Technology</h2>
 <p class="text-slate-600">
 ...
 <div class="w-16 h-16 bg-white rounded-2xl shadow-xl flex items-center justify-center text-4xl shrink-0 group-hover:scale-110 transition font-black">🧠</div>
 <div class="prose prose-lg max-w-none">
 <h2 class="text-3xl text-slate-900 mb-6 tracking-tight font-black">AI On-Demand Philosophy</h2>
 <p class="text-slate-600">
 ...
 <h2 class="text-4xl text-white mb-6 font-black">Built for Audit-Readiness</h2>
