...
@section('content')
 ...
 <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-indigo-400/10 rounded-full blur-3xl pointer-events-none -z-10"></div>
 ...
 <h3 class="text-2xl font-bold mb-2">{{ __('chg_roadmap_1') }}</h3>
 <p class="text-slate-400">{{ __('chg_roadmap_1_d') }}</p>
 </div>
 <div class="flex-1 p-8 rounded-3xl bg-slate-800 border-l-4 border-rose-500 shadow-xl">
 <h3 class="text-2xl font-bold mb-2">{{ __('chg_roadmap_2') }}</h3>
 <p class="text-slate-400">{{ __('chg_roadmap_2_d') }}</p>
 </div>
 <div class="flex-1 p-8 rounded-3xl bg-slate-800 border-l-4 border-emerald-500 shadow-xl">
 <h3 class="text-2xl font-bold mb-2">{{ __('chg_roadmap_3') }}</h3>
 <p class="text-slate-400">{{ __('chg_roadmap_3_d') }}</p>
 </div>
 </div>
 </div>
 </section>
 ...
 <p class="text-xl italic font-bold text-slate-700 mb-4">{{ __('chg_fd1') }}</p>
 <span class="text-sm font-black text-indigo-600">@usera</span>
 </div>
 <div class="break-inside-avoid p-10 bg-rose-50 rounded-3xl">
 <p class="text-xl italic font-bold text-slate-700 mb-4">{{ __('chg_fd2') }}</p>
 ...
 <div class="absolute -top-32 -right-32 w-80 h-80 bg-indigo-500/10 rounded-full blur-3xl"></div>
