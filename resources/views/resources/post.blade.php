...
<main x-data="{ 
 ...
 <img src="{{ $post->featured_image_url }}" alt="{{ $post->title }}" class="w-full h-auto object-cover hover:scale-105 transition-transform [transition-duration:3s]">
 </div>
 @endif
 ...
 <div class="absolute top-0 right-0 w-32 h-32 bg-indigo-500/20 blur-3xl group-hover:bg-indigo-500/40 transition-all duration-700"></div>
