    ...
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-12 gap-16 py-24 relative">
        ...
        <aside class="hidden lg:block col-span-1 sticky top-40 h-fit">
            <div class="flex flex-col items-center gap-6">
                <!-- SHARE BUTTONS -->
                <a href="https://twitter.com/intent/tweet?url={{ urlcurrent() }}&text={{ $post->title }}" target="_blank" class="w-10 h-10 rounded-2xl bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-indigo-600 hover:border-indigo-600 transition-all shadow-sm group">
                ...
                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlcurrent() }}" target="_blank" class="w-10 h-10 rounded-2xl bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-indigo-600 hover:border-indigo-600 transition-all shadow-sm">
        ...
        <div class="col-span-12 lg:col-span-8 space-y-12">
            @if($post->featured_image)
                <div class="rounded-[2.5rem] overflow-hidden shadow-2xl shadow-indigo-100/50 border border-slate-100 mb-20 animate-in fade-in zoom-in duration-1000">
                    <img src="{{ asset('storage/' . $post->featured_image) }}" alt="{{ $post->title }}" class="w-full h-auto object-cover hover:scale-105 transition-transform duration-[3s]">
                </div>
            @endif
