...
<div x-data="{ 
 ...
 <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-indigo-50/50 rounded-full blur-3xl pointer-events-none -z-10"></div>
 ...
 <div class="absolute -top-32 -right-32 w-96 h-96 bg-indigo-500/20 rounded-full blur-3xl"></div>
 
 <div class="relative z-10">
 <div class="inline-flex items-center justify-center w-24 h-24 bg-white/10 rounded-[2rem] text-4xl mb-10 border border-white/20 shadow-inner font-black">
 🆘
 </div>
