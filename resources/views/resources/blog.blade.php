...
@section('content')
 ...
 <div class="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-white/20 text-white text-[10px] font-black uppercase tracking-[0.2em] mb-4 border border-white/20 w-fit">
 {{ __('blog_feat_label') }}
 </div>
 ...
 <span class="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-white/90 shadow-sm border border-slate-100/50" style="color: {{ $post->category->color }}">
 {{ $post->category->name }}
 </span>
 </div>
 @endif
 ...
 <div class="absolute -right-20 -top-20 w-80 h-80 bg-white rounded-full blur-3xl opacity-60 pointer-events-none"></div>
 <div class="absolute bottom-0 left-0 w-64 h-64 bg-indigo-200/40 rounded-full blur-3xl pointer-events-none"></div>
