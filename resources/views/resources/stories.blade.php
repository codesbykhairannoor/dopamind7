...
@section('content')
 ...
 <div class="relative bg-white/90 rounded-[2.5rem] shadow-2xl border border-white p-8 md:p-10 transform transition hover:scale-[1.01] duration-500">
 ...
 <div class="absolute -right-6 -bottom-6 bg-white p-4 rounded-2xl shadow-xl border border-gray-50 z-20 animate-bounce [animation-duration:4000ms] hidden md:block">
 ...
 {{-- Abstract Shapes --}}
 <div class="absolute -top-24 -left-24 w-96 h-96 bg-indigo-500 rounded-full blur-3xl opacity-50 animate-pulse"></div>
 <div class="absolute -bottom-24 -right-24 w-96 h-96 bg-purple-500 rounded-full blur-3xl opacity-50 animate-pulse delay-1000"></div>
