...
},
{
 ...
 "@type": "ListItem",
 "position": 2,
 "name": "{{ __('finance_hero_badge') }}",
 "item": "{{ url('/features/finance') }}"
 }]
},
{
 "@context": "https://schema.org",
 ...
 {
 "@type": "Question",
 "name": "{{ __('finance_faq_q1') }}",
 "acceptedAnswer": {
 "@type": "Answer",
 "text": "{{ __('finance_faq_a1') }}"
 }
 },
 {
 "@type": "Question",
 "name": "{{ __('finance_faq_q2') }}",
 "acceptedAnswer": {
 "@type": "Answer",
 "text": "{{ __('finance_faq_a2') }}"
 }
 },
 {
 "@type": "Question",
 "name": "{{ __('finance_faq_q3') }}",
 "acceptedAnswer": {
 "@type": "Answer",
 "text": "{{ __('finance_faq_a3') }}"
 }
 }
 ]
}
...
@section('content')
 ...
 <div class="relative w-full max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300 fill-mode-both" role="img" aria-label="Personal Finance Dashboard Preview: Showing a clean transaction list with income and expense tracking, a healthy balance indicator, and a budget alert for emergency funds.">
 <div class="absolute -inset-1 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-[2.5rem] blur opacity-20"></div>
 <div class="relative bg-white/90 rounded-[2.5rem] shadow-2xl border border-white p-8 md:p-10 transform transition hover:scale-[1.02] duration-500">
 ...
 <div class="absolute -inset-10 bg-indigo-500/10 blur-3xl rounded-full -z-10 "></div>
 {{-- Visual Card Stack --}}
 ...
 {{-- Card 2 (Glass) --}}
 <div class="relative md:absolute bottom-10 left-0 w-full max-w-[380px] h-60 bg-white/40 rounded-[2.5rem] p-10 border border-white shadow-2xl transform -rotate-2 hover:rotate-0 transition duration-500 z-10 flex flex-col justify-between">
 ...
 <div class="bg-emerald-500/5 border border-emerald-500/20 p-8 rounded-[2rem] text-left group hover:bg-emerald-500/10 transition duration-500">
 ...
 <div class="bg-indigo-500/5 border border-indigo-500/20 p-8 rounded-[2rem] text-left group hover:bg-indigo-500/10 transition duration-500">
 ...
 <div class="w-64 h-64 bg-indigo-600/10 rounded-full animate-ping [animation-duration:4000ms]"></div>
 <div class="absolute w-48 h-48 border border-white/5 rounded-full animate-spin [animation-duration:10000ms]"></div>
 </div>
 ...
 <div class="bg-rose-500/5 border border-rose-500/20 p-8 rounded-[2rem] text-left group hover:bg-rose-500/10 transition duration-500">
 ...
 <div class="bg-amber-500/5 border border-amber-500/20 p-8 rounded-[2rem] text-left group hover:bg-amber-500/10 transition duration-500">
 ...
 <div class="max-w-6xl mx-auto px-6 relative z-10 text-center">
 <div class="inline-flex items-center justify-center px-6 py-2 bg-indigo-900/50 border border-indigo-700/50 text-indigo-300 rounded-full text-sm font-bold uppercase tracking-widest mb-8">
 ...
 <div class="bg-indigo-900/40 p-8 rounded-[2rem] border border-indigo-800/50 hover:bg-indigo-800/40 transition">
 ...
 <div class="bg-white/60 rounded-[4rem] border border-white p-12 md:p-20 shadow-2xl flex flex-col lg:flex-row items-center gap-16">
 ...
 <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-indigo-600 rounded-full mix-blend-screen filter blur-3xl opacity-30 "></div>
