...
@section('content')
 ...
 <div class="absolute top-0 right-0 w-1/2 h-full bg-indigo-500/10 blur-3xl rounded-full"></div>
 <div class="absolute bottom-0 left-0 w-1/2 h-1/2 bg-purple-500/10 blur-3xl rounded-full"></div>
 ...
 <div class="bg-white/5 border border-white/10 p-8 rounded-[2rem] hover:bg-white/10 transition duration-500">
 ...
 <div class="bg-white/5 border border-white/10 p-8 rounded-[2rem] hover:bg-white/10 transition duration-500 text-left">
 ...
 <div class="absolute -inset-4 bg-indigo-50 rounded-[4rem] -z-10 "></div>
...
<section class="py-20 lg:py-32 bg-slate-50 relative overflow-hidden">
 ...
 {{-- Card 3 (Bottom) --}}
 <div class="absolute w-[85%] lg:w-[80%] h-56 lg:h-64 bg-white rounded-[2.5rem] lg:rounded-[3rem] shadow-2xl border border-gray-100 transform rotate-[-4deg] lg:rotate-[-6deg] translate-y-12 lg:translate-y-20 opacity-40 blur-3xl lg:blur-sm"></div>
 ...
 {{-- Floating Atoms --}}
 <div class="absolute -top-6 -left-12 w-8 h-8 rounded-full bg-purple-500/20 border border-purple-500/30 animate-bounce [animation-duration:3000ms]"></div>
 <div class="absolute -bottom-8 -right-10 w-10 h-10 rounded-full bg-emerald-500/20 border border-emerald-500/30 animate-bounce [animation-duration:4000ms]"></div>
 </div>
 ...
 <div class="absolute top-0 right-0 w-[500px] h-[500px] bg-indigo-500 rounded-full mix-blend-screen filter blur-3xl opacity-40 "></div>
