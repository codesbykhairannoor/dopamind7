...
@section('content')
 ...
 <div class="bg-white/80 rounded-t-[3rem] border-x border-t border-gray-200 p-8 md:p-12 shadow-2xl flex flex-col md:flex-row gap-8 overflow-hidden h-auto min-h-[400px]">
 ...
 <div class="absolute top-0 right-0 w-[800px] h-[800px] bg-indigo-100/50 rounded-full blur-3xl -mr-96 -mt-96"></div>
 ...
 <div class="max-w-6xl mx-auto px-6 relative z-10">
 <div class="bg-white/80 rounded-[4rem] border border-white p-12 md:p-24 text-center shadow-2xl relative overflow-hidden">
