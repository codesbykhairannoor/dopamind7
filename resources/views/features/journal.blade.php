...
@section('content')
 ...
 <div class="relative bg-white/80 rounded-[3rem] border border-white shadow-2xl p-8 md:p-16 text-left transform transition hover:scale-[1.01] duration-500">
 ...
 {{-- Floating Emoji Icon --}}
 <div class="absolute -top-12 left-8 text-6xl bg-white rounded-2xl p-2 shadow-sm font-black">🧠</div>
 
 <div class="flex justify-between items-start mt-4 mb-6">
 <div>
 <h3 class="font-black text-gray-900 text-3xl mb-2 font-black">{{ __('journal_mockup_title') }}</h3>
 ...
 <p class="">{{ __('journal_mockup_text_1') }}</p>
 ...
 <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 text-slate-500 text-[10px] uppercase tracking-[0.2em] mb-10">
 {{ __('journal_editorial_badge') }}
 </div>
 <h2 class="text-[42px] leading-[1.1] md:text-7xl font-serif italic text-gray-900 mb-10 leading-[1.1] tracking-tight font-black">
 ...
 <div class="font-serif text-2xl md:text-4xl text-gray-800 leading-[1.6] space-y-10 relative z-10 font-black">
 ...
 <div class="absolute -bottom-8 -right-8 w-24 h-24 bg-slate-900 rounded-[2rem] flex items-center justify-center text-4xl shadow-2xl transform rotate-12 group-hover:rotate-0 transition duration-500 border-4 border-white font-black">🖋️</div>
 </div>
 </div>
 </section>
 ...
 {{-- Nebula Backgrounds --}}
 <div class="absolute top-0 right-0 w-[1000px] h-[1000px] bg-purple-200/40 rounded-full blur-3xl -mr-96 -mt-96 animate-pulse"></div>
 ...
 drop-shadow-2xl font-black">
 ✨
 </span>

 <h4 class="text-3xl font-semibold text-gray-800 mb-2 font-black">
 ...
 <h2 class="text-4xl md:text-6xl font-bold text-white mb-10 leading-tight font-black">
...
<p class="text-white/80 text-xl md:text-2xl mb-12 leading-relaxed max-w-2xl">
 ...
 <div class="w-16 h-16 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center text-3xl shrink-0 group-hover:rotate-12 transition font-black">🔮</div>
 <div>
 <h4 class="text-xl text-gray-900 mb-2">{{ __('journal_nebula_feature_1_title') }}</h4>
 <p class="text-gray-500 font-medium">{{ __('journal_nebula_feature_1_desc') }}</p>
 </div>
 </div>
 <div class="flex items-start gap-8 p-8 rounded-[2.5rem] bg-white hover:shadow-2xl transition duration-500 group border border-gray-100">
 <div class="w-16 h-16 bg-purple-50 text-purple-600 rounded-2xl flex items-center justify-center text-3xl shrink-0 group-hover:scale-110 transition font-black">🌈</div>
 <div>
 <h4 class="text-xl text-gray-900 mb-2">{{ __('journal_nebula_feature_2_title') }}</h4>
 ...
 <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-100 text-purple-700 text-[10px] uppercase tracking-[0.2em] mb-8 shadow-sm border border-purple-200">
 ...
 <div>
 <div class="w-16 h-16 bg-white rounded-2xl shadow-lg flex items-center justify-center text-3xl mb-8 group-hover:rotate-12 transition font-black">🌈</div>
 <h3 class="text-3xl text-gray-900 mb-4 font-black">{{ __('journal_analytics_bento_1_title') }}</h3>
 ...
 <div>
 <h3 class="text-xl mb-2">{{ __('journal_analytics_bento_2_title') }}</h3>
 ...
 <div>
 <h3 class="text-xl text-gray-900 mb-2">{{ __('journal_analytics_bento_3_title') }}</h3>
 ...
 <div class="absolute inset-0 bg-indigo-50 rounded-full blur-3xl opacity-30 animate-pulse"></div>
 <div class="relative w-24 h-24 mx-auto bg-white border border-indigo-100 rounded-full flex items-center justify-center text-3xl shadow-xl transform hover:rotate-12 transition duration-700 group font-black">
 ✨
 <div class="absolute inset-0 border-2 border-dashed border-indigo-200 rounded-full animate-spin-slow group-hover:animate-spin"></div>
 </div>
 </div>

 <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-50 text-slate-400 text-[10px] uppercase tracking-[0.3em] mb-10">
 🧬 {{ __('journal_science_badge') }}
 </div>
 
 <h2 class="text-4xl md:text-5xl font-serif italic text-gray-900 mb-12 leading-tight font-black">
 {{ __('journal_science_title') }}
 </h2>

 <div class="relative py-12 px-8 md:px-20 border-y border-gray-100">
 {{-- Quote Marks --}}
 <div class="absolute top-0 left-0 text-8xl text-indigo-50 font-serif leading-none -translate-x-1/2 -translate-y-1/2 font-black">“</div>
 <div class="absolute bottom-0 right-0 text-8xl text-indigo-50 font-serif leading-none translate-x-1/2 translate-y-1/2 font-black">”</div>
 
 <p class="text-gray-600 text-2xl md:text-3xl font-serif italic leading-[1.6] opacity-80 decoration-indigo-100 underline-offset-8 font-black">
 ...
 <span class="text-[10px] uppercase tracking-widest text-indigo-300 mb-2">Technique</span>
 <span class="text-sm font-bold text-gray-400 italic">Affect Labeling</span>
 </div>
 <div class="flex flex-col items-center">
 <span class="text-[10px] uppercase tracking-widest text-indigo-300 mb-2">Foundation</span>
 <span class="text-sm font-bold text-gray-400 italic">Reflective Practice</span>
 </div>
 <div class="flex flex-col items-center">
 <span class="text-[10px] uppercase tracking-widest text-indigo-300 mb-2">Outcome</span>
 ...
 <div class="lg:w-1/2">
 <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/10 text-purple-400 text-[10px] uppercase tracking-widest mb-8 border border-purple-500/20">
 ...
 <a hx-boost="false" href="{{ route('features.neural-os') }}" class="inline-flex items-center gap-2 bg-purple-600 text-white px-8 py-4 rounded-2xl text-lg hover:bg-purple-700 transition transform hover:-translate-y-1">
 ...
 <div class="text-[10px] text-purple-400 uppercase tracking-widest mb-6">Sentiment Mirror v1.0</div>
 ...
 <p class="text-indigo-600 tracking-[0.5em] uppercase text-xs">{{ __('journal_quote_author') }}</p>
 </div>
 </div>
 </section>
 ...
 <div class="max-w-3xl mx-auto text-center relative z-10 bg-white/80 p-12 md:p-20 rounded-[3rem] shadow-2xl border border-white">
 <div class="text-5xl mb-6 font-black">🖋️</div>
 <h2 class="text-4xl md:text-5xl mb-6 text-gray-900 tracking-tight font-black">{{ __('journal_cta_title') }}</h2>
 <p class="text-gray-500 text-xl mb-10">
 {{ __('journal_cta_desc') }}
 </p>
 <a hx-boost="false" href="{{ route('register') }}" class="inline-block bg-indigo-600 text-white px-12 py-5 rounded-full text-lg hover:bg-indigo-700 hover:shadow-xl hover:shadow-indigo-200 transition transform hover:-translate-y-1">
 {{ __('journal_cta_btn') }}
 </a>
