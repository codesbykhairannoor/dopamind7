...
@section('content')
 ...
 <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[800px] bg-gradient-to-b from-purple-50/50 via-white to-white rounded-full blur-3xl -z-10"></div>
 
 <div class="max-w-5xl mx-auto relative z-10">
 <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-50 border border-purple-100 shadow-sm text-purple-700 text-[10px] mb-10 tracking-[0.2em] animate-in fade-in slide-in-from-bottom-4 duration-700">
 ...
 <h1 class="text-[42px] leading-[1.1] md:text-7xl lg:text-8xl mb-10 leading-[0.95] tracking-tight text-slate-900 animate-in fade-in slide-in-from-bottom-8 duration-1000 font-black">
 ...
 <a hx-boost="false" href="{{ route('register') }}" class="bg-indigo-600 text-white px-12 py-6 rounded-3xl text-xl hover:bg-indigo-700 hover:shadow-2xl hover:shadow-indigo-200 transition transform hover:-translate-y-1 active:scale-95 group">
 {{ __('neural_hero_cta_1') }}
 <span class="inline-block transition-transform group-hover:translate-x-1 ml-2">→</span>
 </a>
 <a href="#audit" class="bg-white text-slate-700 border border-slate-200 px-12 py-6 rounded-3xl text-xl hover:bg-slate-50 hover:border-slate-300 transition transform hover:-translate-y-1 active:scale-95">
 ...
 <div class="text-left">
 <p class="text-[10px] uppercase tracking-widest text-slate-500">{{ __('neural_mockup_source') }}</p>
 <p class="text-white text-lg">Gemini Intelligence Layer</p>
 </div>
 </div>
 ...
 <h2 class="text-4xl text-white mb-8 leading-tight font-black">
 ...
 <div class="lg:w-1/2">
 <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-50 text-emerald-700 text-[10px] mb-8 uppercase tracking-widest border border-emerald-100">
 ...
 <h3 class="text-xl text-slate-900 mb-4 tracking-wide">{{ __('neural_audit_step1_title') }}</h3>
 <p class="text-slate-500 font-bold text-sm leading-relaxed">{{ __('neural_audit_step1_desc') }}</p>
 </div>
 <div>
 <div class="w-12 h-12 bg-white rounded-2xl shadow-xl flex items-center justify-center text-2xl mb-6">🌍</div>
 <h3 class="text-xl text-slate-900 mb-4 tracking-wide">{{ __('neural_audit_step2_title') }}</h3>
 ...
 <span class="text-slate-900 tracking-tight">Audit Report: #482</span>
 </div>
 <div class="space-y-4">
 ...
 <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-100 text-indigo-700 text-[10px] mb-6 tracking-widest border border-indigo-200">
 ...
 <h3 class="text-2xl text-slate-900 mb-4">{{ __('neural_synergy_fin_title') }}</h3>
 <p class="text-slate-500 font-bold leading-relaxed">{{ __('neural_synergy_fin_desc') }}</p>
 </div>
 <div class="bg-white p-12 rounded-[3rem] border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 group">
 <div class="w-16 h-16 bg-white rounded-2xl shadow-xl flex items-center justify-center text-4xl mb-10 group-hover:scale-110 transition font-black">🌱</div>
 <h3 class="text-2xl text-slate-900 mb-4">{{ __('neural_synergy_hab_title') }}</h3>
 ...
 <span class="text-[9px] text-slate-400 uppercase tracking-widest ml-3 mb-1">{{ __('neural_coach_sender') }}</span>
 ...
 <span class="text-[9px] text-slate-400 uppercase tracking-widest mr-3 mb-1">{{ __('neural_coach_user') }}</span>
 ...
 <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-50 text-purple-700 text-[10px] mb-8 uppercase tracking-widest border border-purple-100">
 ...
 <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-white/80 text-[10px] tracking-widest mb-10 border border-white/10">
 🛡️ {{ __('neural_privacy_badge') }}
 </div>
 <h2 class="text-4xl md:text-6xl text-white mb-10 tracking-tight font-black">{{ __('neural_privacy_title') }}</h2>
 <p class="text-slate-400 text-xl font-medium leading-relaxed mb-14">
 {{ __('neural_privacy_desc') }}
 </p>
 <div class="inline-block px-8 py-4 bg-white/5 border border-white/10 rounded-2xl text-[10px] text-indigo-400 tracking-[0.4em] uppercase">
 ...
 <a hx-boost="false" href="{{ route('register') }}" class="inline-block bg-indigo-600 text-white px-16 py-8 rounded-[2.5rem] text-2xl hover:bg-indigo-700 shadow-2xl shadow-indigo-200 transition transform hover:-translate-y-2 active:scale-95">
 {{ __('neural_cta_btn') }}
 </a>
 <div class="flex items-center gap-3 text-sm text-slate-400 tracking-widest">
 {{ __('neural_cta_note') }}
 </div>
 </div>
 </div>
 ...
 <div class="absolute bottom-0 left-1/2 -translate-x-1/2 w-[1500px] h-[600px] bg-gradient-to-t from-indigo-50/50 via-white to-white rounded-full blur-3xl -z-10"></div>
 </section>
