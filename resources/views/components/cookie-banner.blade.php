<div 
    ...
    class="fixed bottom-6 left-6 right-6 md:left-auto md:max-w-md z-[200]"
    x-cloak
>
    <div class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl border border-slate-200 dark:border-slate-800 p-8 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.15)] relative overflow-hidden group">
        {{-- Decorative Blur --}}
        <div class="absolute -right-20 -top-20 w-40 h-40 bg-indigo-500/10 rounded-full blur-3xl pointer-events-none group-hover:bg-indigo-500/20 transition-all duration-700"></div>
