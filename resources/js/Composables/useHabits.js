...
export function useHabits(props) {
    ...
    return {
        ...
        chainConnectForm: modals.chainConnectForm,
        quickTargetForm: modals.quickTargetForm,
        chainLinks: modals.chainLinks,
        chainTimeline: modals.chainTimeline,
        chainLoading: modals.chainLoading,
        connectChain: modals.connectChain,
        createQuickTargetAndLink: modals.createQuickTargetAndLink,
        removeChainLink: modals.removeChainLink,
        isChainSyncEligible: modals.isChainSyncEligible,
