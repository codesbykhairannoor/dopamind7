...
<template>
    ...
    <div class="w-full lg:max-w-[96%] mx-auto p-4 md:p-6 lg:p-8 space-y-6 lg:space-y-8 pb-24">
        ...
        <div class="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-600 to-indigo-600 rounded-[2.5rem] p-8 md:p-12 text-white flex flex-col md:flex-row justify-between items-start md:items-center gap-8 border border-indigo-700/50 group">
            ...
            <div class="relative z-10 w-full md:w-2/3">
                ...
                <p class="text-whitetext-lg md:text-xl font-medium max-w-2xl leading-relaxed">
