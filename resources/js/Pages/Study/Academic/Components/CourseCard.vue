    ...
    <div @click="handleClick" 
        ...
        <div class="relative z-10 flex justify-between items-end mt-auto">
            <div class="flex flex-col gap-1">
                ...
                <span class="text-[10px] font-bold text-slate-400 capitalize tracking-wide">{{ terms.grade }}: <span class="text-emerald-600 dark:text-emerald-400 text-xs uppercase">{{ record.grade }}</span></span>
            </div>
