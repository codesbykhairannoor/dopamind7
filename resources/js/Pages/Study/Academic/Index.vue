        ...
        <template v-if="hasCompletedSetup">
            ...
            <template v-if="!activeCourseReactive">
                ...
                <div class="max-w-[1600px] w-full md:w-[95%] mx-auto px-4 sm:px-8 py-8">
                    <!-- Banner Portfolio -->
                    <Link :href="route('study.portfolio')" prefetch="mount" cache-for="5m" class="group relative flex items-center justify-between px-6 py-4 bg-gradient-to-r from-slate-900 to-slate-800 overflow-hidden rounded-2xl border border-slate-800 transition-all hover:border-indigo-500/50 shadow-lg mb-8 hover:-translate-y-0.5">
