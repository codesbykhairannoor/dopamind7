                    ...
                    <div class="w-full md:w-auto min-w-[320px]">
                        ...
                        <div v-else class="flex flex-col sm:flex-row items-center gap-4">
                            <div class="flex-1 bg-slate-100 dark:bg-slate-800/50 px-6 py-4 rounded-[2rem] border border-slate-200 dark:border-slate-700/50 flex items-center justify-between gap-4 group/url">
                                ...
                                <div class="flex items-center gap-2">
                                    <button @click="isEditingUsername = true" class="flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-slate-700 hover:bg-indigo-50 dark:hover:bg-indigo-900 text-slate-500 hover:text-indigo-600 dark:text-slate-300 dark:hover:text-indigo-400 rounded-xl transition-all shadow-sm active:scale-90 border border-slate-100 dark:border-slate-600 font-bold text-[11px] tracking-wider">
