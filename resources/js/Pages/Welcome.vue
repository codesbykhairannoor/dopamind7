    ...
    <GuestLayout>
        ...
        <header class="pt-32 pb-24 px-6 text-center relative overflow-hidden">
            ...
            <div class="max-w-5xl mx-auto">
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-slate-900 border border-indigo-100 shadow-sm text-indigo-600 font-bold text-xs mb-8 uppercase tracking-wider animate-in fade-in slide-in-from-bottom-4 duration-700">
                    {{ $t('hero_badge') }}
                </div>
                ...
                <div class="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 fill-mode-both">
                    <div v-if="!$page.props.auth.user" class="flex flex-col sm:flex-row justify-center gap-4">
                        ...
                        <Link :href="route('about')" class="bg-white dark:bg-slate-900 text-gray-700 border border-gray-200 px-10 py-5 rounded-2xl font-bold text-lg hover:bg-gray-50 transition">
        ...
        <section class="py-24 bg-gray-50 border-y border-gray-200">
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="col-span-1 sm:col-span-2 bg-white dark:bg-slate-900 p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition duration-300 relative overflow-hidden group animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100 fill-mode-both">
                    ...
                    <div class="bg-white dark:bg-slate-900 p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition duration-300 group animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 fill-mode-both">
                    ...
                    <div class="bg-white dark:bg-slate-900 p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition duration-300 group animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 fill-mode-both">
                    ...
                    <div class="bg-white dark:bg-slate-900 p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition duration-300 group animate-in fade-in slide-in-from-bottom-8 duration-700 delay-400 fill-mode-both">
                    ...
                    <div class="bg-white dark:bg-slate-900 p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition duration-300 group animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500 fill-mode-both">
                        ...
                        <div class="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center">
                            <div class="flex-1">
                                <div class="flex gap-4 mb-4">
                                    <span class="w-12 h-12 bg-white dark:bg-slate-900/10 rounded-xl flex items-center justify-center text-2xl">💼</span>
                                    <span class="w-12 h-12 bg-white dark:bg-slate-900/10 rounded-xl flex items-center justify-center text-2xl">🎨</span>
                                </div>
                                <h4 class="text-xl font-bold mb-2">{{ $t('eco_job_title') }}</h4>
                                <p class="text-indigo-200 text-sm">{{ $t('eco_job_desc') }}</p>
                            </div>
                            <div class="bg-white dark:bg-slate-900/10 px-4 py-2 rounded-lg text-xs font-bold text-indigo-200 border border-white/10">
                                {{ $t('eco_coming_soon') }}
                            </div>
                        </div>
                    </div>
            ...
            <div class="max-w-6xl mx-auto px-6 space-y-32">
                ...
                <div class="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div class="relative h-[400px] bg-gray-50 rounded-[3rem] border border-gray-100 p-8 flex items-center justify-center overflow-hidden animate-in slide-in-from-right-12 fade-in duration-700 delay-200 fill-mode-both">
                        ...
                        <div class="bg-white dark:bg-slate-900 p-4 rounded-xl shadow-lg border border-red-100 absolute top-20 left-10 transform -rotate-6 w-48 animate-pulse">
                            <div class="h-2 bg-red-200 w-1/2 rounded mb-2"></div>
                            <div class="text-xs text-red-500 font-bold">⚠️ Overdue 12 days</div>
                        </div>
                        <div class="bg-white dark:bg-slate-900 p-4 rounded-xl shadow-lg border border-gray-100 absolute bottom-20 right-10 transform rotate-3 w-56">
                ...
                <div class="grid md:grid-cols-2 gap-16 items-center">
                    <div class="order-2 md:order-1 relative h-[400px] bg-indigo-900 rounded-[3rem] p-8 flex items-center justify-center overflow-hidden animate-in slide-in-from-left-12 fade-in duration-700 delay-100 fill-mode-both">
                        ...
                        <div class="grid grid-cols-2 gap-4 w-64">
                            <div class="bg-white dark:bg-slate-900/10 backdrop-blur-md p-6 rounded-2xl border border-white/10 text-center"><div class="text-2xl mb-2">💰</div><div class="text-xs text-white/70">Excel</div></div>
                            <div class="bg-white dark:bg-slate-900/10 backdrop-blur-md p-6 rounded-2xl border border-white/10 text-center"><div class="text-2xl mb-2">✅</div><div class="text-xs text-white/70">Todo</div></div>
                            <div class="bg-white dark:bg-slate-900/10 backdrop-blur-md p-6 rounded-2xl border border-white/10 text-center col-span-2"><div class="text-2xl mb-2">🤯</div><div class="text-xs text-white/70">Chaos</div></div>
                        </div>
                    </div>
        ...
        <section class="py-32 bg-gray-50 border-y border-gray-200">
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="bg-white dark:bg-slate-900 p-10 rounded-[2.5rem] shadow-sm hover:shadow-xl hover:-translate-y-2 transition duration-300 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100 fill-mode-both">
                    ...
                    <div class="bg-white dark:bg-slate-900 p-10 rounded-[2.5rem] shadow-sm hover:shadow-xl hover:-translate-y-2 transition duration-300 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 fill-mode-both">
                    ...
                    <div class="bg-indigo-600 p-10 rounded-[2.5rem] shadow-2xl shadow-indigo-200 text-white relative overflow-hidden group animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 fill-mode-both">
                        <div class="absolute -right-10 -top-10 w-40 h-40 bg-white dark:bg-slate-900/10 rounded-full blur-3xl group-hover:bg-white dark:bg-slate-900/20 transition"></div>
                        <div class="w-16 h-16 bg-white dark:bg-slate-900/20 rounded-3xl flex items-center justify-center text-3xl mb-8">🔄</div>
        ...
        <section class="py-24 bg-white dark:bg-slate-900">
            <div class="max-w-3xl mx-auto px-6">
                ...
                <div class="space-y-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100 fill-mode-both">
                    <div v-for="(faq, index) in [1, 2, 3]" :key="index" class="border border-gray-100 rounded-2xl overflow-hidden transition-all duration-300" :class="activeFaq === faq ? 'bg-gray-50 shadow-md' : 'bg-white dark:bg-slate-900'">
...
<section class="py-24 bg-gray-50 border-t border-gray-100 overflow-hidden">
            <div class="max-w-7xl mx-auto px-6">
                <div class="relative bg-white dark:bg-slate-900 rounded-[3rem] p-8 md:p-16 shadow-xl shadow-indigo-100 border border-indigo-50 overflow-hidden flex flex-col md:flex-row items-center gap-12">
                    ...
                    <div class="w-full md:w-1/2 relative flex justify-center">
                        ...
                        <div class="absolute top-10 -right-4 bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-xl border border-indigo-50 animate-bounce">
        ...
        <section class="py-24 px-6 text-center">
            <div class="max-w-5xl mx-auto bg-indigo-950 rounded-[3rem] p-12 md:p-24 text-white relative overflow-hidden shadow-2xl animate-in zoom-in-95 fade-in duration-1000 delay-200 fill-mode-both">
                ...
                <div class="relative z-10">
                    ...
                    <Link :href="route('register')" class="inline-block bg-white dark:bg-slate-900 text-indigo-950 px-12 py-5 rounded-2xl font-bold text-xl hover:bg-indigo-50 transition transform hover:scale-105 shadow-xl">
                        {{ $t('cta_final_btn') }}
                    </Link>
