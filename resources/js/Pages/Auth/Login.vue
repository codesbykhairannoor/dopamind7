        ...
        <div class="w-full max-w-[420px] flex flex-col relative z-10">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-sm font-medium text-slate-500">
                    ...
                    <Link :href="route('register')" class="text-indigo-600 hover:text-indigo-800 transition font-bold">{{ $t('auth_link_register', 'Sign up') }}</Link>
                </p>
            </div>

            <div v-if="status" class="mb-6 font-bold text-sm text-indigo-600 bg-indigo-50 dark:bg-indigo-500/10 p-4 rounded-xl border border-indigo-100/50 dark:border-indigo-500/20 flex items-center gap-3 shadow-sm dark:shadow-none">
            ...
            <button 
                ...
                <span class="font-bold text-white text-sm">{{ $t('auth_btn_google_in', 'Lanjutkan dengan Google') }}</span>
            </button>
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <button
                    ...
                    class="w-full mt-2 bg-indigo-600 text-white font-black py-3 rounded-xl shadow-lg shadow-indigo-100 dark:shadow-none hover:bg-indigo-700 transition transform hover:-translate-y-0.5 active:scale-95 disabled:opacity-75 flex items-center justify-center gap-2"
                >
