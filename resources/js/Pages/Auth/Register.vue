    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center bg-white selection:bg-indigo-100 selection:text-indigo-700 p-6 overflow-hidden">
        ...
        <div class="w-full max-w-[420px] flex flex-col relative z-10">
            ...
            <button 
                ...
                class="flex items-center justify-center w-full px-4 py-3 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm dark:shadow-none bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-slate-200 mb-6 group active:scale-[0.98]">
                ...
                <span class="font-bold text-slate-700 text-sm">{{ $t('auth_btn_google_up', 'Lanjutkan dengan Google') }}</span>
            </button>
