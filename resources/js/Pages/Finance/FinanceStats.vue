...
<template>
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6 items-stretch">
        ...
        <div class="lg:col-span-5 grid grid-rows-[auto_1fr] gap-4">
            ...
            <div class="bg-white border border-slate-100 rounded-[2rem] px-6 py-5 shadow-sm hover:shadow-md transition-all relative overflow-hidden group flex items-center justify-between h-fit">
                <div class="flex-1 min-w-0"> 
                    ...
                    <div v-else class="flex items-center gap-2 w-full animate-in zoom-in-95 duration-200 mt-1">
                        <input 
                            ...
                            type="text" 
                            class="w-full bg-slate-50 border-none rounded-xl px-3 py-1.5 text-xl font-black text-slate-800 focus:ring-2 focus:ring-indigo-500 transition-all"
            ...
            <div class="grid grid-cols-2 gap-4 h-full min-h-[160px]">
                <div class="bg-emerald-50/40 border border-emerald-100/60 rounded-[2rem] p-5 flex flex-col justify-center relative overflow-hidden group hover:bg-emerald-50 transition-colors">
                    <div class="flex items-center justify-between mb-1">
                        <p class="text-[9px] font-bold text-emerald-600/60 uppercase tracking-widest">{{ $t('income', 'Income') }}</p>
                ...
                <div class="bg-rose-50/40 border border-rose-100/60 rounded-[2rem] p-5 flex flex-col justify-center relative overflow-hidden group hover:bg-rose-50 transition-colors">
                    <div class="flex items-center justify-between mb-1">
                        <p class="text-[9px] font-bold text-rose-600/60 uppercase tracking-widest">{{ $t('expense', 'Expense') }}</p>
