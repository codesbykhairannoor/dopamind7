...
// 1. Data Event dari Mapper
const dayData = computed(() => {
    if (!props.date) return null;
    return props.calendarDays.find(d => d.date === props.date) || null;
});

// 2. Data Super Detail dari Raw Backend (Inertia Props)
...
const dailyPlanner = computed(() => {
    ...
    // Pengecekan aman untuk format tanggal
...
// Hitung persentase tugas planner
    ...
    <Teleport to="body">
        ...
        >
            <div v-if="show" class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-hidden">
                ...
                >
                    <div v-if="show" class="relative w-full max-w-4xl bg-slate-50/95 backdrop-blur-2xl rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh] ring-1 ring-white/50">
