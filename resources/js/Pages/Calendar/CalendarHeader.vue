...
const selectMonth = (monthIndex) => {
    ...
    // Hitung offset selisih bulan biar controller tetep bisa pake logic + / - kalau diperlukan, 
    // Tapi karena kita pake Inertia visit berdasarkan YYYY-MM, kita langsung emit payload string tanggalnya.
...
<template>
    <div class="relative z-[60] px-4 py-4 transition-all bg-white/80 backdrop-blur-xl border-b shadow-sm border-slate-200 sm:px-6 lg:px-8 md:sticky md:top-0">
        <div class="flex flex-col items-center justify-between w-full gap-4 md:flex-row max-w-7xl mx-auto">
