        ...
        <div class="p-6 bg-white rounded-2xl relative overflow-hidden transition-all">
            ...
            <div class="space-y-5">
                ...
                <div class="flex justify-between items-center mt-8 pt-4 border-t border-slate-100">
                    <button v-if="isEditing" @click="remove(form.id)" type="button" 
                    ...
                    <div class="flex gap-3">
                        ...
                        <PrimaryButton @click="submit" :disabled="form.processing || conflictError" 
                            :class="[ '!rounded-xl !py-3 !px-6 transition-all', conflictError ? '!bg-slate-300 !cursor-not-allowed' : 'hover:shadow-lg hover:-translate-y-0.5' ]">
