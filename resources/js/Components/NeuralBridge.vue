        ...
        <div class="flex items-start gap-4 relative z-10">
            ...
            <div class="flex-1 min-w-0">
                <div class="flex items-center gap-2 mb-1">
                    <span class="text-[10px] font-black text-indigo-500 capitalize tracking-wide">{{ $t('neural_bridge_title', 'Neural Bridge') }}</span>
                ...
                <div v-else class="py-1">
                    ...
                    <template v-else>
                        <div class="flex items-center justify-between">
                            <p class="text-[10px] font-bold text-slate-400 dark:text-slate-500 capitalize tracking-wide">{{ $t('neural_bridge_limit', 'Neural insights require Quantum Plan') }}</p>
