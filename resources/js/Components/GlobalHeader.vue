                ...
                <Dropdown align="right" width="64">
                    ...
                    <template #content>
                        ...
                        <div class="p-1.5 space-y-0.5">
                            ...
                            <DropdownLink :href="route('settings.general')" class="flex items-center gap-2.5 px-3 py-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-all group">
