...
const showModule = (moduleName) =>
    user.value?.settings?.modules?.[moduleName] !== false;
    ...
    <div class="space-y-0.5" :class="isDrawer ? 'px-1' : ''">
        ...
        >
            <div
                ...
                class="h-px bg-slate-100 dark:bg-slate-800 w-full my-2"
            ></div>
            <template v-else>
                <span
        ...
        >
            <div
                v-show="coreExpanded || (!isDrawer && collapsed)"
                class="space-y-0.5"
            >
                <Link
        ...
        >
            ...
            <template v-else>
                <div class="flex items-center gap-1.5 ml-1">
                    ...
                    <div
                        v-if="isExplorer"
                        class="w-3 h-3 text-slate-300 dark:text-slate-700"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
        ...
        <template v-if="!isExplorer">
            <div class="px-2 py-1.5 mb-0.5" :class="isDrawer ? 'px-3' : ''">
                ...
                <span
                    v-else
                    class="text-[9px] font-black text-indigo-400/80 dark:text-indigo-600/80 tracking-wide ml-1"
                >
                    Neural OS
                </span>
            </div>
            ...
            >
                ...
                <span
                    v-if="showLabels"
                    class="text-[8px] font-black text-indigo-500 uppercase bg-indigo-100 dark:bg-indigo-500/20 px-1.5 py-0.5 rounded-full shrink-0"
                    >AI</span
                >
                <div
