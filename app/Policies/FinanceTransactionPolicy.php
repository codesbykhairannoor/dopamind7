...
class FinanceTransactionPolicy
{
    ...
    {
        return $user->id === $financeTransaction->user_id;
    }
     ...
     */
    public function restore(User $user, FinanceTransaction $financeTransaction): bool
    {
        //
    }
     ...
     */
    public function forceDelete(User $user, FinanceTransaction $financeTransaction): bool
    {
        //
    }
}
