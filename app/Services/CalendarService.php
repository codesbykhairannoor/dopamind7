...
class CalendarService
{
    ...
    {
        $cacheKey = "calendar_data_{$userId}_{$monthQuery}";

        return \Illuminate\Support\Facades\Cache::remember($cacheKey, now()->addHours(1), function () use ($userId, $monthQuery, $timezone) {
            try {
