    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="/favicon.png?v=2" alt="OneForMind Logo" class="w-8 h-8 transition-transform duration-500 group-hover:rotate-[360deg] group-hover:scale-110"${_scopeId}><span${_scopeId}>OneForMind<span class="text-indigo-400"${_scopeId}>.</span></span>`);
          } else {
            return [
              createVNode("img", {
                src: "/favicon.png?v=2",
      ...
      _push(`</div><button aria-label="Toggle mobile menu" class="md:hidden text-gray-600 p-2 rounded-lg hover:bg-gray-100 transition z-20">`);
