...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(_attrs)}><header><h2 class="text-lg font-black text-slate-800 dark:text-white uppercase tracking-widest flex items-center gap-2 transition-colors duration-500"> 🔒 ${ssrInterpolate(_ctx.$t("password_security_title", "Keamanan Sandi"))}</h2><p class="mt-1 text-sm text-slate-500 dark:text-slate-400 font-medium transition-colors duration-500">${ssrInterpolate(_ctx.$t("password_security_desc", "Pastikan akun Anda menggunakan kata sandi acak yang panjang agar tetap aman."))}</p></header><form class="mt-8 space-y-6"><div>`);
      ...
      _push(ssrRenderComponent(PrimaryButton, {
        ...
        class: "!rounded-xl !py-3.5 !px-8 !bg-slate-800 dark:!bg-slate-700 hover:!bg-slate-900 dark:hover:!bg-slate-600 !shadow-lg !shadow-slate-200 dark:!shadow-none !text-[11px] !font-black !uppercase !tracking-widest transition-all active:scale-95 transition-colors duration-500"
      }, {
