    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.dayData) {
              _push2(`<div class="bg-white rounded-2xl overflow-hidden shadow-xl" data-v-9873c298${_scopeId}><div class="bg-indigo-600 px-6 py-5 relative overflow-hidden text-white" data-v-9873c298${_scopeId}><div class="absolute -right-6 -top-6 w-32 h-32 bg-white/10 rounded-full blur-2xl" data-v-9873c298${_scopeId}></div><div class="relative z-10 flex justify-between items-start" data-v-9873c298${_scopeId}><div data-v-9873c298${_scopeId}><span class="text-indigo-200 text-[10px] font-bold uppercase tracking-widest" data-v-9873c298${_scopeId}>${ssrInterpolate(_ctx.$t("daily_detail"))}</span><h3 class="text-xl font-black mt-0.5 capitalize" data-v-9873c298${_scopeId}>${ssrInterpolate(formattedDate.value)}</h3></div><button class="bg-white/10 hover:bg-white/20 p-1.5 rounded-lg transition" data-v-9873c298${_scopeId}>✕</button></div><div class="flex gap-3 mt-4" data-v-9873c298${_scopeId}><div class="bg-white/10 backdrop-blur-sm border border-white/10 rounded-xl p-2.5 flex-1" data-v-9873c298${_scopeId}><span class="text-[10px] text-indigo-100 uppercase block font-bold" data-v-9873c298${_scopeId}>${ssrInterpolate(_ctx.$t("income"))}</span><span class="text-sm font-bold text-emerald-300" data-v-9873c298${_scopeId}>+ ${ssrInterpolate(unref(formatMoney)(__props.dayData.total_income))}</span></div><div class="bg-white/10 backdrop-blur-sm border border-white/10 rounded-xl p-2.5 flex-1" data-v-9873c298${_scopeId}><span class="text-[10px] text-indigo-100 uppercase block font-bold" data-v-9873c298${_scopeId}>${ssrInterpolate(_ctx.$t("expense"))}</span><span class="text-sm font-bold text-rose-300" data-v-9873c298${_scopeId}>- ${ssrInterpolate(unref(formatMoney)(__props.dayData.total_expense))}</span></div></div></div><div class="p-0 bg-slate-50 max-h-[60vh] overflow-y-auto custom-scrollbar" data-v-9873c298${_scopeId}><div class="divide-y divide-slate-100" data-v-9873c298${_scopeId}><!--[-->`);
              ssrRenderList(__props.dayData.transactions, (trx) => {
                _push2(`<div class="bg-white p-4 flex items-center gap-3 hover:bg-slate-50 transition group" data-v-9873c298${_scopeId}><div class="${ssrRenderClass([unref(getCategoryDetails)(trx.category, __props.categories).bg || "bg-slate-100", "w-10 h-10 rounded-xl flex items-center justify-center text-lg shrink-0 transition-colors"])}" data-v-9873c298${_scopeId}>${ssrInterpolate(unref(getCategoryDetails)(trx.category, __props.categories).icon)}</div><div class="flex-1 min-w-0" data-v-9873c298${_scopeId}><p class="font-bold text-slate-700 text-sm truncate" data-v-9873c298${_scopeId}>${ssrInterpolate(trx.title)}</p><span class="text-[10px] text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded capitalize" data-v-9873c298${_scopeId}>${ssrInterpolate(unref(getCategoryDetails)(trx.category, __props.categories).name)}</span></div><div class="text-right" data-v-9873c298${_scopeId}><p class="${ssrRenderClass([trx.type === "income" ? "text-emerald-600" : "text-slate-800", "font-bold text-sm font-mono mb-1"])}" data-v-9873c298${_scopeId}>${ssrInterpolate(trx.type === "income" ? "+" : "-")} ${ssrInterpolate(unref(formatMoney)(trx.amount))}</p><div class="flex gap-3 justify-end opacity-0 group-hover:opacity-100 transition-opacity" data-v-9873c298${_scopeId}><button class="text-[10px] font-bold text-indigo-500 hover:underline" data-v-9873c298${_scopeId}>${ssrInterpolate(_ctx.$t("edit"))}</button><button class="text-[10px] font-bold text-rose-400 hover:text-rose-600" data-v-9873c298${_scopeId}>${ssrInterpolate(_ctx.$t("delete"))}</button></div></div></div>`);
              });
              _push2(`<!--]--></div></div></div>`);
            } else {
              _push2(`<!---->`);
...
const ArchiveModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9873c298"]]);
export {
