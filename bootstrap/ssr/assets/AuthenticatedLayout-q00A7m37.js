    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$2, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="${ssrRenderClass([featureConfig.value.bg, "overflow-hidden relative group transition-all duration-500 z-[100]"])}" data-v-39fe93d9${_scopeId}><div class="absolute inset-0 opacity-[0.03] dark:opacity-[0.07] pointer-events-none" data-v-39fe93d9${_scopeId}>`);
            if (featureConfig.value.pattern === "pattern-grid") {
              _push2(`<div class="absolute inset-0" style="${ssrRenderStyle({ "background-image": "radial-gradient(#000 1px, transparent 1px)", "background-size": "20px 20px" })}" data-v-39fe93d9${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (featureConfig.value.pattern === "pattern-motion") {
              _push2(`<div class="absolute inset-0 overflow-hidden" data-v-39fe93d9${_scopeId}><!--[-->`);
              ssrRenderList(5, (i) => {
                _push2(`<div class="absolute h-px bg-white w-full rotate-[-45deg] transition-all" style="${ssrRenderStyle(`top: ${i * 20}%; left: -${i * 10}%;`)}" data-v-39fe93d9${_scopeId}></div>`);
              });
              _push2(`<!--]--></div>`);
            } else {
              _push2(`<!---->`);
            ...
            if (featureConfig.value.pattern === "pattern-quantum") {
              _push2(`<div class="absolute inset-0 overflow-hidden" data-v-39fe93d9${_scopeId}><!--[-->`);
              ssrRenderList(15, (i) => {
                _push2(`<div class="quantum-particle" style="${ssrRenderStyle(`top: ${Math.random() * 100}%; left: ${Math.random() * 100}%; animation-delay: ${Math.random() * 5}s`)}" data-v-39fe93d9${_scopeId}></div>`);
              });
              _push2(`<!--]--></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="${ssrRenderClass([featureConfig.value.accent, "absolute -top-24 -right-24 w-64 h-64 rounded-full blur-[80px] opacity-20"])}" data-v-39fe93d9${_scopeId}></div><div class="p-6 md:p-10 relative z-10" data-v-39fe93d9${_scopeId}><button class="absolute top-4 right-4 p-2 text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all hover:rotate-90" data-v-39fe93d9${_scopeId}>`);
            _push2(ssrRenderComponent(unref(X), { size: 20 }, null, _parent2, _scopeId));
            _push2(`</button><div class="relative mb-8" data-v-39fe93d9${_scopeId}><div class="${ssrRenderClass([[featureConfig.value.glow, featureConfig.value.isPremium ? "bg-gradient-to-br from-violet-600 to-indigo-600" : "bg-white dark:bg-slate-800"], "w-20 h-20 rounded-[2rem] flex items-center justify-center mx-auto shadow-2xl relative z-10 transition-transform duration-700 group-hover:scale-110"])}" data-v-39fe93d9${_scopeId}>`);
            ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(featureConfig.value.icon), {
              size: 32,
              class: featureConfig.value.isPremium ? "text-white" : featureConfig.value.color,
              "stroke-width": "2.5"
            }, null), _parent2, _scopeId);
            _push2(`</div><div class="${ssrRenderClass([featureConfig.value.color, "absolute inset-0 w-20 h-20 bg-current opacity-10 blur-xl rounded-full mx-auto"])}" data-v-39fe93d9${_scopeId}></div></div><div class="text-center mb-8" data-v-39fe93d9${_scopeId}><div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900/5 dark:bg-white/10 backdrop-blur-md mb-4 border border-white/10 shadow-sm" data-v-39fe93d9${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Sparkle), {
              size: 9,
              class: featureConfig.value.color,
              fill: "currentColor"
            }, null, _parent2, _scopeId));
            _push2(`<span class="text-[8px] font-black uppercase tracking-[0.3em] text-slate-600 dark:text-slate-300" data-v-39fe93d9${_scopeId}>${ssrInterpolate(_ctx.$t(featureConfig.value.isPremium ? "gating.lock_title_ai" : "gating.lock_title_required"))}</span></div><h3 class="${ssrRenderClass([featureConfig.value.isPremium ? "text-white" : "text-slate-900 dark:text-white", "text-3xl font-black tracking-tighter mb-3 leading-tight"])}" data-v-39fe93d9${_scopeId}>${ssrInterpolate(_ctx.$t(tKey("title")))}</h3><p class="${ssrRenderClass([featureConfig.value.isPremium ? "text-indigo-200/60" : "text-slate-500 dark:text-slate-400", "text-[11px] font-bold leading-relaxed max-w-[260px] mx-auto transition-colors"])}" data-v-39fe93d9${_scopeId}>${ssrInterpolate(_ctx.$t(tKey("description")))}</p></div><div class="space-y-2 mb-10" data-v-39fe93d9${_scopeId}><!--[-->`);
            ssrRenderList(3, (i) => {
              _push2(`<div class="${ssrRenderClass([featureConfig.value.isPremium ? "bg-white/5 hover:bg-white/10 border border-white/5" : "bg-white dark:bg-slate-800 shadow-sm hover:shadow-md border border-slate-100 dark:border-white/5", "flex items-center gap-3 p-3.5 rounded-2xl transition-all"])}" data-v-39fe93d9${_scopeId}><div class="${ssrRenderClass([featureConfig.value.isPremium ? "bg-indigo-500/20 text-indigo-400" : "bg-slate-50 dark:bg-slate-700 text-slate-400", "shrink-0 w-5 h-5 rounded-full flex items-center justify-center"])}" data-v-39fe93d9${_scopeId}>`);
              _push2(ssrRenderComponent(unref(CheckCircle2), { size: 12 }, null, _parent2, _scopeId));
              _push2(`</div><span class="${ssrRenderClass([featureConfig.value.isPremium ? "text-indigo-100" : "text-slate-700 dark:text-slate-200", "text-[11px] font-black tracking-tight"])}" data-v-39fe93d9${_scopeId}>${ssrInterpolate(_ctx.$t(tKey("benefit_" + i)))}</span></div>`);
            });
            _push2(`<!--]--></div><div class="space-y-3" data-v-39fe93d9${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("billing"),
              onClick: unref(closeGating),
              class: ["block w-full py-4 rounded-2xl font-black text-[11px] uppercase tracking-widest text-white shadow-2xl transition-all active:scale-95 flex items-center justify-center gap-3 group/btn relative overflow-hidden", featureConfig.value.isPremium ? "bg-indigo-600 hover:bg-indigo-500" : "bg-slate-900 dark:bg-indigo-600 hover:scale-[1.01]"]
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (featureConfig.value.isPremium) {
                    _push3(`<div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent translate-x-[-100%] group-hover/btn:translate-x-[100%] transition-transform duration-1000" data-v-39fe93d9${_scopeId2}></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
            ...
            _push2(`<button class="${ssrRenderClass([featureConfig.value.isPremium ? "text-indigo-400/60 hover:text-white" : "text-slate-400 hover:text-slate-900 dark:hover:text-white", "block w-full py-2 font-bold text-[9px] uppercase tracking-widest transition-colors"])}" data-v-39fe93d9${_scopeId}>${ssrInterpolate(_ctx.$t("gating.btn_stay"))}</button></div><div class="${ssrRenderClass([featureConfig.value.isPremium ? "border-white/5 text-indigo-200" : "border-slate-100 dark:border-white/5 text-slate-400", "mt-12 pt-8 border-t flex items-center justify-center gap-8 opacity-40 transition-colors"])}" data-v-39fe93d9${_scopeId}><div class="flex items-center gap-2" data-v-39fe93d9${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Gem), { size: 14 }, null, _parent2, _scopeId));
            _push2(`<span class="text-[8px] font-black uppercase tracking-widest" data-v-39fe93d9${_scopeId}>${ssrInterpolate(_ctx.$t("gating.tier_platinum"))}</span></div><div class="flex items-center gap-2" data-v-39fe93d9${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Sparkles), { size: 14 }, null, _parent2, _scopeId));
            _push2(`<span class="text-[8px] font-black uppercase tracking-widest" data-v-39fe93d9${_scopeId}>${ssrInterpolate(_ctx.$t("gating.tier_neural"))}</span></div></div></div></div>`);
          } else {
            return [
              createVNode("div", {
                ...
                createVNode("div", { class: "p-6 md:p-10 relative z-10" }, [
                  ...
                  createVNode("div", { class: "relative mb-8" }, [
                    createVNode("div", {
                      class: [[featureConfig.value.glow, featureConfig.value.isPremium ? "bg-gradient-to-br from-violet-600 to-indigo-600" : "bg-white dark:bg-slate-800"], "w-20 h-20 rounded-[2rem] flex items-center justify-center mx-auto shadow-2xl relative z-10 transition-transform duration-700 group-hover:scale-110"]
                    }, [
                    ...
                    createVNode("div", {
                      class: ["absolute inset-0 w-20 h-20 bg-current opacity-10 blur-xl rounded-full mx-auto", featureConfig.value.color]
                    }, null, 2)
                  ]),
                  createVNode("div", { class: "text-center mb-8" }, [
                    createVNode("div", { class: "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900/5 dark:bg-white/10 backdrop-blur-md mb-4 border border-white/10 shadow-sm" }, [
                      createVNode(unref(Sparkle), {
                        size: 9,
                        class: featureConfig.value.color,
                        fill: "currentColor"
                      }, null, 8, ["class"]),
                      createVNode("span", { class: "text-[8px] font-black uppercase tracking-[0.3em] text-slate-600 dark:text-slate-300" }, toDisplayString(_ctx.$t(featureConfig.value.isPremium ? "gating.lock_title_ai" : "gating.lock_title_required")), 1)
                    ]),
                    createVNode("h3", {
                      class: ["text-3xl font-black tracking-tighter mb-3 leading-tight", featureConfig.value.isPremium ? "text-white" : "text-slate-900 dark:text-white"]
                    }, toDisplayString(_ctx.$t(tKey("title"))), 3),
                    createVNode("p", {
                      class: ["text-[11px] font-bold leading-relaxed max-w-[260px] mx-auto transition-colors", featureConfig.value.isPremium ? "text-indigo-200/60" : "text-slate-500 dark:text-slate-400"]
                    }, toDisplayString(_ctx.$t(tKey("description"))), 3)
                  ]),
                  createVNode("div", { class: "space-y-2 mb-10" }, [
                    (openBlock(), createBlock(Fragment, null, renderList(3, (i) => {
                      return createVNode("div", {
                        key: i,
                        class: ["flex items-center gap-3 p-3.5 rounded-2xl transition-all", featureConfig.value.isPremium ? "bg-white/5 hover:bg-white/10 border border-white/5" : "bg-white dark:bg-slate-800 shadow-sm hover:shadow-md border border-slate-100 dark:border-white/5"]
                      }, [
                        createVNode("div", {
                          class: ["shrink-0 w-5 h-5 rounded-full flex items-center justify-center", featureConfig.value.isPremium ? "bg-indigo-500/20 text-indigo-400" : "bg-slate-50 dark:bg-slate-700 text-slate-400"]
                        }, [
                          createVNode(unref(CheckCircle2), { size: 12 })
                        ], 2),
                        createVNode("span", {
                          class: ["text-[11px] font-black tracking-tight", featureConfig.value.isPremium ? "text-indigo-100" : "text-slate-700 dark:text-slate-200"]
                  ...
                  createVNode("div", { class: "space-y-3" }, [
                    ...
                    createVNode("button", {
                      onClick: unref(closeGating),
                      class: ["block w-full py-2 font-bold text-[9px] uppercase tracking-widest transition-colors", featureConfig.value.isPremium ? "text-indigo-400/60 hover:text-white" : "text-slate-400 hover:text-slate-900 dark:hover:text-white"]
                    }, toDisplayString(_ctx.$t("gating.btn_stay")), 11, ["onClick"])
                  ]),
                  createVNode("div", {
                    class: ["mt-12 pt-8 border-t flex items-center justify-center gap-8 opacity-40 transition-colors", featureConfig.value.isPremium ? "border-white/5 text-indigo-200" : "border-slate-100 dark:border-white/5 text-slate-400"]
                  }, [
                    createVNode("div", { class: "flex items-center gap-2" }, [
                      createVNode(unref(Gem), { size: 14 }),
                      createVNode("span", { class: "text-[8px] font-black uppercase tracking-widest" }, toDisplayString(_ctx.$t("gating.tier_platinum")), 1)
                    ]),
                    createVNode("div", { class: "flex items-center gap-2" }, [
                      createVNode(unref(Sparkles), { size: 14 }),
                      createVNode("span", { class: "text-[8px] font-black uppercase tracking-widest" }, toDisplayString(_ctx.$t("gating.tier_neural")), 1)
                    ])
                  ], 2)
                ])
              ], 2)
...
const FeatureLockModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-39fe93d9"]]);
const _sfc_main = {
