...
import FinanceHeader from "./FinanceHeader-B5KKj48a.js";
import _sfc_main$1 from "./FinanceStats-Dry4iwQc.js";
import _sfc_main$3 from "./BudgetSidebar-DlpLOcrG.js";
import TransactionModal from "./TransactionModal-CD6rym4R.js";
import _sfc_main$4 from "./BudgetModal-CgJYjGfu.js";
import _sfc_main$5 from "./CategoryModal-DYpCHnR4.js";
import DailyTrendChart from "./DailyTrendChart-Ck63nC4N.js";
import ArchiveModal from "./ArchiveModal-BtEbKAKN.js";
import _sfc_main$2 from "./FinanceDatePicker-DmzoAmTw.js";
import FinanceBatchModal from "./FinanceBatchModal-RbCoPRVz.js";
import { u as useFinanceForm, F as FinanceInsights } from "./FinanceInsights-CXTulmbv.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (localTransactions.value.length === 0) {
        _push(`<div class="py-20 text-center bg-white rounded-[2rem] border border-slate-200/60 shadow-sm mt-4"><div class="flex flex-col items-center gap-4"><span class="text-5xl animate-bounce">💸</span><p class="text-sm font-bold text-slate-400 px-8">${ssrInterpolate(_ctx.$t("finance_empty_state", "Belum ada transaksi. Catat pengeluaran atau pemasukanmu hari ini!"))}</p><button class="mt-2 bg-rose-500 text-white font-black py-2.5 px-6 rounded-xl shadow-lg shadow-rose-100 hover:bg-rose-600 active:scale-95 transition-all outline-none"> + ${ssrInterpolate(_ctx.$t("finance_add_transaction", "Tambah Transaksi"))}</button></div></div>`);
      } else {
