...
import FinanceHeader from "./FinanceHeader-CXBun8xC.js";
import _sfc_main$1 from "./FinanceStats-C2gRuJuR.js";
import _sfc_main$5 from "./BudgetSidebar-CljMUTNv.js";
import TransactionModal from "./TransactionModal-BTbn80JU.js";
import _sfc_main$7 from "./BudgetModal-DX4_dtvu.js";
import _sfc_main$8 from "./CategoryModal-CJot4Lqc.js";
import DailyTrendChart from "./DailyTrendChart-BsQnYF-L.js";
import ArchiveModal from "./ArchiveModal-BYuAFBxR.js";
import FullArchiveModal from "./FullArchiveModal-CFlkSpPt.js";
import _sfc_main$3 from "./FinanceDatePicker-CxOhCf2w.js";
import FinanceBatchModal from "./FinanceBatchModal-Bd5fJvxn.js";
import { u as useFinanceForm, F as FinanceInsights } from "./FinanceInsights-B1E8q9T1.js";
import _sfc_main$4 from "./SavingCard-bP7CanOU.js";
import _sfc_main$9 from "./SavingModal-obtmYFfA.js";
import { _ as _sfc_main$6 } from "./NeuralBridge-IX-p3eB4.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isMobile.value) {
        ...
        _push(`</div><div class="space-y-6"><div class="flex items-center justify-between"><div class="flex items-center gap-3"><div class="w-10 h-10 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-500">`);
        ...
        if (localSavings.value.length === 0) {
          _push(`<div class="group bg-white dark:bg-slate-900 rounded-[2.5rem] border border-dashed border-slate-200 dark:border-slate-800 p-12 text-center transition-colors"><div class="mb-4 text-4xl transform group-hover:scale-110 transition-transform duration-500">🏦</div><h4 class="text-slate-400 font-black text-sm mb-4">You have no active saving goals yet.</h4><button class="text-[10px] font-black uppercase tracking-widest text-indigo-600 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900 px-6 py-2.5 rounded-xl hover:bg-indigo-50 dark:hover:bg-indigo-500/5 transition-all"> Start Saving Now </button></div>`);
        } else {
      ...
      _push(ssrRenderComponent(_sfc_main$9, {
        show: isSavingModalOpen.value,
        saving: editingSaving.value,
