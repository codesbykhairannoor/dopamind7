    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="bg-white rounded-[2.5rem] flex flex-col max-h-[90vh] relative overflow-hidden transition-all duration-300 border border-slate-100 shadow-2xl" data-v-e1d15172${_scopeId}>`);
            if (__props.conflictError) {
              _push2(`<div class="absolute top-0 left-0 right-0 bg-rose-500 text-white text-[10px] font-black px-6 py-3.5 text-center animate-in slide-in-from-top-full z-50 shadow-lg flex items-center justify-center gap-2 uppercase tracking-[0.1em] rounded-t-[2.5rem] shrink-0" data-v-e1d15172${_scopeId}><svg class="w-4 h-4 shrink-0 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3" data-v-e1d15172${_scopeId}><path d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" data-v-e1d15172${_scopeId}></path></svg><span data-v-e1d15172${_scopeId}>${ssrInterpolate(__props.conflictError)}</span></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="${ssrRenderClass([{ "mt-12": __props.conflictError }, "px-8 py-6 border-b border-slate-50 flex justify-between items-center bg-white shrink-0 z-20 rounded-t-[2.5rem]"])}" data-v-e1d15172${_scopeId}><div class="flex items-center gap-4" data-v-e1d15172${_scopeId}><div class="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center text-xl text-white shadow-lg shadow-indigo-100" data-v-e1d15172${_scopeId}> ✨ </div><div data-v-e1d15172${_scopeId}><h2 class="text-xl font-black text-slate-800 tracking-tight leading-none mb-1.5" data-v-e1d15172${_scopeId}>${ssrInterpolate(_ctx.$t("batch_mode_title", "Batch Finance"))}</h2><div class="relative" data-v-e1d15172${_scopeId}><button type="button" class="text-[10px] font-black text-indigo-700 bg-indigo-50 hover:bg-indigo-100 border border-indigo-100 rounded-lg px-2.5 py-1 transition-all uppercase tracking-widest flex items-center gap-2" data-v-e1d15172${_scopeId}><span data-v-e1d15172${_scopeId}>${ssrInterpolate(dateDisplay.value)}</span><span data-v-e1d15172${_scopeId}>📅</span></button>`);
            if (showDatePicker.value) {
              _push2(`<div class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-0 sm:absolute sm:top-full sm:left-0 sm:mt-2 sm:origin-top-left sm:block sm:inset-auto" data-v-e1d15172${_scopeId}><div class="fixed inset-0 bg-slate-900/40 backdrop-blur-sm sm:hidden" data-v-e1d15172${_scopeId}></div>`);
            ...
            _push2(`</div></div></div><div class="flex items-center gap-3" data-v-e1d15172${_scopeId}><button type="button" class="hidden sm:flex text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-xl border-2 border-slate-50 text-slate-400 hover:bg-indigo-50 hover:text-indigo-600 hover:border-indigo-100 transition-all active:scale-95 items-center gap-2" data-v-e1d15172${_scopeId}><span data-v-e1d15172${_scopeId}>↩️</span> ${ssrInterpolate(_ctx.$t("btn_single_mode", "Single Mode"))}</button><button class="w-10 h-10 rounded-xl bg-slate-50 text-slate-400 hover:bg-rose-50 hover:text-rose-500 transition-all active:scale-90 flex items-center justify-center font-bold" data-v-e1d15172${_scopeId}> ✕ </button></div></div><div class="flex-1 overflow-y-auto custom-scrollbar bg-slate-50/30 p-4 md:p-8" data-v-e1d15172${_scopeId}><div class="space-y-4" data-v-e1d15172${_scopeId}><!--[-->`);
            ssrRenderList(__props.form.transactions, (trx, index) => {
              _push2(`<div class="bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm relative group animate-in fade-in slide-in-from-bottom-4 duration-300" data-v-e1d15172${_scopeId}><div class="flex justify-between items-center mb-4" data-v-e1d15172${_scopeId}><span class="${ssrRenderClass([trx.type === "expense" ? "bg-rose-50 text-rose-500" : "bg-emerald-50 text-emerald-500", "text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-lg"])}" data-v-e1d15172${_scopeId}>${ssrInterpolate(_ctx.$t("transaction", "Transaksi"))} #${ssrInterpolate(index + 1)}</span><button type="button"${ssrIncludeBooleanAttr(__props.form.transactions.length <= 1) ? " disabled" : ""} class="${ssrRenderClass([{ "opacity-50 cursor-not-allowed": __props.form.transactions.length <= 1 }, "w-8 h-8 rounded-full bg-slate-50 text-slate-400 flex items-center justify-center hover:bg-rose-100 hover:text-rose-500 transition-all"])}" data-v-e1d15172${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3" data-v-e1d15172${_scopeId}><path d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-e1d15172${_scopeId}></path></svg></button></div><div class="grid grid-cols-1 sm:grid-cols-2 gap-4" data-v-e1d15172${_scopeId}><div class="space-y-4" data-v-e1d15172${_scopeId}><div data-v-e1d15172${_scopeId}><label class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1.5 ml-1 block" data-v-e1d15172${_scopeId}>${ssrInterpolate(_ctx.$t("type", "Tipe"))}</label><div class="flex bg-slate-50 p-1 rounded-xl h-11 border border-slate-100" data-v-e1d15172${_scopeId}><button type="button" class="${ssrRenderClass([trx.type === "expense" ? "bg-white text-rose-600 shadow-sm border border-slate-200" : "text-slate-400 hover:text-slate-600", "flex-1 rounded-lg text-[10px] font-black transition-all flex items-center justify-center tracking-wider uppercase"])}" data-v-e1d15172${_scopeId}>${ssrInterpolate(_ctx.$t("out", "Keluar"))}</button><button type="button" class="${ssrRenderClass([trx.type === "income" ? "bg-white text-emerald-600 shadow-sm border border-slate-200" : "text-slate-400 hover:text-slate-600", "flex-1 rounded-lg text-[10px] font-black transition-all flex items-center justify-center tracking-wider uppercase"])}" data-v-e1d15172${_scopeId}>${ssrInterpolate(_ctx.$t("in", "Masuk"))}</button></div></div><div data-v-e1d15172${_scopeId}><label class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1.5 ml-1 block" data-v-e1d15172${_scopeId}>${ssrInterpolate(_ctx.$t("category", "Kategori"))}</label><div class="relative" data-v-e1d15172${_scopeId}><select class="${ssrRenderClass([[
              ...
              ], "w-full pl-3 pr-8 h-11 !rounded-xl border-2 border-slate-200 bg-slate-50 focus:bg-white focus:ring-0 font-bold text-slate-700 capitalize text-xs appearance-none cursor-pointer transition-all"])}" data-v-e1d15172${_scopeId}><option value="" disabled data-v-e1d15172${ssrIncludeBooleanAttr(Array.isArray(trx.category) ? ssrLooseContain(trx.category, "") : ssrLooseEqual(trx.category, "")) ? " selected" : ""}${_scopeId}>${ssrInterpolate(_ctx.$t("select_placeholder", "Pilih..."))}</option><!--[-->`);
              ssrRenderList(getCategoriesByType(trx.type), (catSlug) => {
                _push2(`<option${ssrRenderAttr("value", catSlug)} data-v-e1d15172${ssrIncludeBooleanAttr(Array.isArray(trx.category) ? ssrLooseContain(trx.category, catSlug) : ssrLooseEqual(trx.category, catSlug)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(getDetail(catSlug).icon)} ${ssrInterpolate(getDetail(catSlug).name)}</option>`);
              });
              _push2(`<!--]--></select><div class="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400" data-v-e1d15172${_scopeId}><svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3" data-v-e1d15172${_scopeId}><path d="M19 9l-7 7-7-7" data-v-e1d15172${_scopeId}></path></svg></div></div></div></div><div class="space-y-4" data-v-e1d15172${_scopeId}><div data-v-e1d15172${_scopeId}><label class="${ssrRenderClass([trx.type === "expense" ? "text-rose-400" : "text-emerald-400", "text-[9px] font-black uppercase tracking-widest mb-1.5 ml-1 block"])}" data-v-e1d15172${_scopeId}>${ssrInterpolate(_ctx.$t("amount", "Nominal"))}</label><div class="relative group" data-v-e1d15172${_scopeId}><span class="${ssrRenderClass([trx.type === "expense" ? "text-rose-500" : "text-emerald-500", "absolute left-3 top-1/2 -translate-y-1/2 font-black text-[12px]"])}" data-v-e1d15172${_scopeId}>${ssrInterpolate(currencySymbol.value)}</span><input type="text"${ssrRenderAttr("value", formatDisplay(trx.amount))} placeholder="0" class="${ssrRenderClass([[
              ...
              ], "w-full h-11 pl-10 pr-3 !rounded-xl border-2 bg-white focus:ring-0 font-black text-sm transition-all"])}" data-v-e1d15172${_scopeId}></div></div><div data-v-e1d15172${_scopeId}><label class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1.5 ml-1 block" data-v-e1d15172${_scopeId}>${ssrInterpolate(_ctx.$t("description", "Keterangan"))}</label>`);
            ...
            _push2(`<!--]--></div><button type="button" class="mt-8 w-full py-4 border-2 border-dashed border-indigo-200 bg-indigo-50/50 rounded-2xl text-indigo-500 font-black uppercase tracking-widest text-[10px] hover:border-indigo-400 hover:bg-indigo-100 hover:text-indigo-600 transition-all flex items-center justify-center gap-3 active:scale-95 shadow-sm" data-v-e1d15172${_scopeId}><span class="w-5 h-5 rounded-md bg-indigo-200 text-indigo-700 flex items-center justify-center text-xs shadow-sm" data-v-e1d15172${_scopeId}>+</span> ${ssrInterpolate(_ctx.$t("btn_add_another_transaction", "Tambah Baris Transaksi"))}</button></div><div class="px-8 py-5 bg-white border-t border-slate-50 flex flex-col sm:flex-row justify-between items-center gap-4 shrink-0 rounded-b-[2.5rem]" data-v-e1d15172${_scopeId}><div class="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2" data-v-e1d15172${_scopeId}><span class="w-2 h-2 rounded-full bg-indigo-500" data-v-e1d15172${_scopeId}></span> ${ssrInterpolate(_ctx.$t("total_label", "Total Input:"))} <span class="text-indigo-600 text-sm font-black" data-v-e1d15172${_scopeId}>${ssrInterpolate(__props.form.transactions.length)}</span></div><div class="flex gap-3 w-full sm:w-auto" data-v-e1d15172${_scopeId}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (__props.form.processing) {
                    _push3(`<span data-v-e1d15172${_scopeId2}>...</span>`);
                  } else {
                    _push3(`<span data-v-e1d15172${_scopeId2}>${ssrInterpolate(_ctx.$t("btn_save_all_transactions", "Simpan Batch"))}</span>`);
                  }
                } else {
                  return [
...
const FinanceBatchModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e1d15172"]]);
export {
