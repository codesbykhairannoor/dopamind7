import { ref, watch, computed, reactive, resolveComponent, unref, withCtx, createTextVNode, toDisplayString, createVNode, useSSRContext } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderList } from "vue/server-renderer";
import { A as AuthenticatedLayout } from "./AuthenticatedLayout-Ckw7xNt_.js";
import { _ as _sfc_main$4 } from "./OneForMindIcon-Dc5dmmrC.js";
import { useForm, router, usePage, Head } from "@inertiajs/vue3";
import dayjs from "dayjs";
import FinanceHeader from "./FinanceHeader-1KwJgWYm.js";
import _sfc_main$1 from "./FinanceStats-BWtN-xqe.js";
import _sfc_main$3 from "./BudgetSidebar-DKCx_xTn.js";
import TransactionModal from "./TransactionModal-D3QVl4Jj.js";
import _sfc_main$5 from "./BudgetModal-D1pJfrVk.js";
import _sfc_main$6 from "./CategoryModal-CJot4Lqc.js";
import DailyTrendChart from "./DailyTrendChart-Bpd3Vvpw.js";
import ArchiveModal from "./ArchiveModal-CUOW5Fzr.js";
import _sfc_main$2 from "./FinanceDatePicker-BIQiyh9C.js";
import FinanceBatchModal from "./FinanceBatchModal-Dm1tanvG.js";
import { u as useFinanceForm, F as FinanceInsights } from "./FinanceInsights-CH0qgFz9.js";
import Swal from "sweetalert2";
import { u as useFinanceFormat } from "./useFinanceFormat-CRSb1fg_.js";
import { trans } from "laravel-vue-i18n";
import "dayjs/locale/id.js";
import "dayjs/locale/en.js";
import { u as useFinanceHistory } from "./useFinanceHistory-CCwjJukw.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    const { tier, canUse, isExplorer } = useGating();
    const props = __props;
    usePage();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-full min-h-screen bg-slate-50/50 dark:bg-slate-950/50 px-4 sm:px-6 lg:px-8 py-8 transition-colors duration-500"><div class="mb-8">`);
      ...
      _push(`</div>`);
      if (localTransactions.value.length && unref(canUse)("finance_charts")) {
        _push(ssrRenderComponent(DailyTrendChart, {
          transactions: localTransactions.value,
          currentDate: __props.filters.date,
          onDayClick: unref(openDetail)
        }, null, _parent));
      } else if (unref(isExplorer) && localTransactions.value.length) {
        _push(`<div class="bg-white dark:bg-slate-900 rounded-[2rem] p-8 border border-slate-200 dark:border-slate-800 text-center space-y-4"><div class="w-16 h-16 bg-indigo-50 dark:bg-indigo-500/10 rounded-2xl flex items-center justify-center mx-auto text-3xl">📊</div><h4 class="font-bold text-slate-800 dark:text-white uppercase tracking-widest text-[10px]">${ssrInterpolate(_ctx.$t("premium_feature"))}</h4><p class="text-xs text-slate-500 dark:text-slate-400 font-medium px-4">${ssrInterpolate(_ctx.$t("upgrade_for_charts", "Upgrade ke Architect untuk melihat grafik tren pengeluaran Anda."))}</p>`);
        _push(ssrRenderComponent(_component_Link, {
          href: _ctx.route("pricing.index"),
          class: "inline-block bg-indigo-600 text-white text-[10px] font-black px-4 py-2 rounded-lg shadow-lg shadow-indigo-100 dark:shadow-none uppercase tracking-widest hover:bg-indigo-700 transition-all"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(_ctx.$t("upgrade_now"))}`);
            } else {
              return [
                createTextVNode(toDisplayString(_ctx.$t("upgrade_now")), 1)
              ];
            }
          }),
          _: 1
      ...
      if (unref(canUse)("finance_budgeting")) {
        ...
        _push(`<div class="bg-gradient-to-br from-indigo-600 to-violet-700 rounded-[2.5rem] p-8 text-white shadow-xl shadow-indigo-200 dark:shadow-none relative overflow-hidden"><div class="absolute -right-10 -top-10 w-40 h-40 bg-white/10 rounded-full blur-3xl"></div><div class="relative z-10"><div class="w-12 h-12 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center mb-6 text-2xl">🎯</div><h3 class="text-xl font-black mb-2 tracking-tight">Master Your Budget</h3><p class="text-sm font-medium text-indigo-100/80 mb-6 leading-relaxed">Set limits for every category and take control of your financial destiny.</p>`);
        _push(ssrRenderComponent(_component_Link, {
          href: _ctx.route("pricing.index"),
          class: "flex items-center justify-center w-full bg-white text-indigo-600 font-black py-4 rounded-2xl shadow-lg hover:scale-[1.02] active:scale-95 transition-all text-xs uppercase tracking-widest"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(_ctx.$t("btn_unlock_architect", "Unlock Architect"))}`);
            } else {
              return [
                createTextVNode(toDisplayString(_ctx.$t("btn_unlock_architect", "Unlock Architect")), 1)
              ];
            }
          }),
          _: 1
      ...
      } else if (unref(tier) < 3) {
        _push(`<div class="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-none overflow-hidden relative group"><div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">`);
        _push(ssrRenderComponent(_sfc_main$4, {
          name: "premium",
          size: "100"
        }, null, _parent));
        _push(`</div><div class="relative z-10"><div class="inline-flex items-center gap-2 px-3 py-1 bg-amber-50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20 rounded-full mb-4"><span class="text-[10px] font-black text-amber-600 dark:text-amber-400 uppercase tracking-widest">Quantum Feature</span></div><h4 class="text-lg font-black text-slate-800 dark:text-white mb-2 leading-tight">AI Financial Pulse</h4><p class="text-xs text-slate-500 dark:text-slate-400 font-bold mb-6 leading-relaxed">Get predictive insights and automated audit of your spending patterns.</p>`);
        _push(ssrRenderComponent(_component_Link, {
          href: _ctx.route("pricing.index"),
          class: "text-xs font-black text-indigo-600 dark:text-indigo-400 hover:translate-x-1 transition-transform inline-flex items-center gap-2"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Learn More about Quantum `);
              ...
              return [
                createTextVNode(" Learn More about Quantum "),
