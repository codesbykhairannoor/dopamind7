...
import { _ as _sfc_main$5 } from "./OneForMindIcon-XdjRmiFl.js";
import { useForm, router, usePage, Head } from "@inertiajs/vue3";
import dayjs from "dayjs";
import FinanceHeader from "./FinanceHeader-BLjzDCQn.js";
...
import FullArchiveModal from "./FullArchiveModal-cLIY3vZn.js";
import _sfc_main$6 from "./FinanceDatePicker-CxOhCf2w.js";
import FinanceBatchModal from "./FinanceBatchModal-BoHUw9j9.js";
import { u as useFinanceForm, F as FinanceInsights } from "./FinanceInsights-Bb26wnio.js";
import _sfc_main$7 from "./SavingCard-C3qPUs9X.js";
import _sfc_main$a from "./SavingModal-BGDJzsry.js";
import _sfc_main$b from "./VaultTransactionModal-Bt0fhf-P.js";
import { _ as _sfc_main$4 } from "./LockedFeatureWall-DPg3CTtZ.js";
import { _ as _sfc_main$3 } from "./NeuralBridge-CPYzz-Jv.js";
import { Wallet, Lock, Plus, TrendingUp, ArrowRight } from "lucide-vue-next";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="lg:col-span-3 space-y-8 w-full order-2 lg:order-1 pb-24 lg:pb-0"><div class="hidden lg:block">`);
      _push(ssrRenderComponent(_sfc_main$3, { module: "Finance" }, null, _parent));
      _push(`<div class="relative">`);
      if (unref(isExplorer)) {
        _push(ssrRenderComponent(_sfc_main$4, {
          onClick: ($event) => openPremiumPreview()
        }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`</div></div><div class="space-y-4"><div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-1 lg:px-0"><div class="flex items-center gap-2"><h3 class="text-base lg:text-lg font-bold text-slate-800 dark:text-white transition-colors duration-500">${ssrInterpolate(_ctx.$t("daily_history"))}</h3>`);
      if (!unref(filterDate)) {
      ...
      if (!unref(filterDate)) {
        ...
        _push(`</span><span class="hidden sm:inline">${ssrInterpolate(_ctx.$t("view_full_archive", "Arsip Lengkap"))}</span><span class="sm:hidden">Archive</span></button>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`</div><div class="space-y-6 relative group"><div class="flex items-center justify-between px-1 lg:px-0"><div class="flex items-center gap-3"><div class="w-10 h-10 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-500 shadow-sm">`);
      _push(ssrRenderComponent(unref(Wallet), { size: 20 }, null, _parent));
      _push(`</div><div class="flex items-center gap-2"><div><h3 class="text-base lg:text-lg font-black text-slate-800 dark:text-white tracking-tight">The Vault</h3><p class="text-[9px] lg:text-[10px] font-black text-slate-400 tracking-widest leading-none mt-0.5">Your wealth manifestation</p></div>`);
      if (unref(isExplorer)) {
        _push(ssrRenderComponent(unref(Lock), {
          size: 12,
          class: "text-orange-500 animate-pulse ml-0.5"
        }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><button class="flex items-center gap-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-4 py-2.5 rounded-[1.25rem] text-[10px] font-black tracking-widest hover:scale-105 transition-all active:scale-95 shadow-xl shadow-slate-200 dark:shadow-none relative group/btn overflow-hidden"><div class="absolute inset-0 bg-gradient-to-tr from-white/10 to-transparent opacity-0 group-hover/btn:opacity-100 transition-opacity"></div>`);
      _push(ssrRenderComponent(unref(Plus), {
        size: 16,
        "stroke-width": "3"
      }, null, _parent));
      _push(`<span class="hidden sm:inline relative z-10">${ssrInterpolate(unref(isExplorer) ? "Unlock goal" : "Create goal")}</span><span class="sm:hidden relative z-10">Goal</span></button></div><div class="grid grid-cols-1 md:grid-cols-2 gap-8 relative">`);
      if (unref(isExplorer)) {
        _push(`<div class="absolute inset-x-0 -inset-y-4 z-40 rounded-[3rem] overflow-hidden group/locked-vault cursor-pointer transition-all duration-700 border border-slate-100 dark:border-slate-800 shadow-2xl"><div class="absolute inset-0 bg-white/60 dark:bg-slate-950/60 backdrop-blur-xl transition-all duration-700 group-hover/locked-vault:backdrop-blur-md"></div><div class="absolute inset-0 opacity-10 group-hover/locked-vault:opacity-30 transition-opacity duration-1000 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-orange-400 via-transparent to-transparent"></div><div class="relative z-10 h-full flex flex-col items-center justify-center p-8 text-center"><div class="max-w-xs animate-in zoom-in duration-500 space-y-4"><div class="w-16 h-16 bg-gradient-to-br from-orange-500 to-amber-600 rounded-2xl flex items-center justify-center mx-auto text-white shadow-xl rotate-3 group-hover/locked-vault:rotate-0 transition-transform">`);
        _push(ssrRenderComponent(unref(Wallet), {
          size: 32,
          "stroke-width": "2.5"
        }, null, _parent));
        _push(`</div><div><h4 class="text-xl font-black text-slate-900 dark:text-white mb-1 tracking-tight">${ssrInterpolate(_ctx.$t("gating.finance_vault.title"))}</h4><p class="text-[10px] font-bold text-slate-500 dark:text-slate-400 leading-relaxed px-4">${ssrInterpolate(_ctx.$t("gating.finance_vault.description"))}</p></div><div class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-orange-500 text-white font-black text-[9px] uppercase tracking-widest shadow-lg shadow-orange-200 dark:shadow-none hover:scale-105 transition-all">${ssrInterpolate(_ctx.$t("gating.btn_upgrade"))}</div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`<div class="relative bg-slate-900 dark:bg-indigo-950 rounded-[2.5rem] p-8 overflow-hidden group/forecast cursor-pointer hover:scale-[1.02] transition-all duration-500 shadow-2xl border border-slate-800"><div class="absolute inset-0 opacity-40 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-indigo-500 via-slate-900 to-black"></div><div class="relative z-10 flex flex-col h-full"><div class="flex items-center justify-between mb-6"><div class="flex items-center gap-3"><div class="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white">`);
      _push(ssrRenderComponent(unref(TrendingUp), { size: 20 }, null, _parent));
      _push(`</div><div><h4 class="text-xs font-black text-white tracking-widest">${ssrInterpolate(_ctx.$t("gating.finance_trends.title"))}</h4><p class="text-[9px] font-bold text-indigo-300 tracking-tighter">AI wealth prediction</p></div></div><div class="px-2 py-1 rounded-md bg-indigo-500 text-white text-[8px] font-black tracking-widest shadow-lg uppercase">Architect</div></div><div class="flex-1 flex items-end gap-1.5 h-24 mb-6 blur-[3px] group-hover:blur-[1px] transition-all duration-700 opacity-20 group-hover:opacity-40"><!--[-->`);
      ssrRenderList([30, 45, 35, 70, 85, 60, 100, 90, 110, 130], (h) => {
        _push(`<div style="${ssrRenderStyle({ height: h + "%" })}" class="flex-1 bg-gradient-to-t from-indigo-400 to-transparent rounded-t-sm"></div>`);
      });
      _push(`<!--]--></div><div class="mt-auto flex items-center justify-between"><span class="text-[10px] font-black text-indigo-200 tracking-widest uppercase">${ssrInterpolate(_ctx.$t("gating.btn_upgrade"))}</span>`);
      _push(ssrRenderComponent(unref(ArrowRight), {
        size: 16,
        class: "text-white group-hover:translate-x-1 transition-transform"
      }, null, _parent));
      _push(`</div></div><div class="absolute inset-0 bg-white/5 backdrop-blur-[1px] opacity-20 transition-opacity group-hover:opacity-0"></div></div></div></div><div class="lg:hidden relative">`);
      if (unref(isExplorer)) {
        _push(ssrRenderComponent(_sfc_main$4, {
          onClick: ($event) => openPremiumPreview()
        }, null, _parent));
