...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="grid grid-cols-2 gap-4 h-full min-h-[160px]"><div class="bg-emerald-50/40 dark:bg-emerald-500/5 border border-emerald-100/60 dark:border-emerald-500/20 rounded-[2rem] p-5 flex flex-col justify-center relative overflow-hidden group hover:bg-emerald-50 dark:hover:bg-emerald-500/10 shadow-sm dark:shadow-none transition-colors duration-500"><div class="flex items-center justify-between mb-1"><p class="text-[9px] font-black text-emerald-600/60 dark:text-emerald-400/60 tracking-widest transition-colors duration-500">${ssrInterpolate(_ctx.$t("income"))}</p><div class="w-5 h-5 bg-emerald-100 dark:bg-emerald-500/20 rounded-full flex items-center justify-center text-[10px] text-emerald-600 dark:text-emerald-400 group-hover:scale-110 transition duration-300">↓</div></div><h4 class="text-lg md:text-xl font-black text-emerald-700 dark:text-emerald-400 truncate transition-colors duration-500">${ssrInterpolate(unref(formatMoney)(((_c = __props.stats) == null ? void 0 : _c.total_income) || 0))}</h4></div><div class="bg-rose-50/40 dark:bg-rose-500/5 border border-rose-100/60 dark:border-rose-500/20 rounded-[2rem] p-5 flex flex-col justify-center relative overflow-hidden group hover:bg-rose-50 dark:hover:bg-rose-500/10 shadow-sm dark:shadow-none transition-colors duration-500"><div class="flex items-center justify-between mb-1"><p class="text-[9px] font-black text-rose-600/60 dark:text-rose-400/60 tracking-widest transition-colors duration-500">${ssrInterpolate(_ctx.$t("expense"))}</p><div class="w-5 h-5 bg-rose-100 dark:bg-rose-500/20 rounded-full flex items-center justify-center text-[10px] text-rose-600 dark:text-rose-400 group-hover:scale-110 transition duration-300">↑</div></div><h4 class="text-lg md:text-xl font-black text-rose-700 dark:text-rose-400 truncate transition-colors duration-500">${ssrInterpolate(unref(formatMoney)(((_d = __props.stats) == null ? void 0 : _d.total_expense) || 0))}</h4></div></div></div></div>`);
    };
  }
};
