      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (__props.show) {
          ...
          _push2(ssrRenderComponent(unref(Link), {
            ...
            class: "col-span-2 bg-orange-500 rounded-3xl p-5 text-white relative overflow-hidden group shadow-lg shadow-orange-200 hover:-translate-y-1 transition-transform"
          }, {
