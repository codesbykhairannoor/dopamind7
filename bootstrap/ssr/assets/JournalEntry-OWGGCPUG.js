...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const fontFamilies = [
      ...
      { name: "Writing", value: "Outfit, sans-serif" }
    ];
    const fontSizes = [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div>`);
      if (unref(editor)) {
        _push(`<div class="sticky top-20 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md p-2 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xl flex flex-wrap items-center gap-1 mb-10 w-full sm:w-fit transition-all duration-500 overflow-visible group/toolbar"><button class="${ssrRenderClass([{ "bg-indigo-600 text-white shadow-lg shadow-indigo-100 dark:shadow-none": unref(editor).isActive("bold") }, "w-10 h-10 rounded-xl flex items-center justify-center hover:bg-slate-100 dark:hover:bg-slate-800 transition-all active:scale-95 group/btn relative"])}">`);
        ...
        if (showFontMenu.value) {
          _push(`<div class="absolute top-full left-0 mt-2 w-48 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl p-2 z-[100] animate-in fade-in zoom-in-95 duration-200 border border-slate-100 dark:border-slate-800"><!--[-->`);
        ...
        if (showSizeMenu.value) {
          _push(`<div class="absolute top-full left-0 mt-2 w-40 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl p-2 z-[100] animate-in fade-in zoom-in-95 duration-200 border border-slate-100 dark:border-slate-800"><!--[-->`);
        ...
        _push(`<span class="absolute -top-10 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[9px] px-2 py-1 rounded opacity-0 group-hover/btn:opacity-100 transition-opacity whitespace-nowrap pointer-events-none font-bold">Daftar</span></button><div class="w-px h-6 bg-slate-200 dark:bg-slate-800 mx-1 self-center"></div><div class="relative"><button class="${ssrRenderClass([[isListening.value ? "bg-rose-500 text-white animate-pulse" : "hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300"], "w-10 h-10 rounded-xl flex items-center justify-center transition-all active:scale-95 group/btn relative overflow-hidden"])}">`);
        _push(ssrRenderComponent(unref(Mic), {
          class: ["w-4 h-4", { "animate-bounce": isListening.value }]
        }, null, _parent));
        if (unref(isExplorer)) {
