...
import _sfc_main$3 from "./JobFilterBar-CZWFXXJh.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="min-h-screen bg-[#f8fafc] pb-24"><div class="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-sm"><div class="w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-5"><div class="flex items-center gap-4"><div class="flex items-center gap-3"><div class="w-12 h-12 flex items-center justify-center text-white bg-indigo-600 rounded-xl shadow-lg shadow-indigo-200 shrink-0">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "job",
        size: "28"
      }, null, _parent));
      _push(`</div><div><h1 class="text-xl md:text-2xl font-black leading-tight tracking-tight text-slate-800 flex items-center gap-2">${ssrInterpolate(_ctx.$t("job_page_title", "Job Tracker"))} `);
      ...
      _push(`</h1><p class="mt-0.5 text-sm font-medium capitalize text-slate-500">${ssrInterpolate(todayDate.value)}</p></div></div><button class="ml-auto bg-indigo-600 text-white font-bold py-2.5 px-6 rounded-xl shadow-md shadow-indigo-200 hover:bg-indigo-700 active:scale-[0.98] transition-all flex items-center gap-2 shrink-0">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "plus",
        size: "18",
        "stroke-width": "3"
      }, null, _parent));
      _push(` ${ssrInterpolate(_ctx.$t("job_add_row", "Tambah Baris"))}</button></div></div></div><div class="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8">`);
      if (unref(localStats)) {
