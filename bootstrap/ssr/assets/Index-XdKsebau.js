...
import _sfc_main$1 from "./PlannerHeader-DFRbaZqC.js";
import _sfc_main$3 from "./PlannerSidebar-BUTNmmcp.js";
import PlannerTimeline from "./PlannerTimeline-DHlmGrse.js";
import _sfc_main$4 from "./PlannerModal-D_VFpSmt.js";
import PlannerBatchModal from "./PlannerBatchModal-Tyj_ZcKU.js";
import { _ as _sfc_main$2 } from "./NeuralBridge-CYzFQSZe.js";
import "./OneForMindIcon-BMUpA12P.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-full min-h-screen bg-slate-50/50 dark:bg-slate-950 px-4 sm:px-6 lg:px-8 py-8 transition-colors duration-500"><div class="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start"><div class="lg:col-span-3 order-1 lg:order-2 w-full">`);
