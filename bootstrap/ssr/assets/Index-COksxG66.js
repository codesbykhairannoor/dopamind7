...
import { A as AuthenticatedLayout } from "./AuthenticatedLayout-B5rMP2TX.js";
              ...
              createVNode("div", { class: "max-w-3xl mx-auto py-12 px-4 sm:px-6 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500" }, [
                ...
                createVNode("div", { class: "bg-white rounded-[2.5rem] p-6 sm:p-8 shadow-sm border border-slate-100" }, [
                  ...
                  createVNode("form", { class: "space-y-4" }, [
                    createVNode("div", { class: "flex items-center justify-between p-5 bg-slate-50 rounded-[1.5rem] border border-slate-100 hover:border-indigo-200 transition-colors" }, [
                      createVNode("div", { class: "flex items-center gap-4" }, [
                        createVNode("div", { class: "w-12 h-12 bg-white rounded-xl flex items-center justify-center text-2xl shadow-sm" }, "🌱"),
                        createVNode("div", null, [
                          createVNode("h4", { class: "font-black text-slate-700 text-sm sm:text-base" }, toDisplayString(_ctx.$t("habit_page_title", "Habit Tracker")), 1),
                          createVNode("p", { class: "text-[11px] font-medium text-slate-500" }, toDisplayString(_ctx.$t("module_habit_desc", "Pantau kebiasaan harianmu")), 1)
                        ])
                      ]),
                      createVNode("label", { class: "relative inline-flex items-center cursor-pointer" }, [
                        ...
                        createVNode("div", { class: "w-12 h-7 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[4px] after:left-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-500 shadow-inner" })
                      ])
                    ]),
                    createVNode("div", { class: "flex items-center justify-between p-5 bg-slate-50 rounded-[1.5rem] border border-slate-100 hover:border-indigo-200 transition-colors" }, [
                      createVNode("div", { class: "flex items-center gap-4" }, [
                        createVNode("div", { class: "w-12 h-12 bg-white rounded-xl flex items-center justify-center text-2xl shadow-sm" }, "📋"),
                        createVNode("div", null, [
                          createVNode("h4", { class: "font-black text-slate-700 text-sm sm:text-base" }, "Daily Planner"),
                          createVNode("p", { class: "text-[11px] font-medium text-slate-500" }, toDisplayString(_ctx.$t("module_planner_desc", "Jadwal & Agenda Harian")), 1)
                        ])
                      ]),
                      createVNode("label", { class: "relative inline-flex items-center cursor-pointer" }, [
                        withDirectives(createVNode("input", {
                    ...
                    createVNode("div", { class: "flex items-center justify-between p-5 bg-slate-50 rounded-[1.5rem] border border-slate-100 hover:border-indigo-200 transition-colors" }, [
                      createVNode("div", { class: "flex items-center gap-4" }, [
                        createVNode("div", { class: "w-12 h-12 bg-white rounded-xl flex items-center justify-center text-2xl shadow-sm" }, "💸"),
                        createVNode("div", null, [
                          createVNode("h4", { class: "font-black text-slate-700 text-sm sm:text-base" }, "Finance Management"),
                          createVNode("p", { class: "text-[11px] font-medium text-slate-500" }, toDisplayString(_ctx.$t("module_finance_desc", "Atur budget & pengeluaran")), 1)
                        ])
                      ]),
                      createVNode("label", { class: "relative inline-flex items-center cursor-pointer" }, [
                        withDirectives(createVNode("input", {
                    ...
                    createVNode("div", { class: "flex items-center justify-between p-5 bg-slate-50 rounded-[1.5rem] border border-slate-100 hover:border-indigo-200 transition-colors" }, [
                      createVNode("div", { class: "flex items-center gap-4" }, [
                        createVNode("div", { class: "w-12 h-12 bg-white rounded-xl flex items-center justify-center text-2xl shadow-sm" }, "📓"),
                        createVNode("div", null, [
                          createVNode("h4", { class: "font-black text-slate-700 text-sm sm:text-base" }, "Journal"),
                          createVNode("p", { class: "text-[11px] font-medium text-slate-500" }, toDisplayString(_ctx.$t("module_journal_desc", "Catat kegiatan harian")), 1)
                        ])
                      ]),
                      createVNode("label", { class: "relative inline-flex items-center cursor-pointer" }, [
                        withDirectives(createVNode("input", {
                    ...
                    createVNode("div", { class: "flex items-center justify-between p-5 bg-slate-50 rounded-[1.5rem] border border-slate-100 hover:border-indigo-200 transition-colors" }, [
                      createVNode("div", { class: "flex items-center gap-4" }, [
                        createVNode("div", { class: "w-12 h-12 bg-white rounded-xl flex items-center justify-center text-2xl shadow-sm" }, "📅"),
                        createVNode("div", null, [
                          createVNode("h4", { class: "font-black text-slate-700 text-sm sm:text-base" }, "Calendar"),
                          createVNode("p", { class: "text-[11px] font-medium text-slate-500" }, "Jadwal Kalender Global")
                        ])
                      ]),
                      createVNode("label", { class: "relative inline-flex items-center cursor-pointer" }, [
                        withDirectives(createVNode("input", {
