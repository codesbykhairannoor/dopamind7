...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full md:max-w-[95%] mx-auto md:px-2 pt-2 md:pt-8 pb-20" }, _attrs))} data-v-0201bc14>`);
      if (__props.localHabits.length > 0) {
        _push(`<div class="md:hidden space-y-6" data-v-0201bc14><div class="relative" data-v-0201bc14><div class="flex gap-3 overflow-x-auto no-scrollbar scroll-smooth px-4 py-2" data-v-0201bc14><!--[-->`);
        ssrRenderList(__props.monthDates, (day) => {
          ...
          ], "flex-shrink-0 w-12 py-3 rounded-2xl flex flex-col items-center gap-1 transition-all duration-300"])}" data-v-0201bc14><span class="text-[10px] font-bold uppercase tracking-tighter opacity-80" data-v-0201bc14>${ssrInterpolate(day.dayName)}</span><span class="text-sm font-black" data-v-0201bc14>${ssrInterpolate(day.dayNumber)}</span></button>`);
        });
        _push(`<!--]--></div></div><div class="space-y-3 px-4" data-v-0201bc14><!--[-->`);
        ssrRenderList(__props.localHabits, (habit) => {
          _push(`<div class="${ssrRenderClass([{ "opacity-60 grayscale-[0.4] scale-[0.97]": habit.is_stagnant }, "bg-white dark:bg-slate-900 p-4 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-4 transition-all active:scale-[0.98]"])}" data-v-0201bc14><div class="${ssrRenderClass([{ "rotate-12": habit.is_stagnant }, "w-12 h-12 rounded-2xl flex items-center justify-center text-2xl shrink-0 transition-transform"])}" style="${ssrRenderStyle({ backgroundColor: habit.color + "15", color: habit.color })}" data-v-0201bc14>${ssrInterpolate(habit.icon)}</div><div class="flex-1 min-w-0" data-v-0201bc14><div class="flex items-center justify-between gap-2" data-v-0201bc14><h4 class="${ssrRenderClass([habit.is_stagnant ? "text-slate-400 dark:text-slate-500" : "text-slate-700 dark:text-white", "font-bold truncate text-sm flex items-center gap-1.5"])}" data-v-0201bc14>${ssrInterpolate(habit.name)} `);
          if (habit.is_stagnant) {
            _push(`<span class="text-[8px] font-black bg-rose-50 text-rose-500 px-1 rounded-md uppercase" data-v-0201bc14>Dormant</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</h4><div class="flex items-center gap-1 opacity-100" data-v-0201bc14><button class="p-2 text-slate-300 dark:text-slate-600 hover:text-rose-500 bg-slate-50 dark:bg-slate-800/50 rounded-lg" data-v-0201bc14>`);
          _push(ssrRenderComponent(_sfc_main$1, {
            name: "trash",
            size: "14"
          }, null, _parent));
          _push(`</button></div></div><div class="flex items-center gap-2 mt-1" data-v-0201bc14><div class="flex-1 h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden" data-v-0201bc14><div class="h-full rounded-full transition-all duration-500" style="${ssrRenderStyle({ width: habit.progress_percent + "%", backgroundColor: habit.color })}" data-v-0201bc14></div></div><span class="text-[10px] font-black text-slate-400 dark:text-slate-500" data-v-0201bc14>${ssrInterpolate(Math.round(habit.progress_percent))}%</span></div></div><button class="${ssrRenderClass([[
          ...
          if (__props.getStatus(habit, selectedDate.value) === "completed") {
            ...
            _push(`<span class="text-xl font-black" data-v-0201bc14>-</span>`);
          } else {
            _push(ssrRenderComponent(_sfc_main$1, {
              name: "plus",
              size: "20",
        ...
        _push(`<!--]--></div><p class="text-[10px] text-center text-slate-400 font-medium px-10 leading-relaxed" data-v-0201bc14> 💡 ${ssrInterpolate(_ctx.$t("habit_mobile_hint", "Tekan sekali untuk SELESAI, tahan (hold) untuk SKIP keesokan harinya."))}</p></div>`);
      } else {
        _push(`<div class="md:hidden py-16 text-center bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-200/60 dark:border-slate-800 shadow-sm flex flex-col items-center gap-4" data-v-0201bc14><span class="text-5xl animate-bounce" data-v-0201bc14>🌱</span><p class="text-xs font-bold text-slate-400 dark:text-slate-500 px-10" data-v-0201bc14>${ssrInterpolate(_ctx.$t("habit_empty", "Belum ada habit aktif. Tambah satu yuk!"))}</p><button class="mt-2 bg-indigo-600 text-white font-black py-2.5 px-6 rounded-xl shadow-lg shadow-indigo-100 dark:shadow-none hover:bg-indigo-700 active:scale-95 transition-all outline-none" data-v-0201bc14> + ${ssrInterpolate(_ctx.$t("habit_btn_add", "Tambah Habit"))}</button></div>`);
      }
      if (__props.localHabits.length > 0) {
        _push(`<div class="hidden md:block bg-white dark:bg-slate-900 md:rounded-[2.5rem] shadow-sm md:shadow-[0_2px_20px_rgba(0,0,0,0.04)] dark:shadow-none border border-slate-100 dark:border-slate-800 overflow-hidden relative" data-v-0201bc14><div class="overflow-x-auto custom-scrollbar relative select-none" data-v-0201bc14><div class="sticky top-0 z-30 bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 flex shadow-sm" data-v-0201bc14><div class="sticky left-0 z-40 bg-white dark:bg-slate-900 w-72 shrink-0 border-r border-slate-100 dark:border-slate-800 p-4 flex items-center font-bold text-slate-400 dark:text-slate-500 text-xs uppercase tracking-wider shadow-[10px_0_20px_rgba(0,0,0,0.02)] dark:shadow-[10px_0_20px_rgba(0,0,0,0.2)]" data-v-0201bc14><div class="w-8 shrink-0" data-v-0201bc14></div><span class="truncate" data-v-0201bc14>${ssrInterpolate(_ctx.$t("habit_name"))}</span></div><div class="flex items-center px-4 py-3 gap-1.5" data-v-0201bc14><!--[-->`);
        ssrRenderList(__props.monthDates, (day) => {
          _push(`<div class="w-8 shrink-0 flex flex-col items-center gap-1" data-v-0201bc14><span class="text-[10px] font-bold text-slate-400 capitalize" data-v-0201bc14>${ssrInterpolate(day.dayName)}</span><span class="${ssrRenderClass([day.isToday ? "text-indigo-600 bg-indigo-50 dark:bg-indigo-500/10 px-1.5 rounded" : "", "text-xs font-black text-slate-600 dark:text-slate-300"])}" data-v-0201bc14>${ssrInterpolate(day.dayNumber)}</span></div>`);
        });
        _push(`<!--]--></div><div class="flex shrink-0 sticky right-0 z-40 bg-white dark:bg-slate-900 w-32 p-4 border-l border-slate-100 dark:border-slate-800 items-center justify-end font-bold text-slate-400 dark:text-slate-500 text-xs uppercase tracking-wider shadow-[-10px_0_20px_rgba(255,255,255,0.8)] dark:shadow-[-10px_0_20px_rgba(15,23,42,0.8)]" data-v-0201bc14>${ssrInterpolate(_ctx.$t("habit_table_total"))}</div></div>`);
        _push(ssrRenderComponent(unref(draggable), {
          ...
          item: withCtx(({ element: habit, index: hIndex }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex transition-colors duration-200 group relative bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800" data-v-0201bc14${_scopeId}><div class="sticky left-0 z-30 w-72 shrink-0 bg-white dark:bg-slate-900 group-hover:bg-slate-50 dark:group-hover:bg-slate-800 border-r border-slate-100 dark:border-slate-800 p-4 flex items-center gap-3 flex-shrink-0 shadow-[10px_0_20px_rgba(0,0,0,0.02)] dark:shadow-[10px_0_20px_rgba(0,0,0,0.2)]" data-v-0201bc14${_scopeId}><div class="drag-handle cursor-grab active:cursor-grabbing text-slate-300 dark:text-slate-700 hover:text-indigo-500 opacity-30 group-hover:opacity-100 transition-opacity p-1 -ml-2 shrink-0" data-v-0201bc14${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                name: "menu",
                size: "20"
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="w-10 h-10 rounded-xl flex items-center justify-center text-xl bg-slate-50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800 shrink-0" style="${ssrRenderStyle({ color: habit.color })}" data-v-0201bc14${_scopeId}>${ssrInterpolate(habit.icon)}</div><div class="flex items-center gap-1 bg-white/95 dark:bg-slate-800/95 backdrop-blur-md px-1.5 py-1 rounded-full absolute right-2 top-2 shadow-xl border border-slate-200/50 dark:border-slate-700 z-50 transition-all opacity-0 scale-90 translate-x-1 group-hover:opacity-100 group-hover:scale-100 group-hover:translate-x-0" data-v-0201bc14${_scopeId}><button class="p-1.5 text-slate-400 dark:text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 rounded-full transition" title="Edit" data-v-0201bc14${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                name: "planner",
                size: "14",
                "stroke-width": "2.5"
              }, null, _parent2, _scopeId));
              _push2(`</button><button class="p-1.5 text-slate-400 dark:text-slate-500 hover:text-rose-500 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-500/10 rounded-full transition" title="Hapus" data-v-0201bc14${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                name: "trash",
                size: "14",
                "stroke-width": "2.5"
              }, null, _parent2, _scopeId));
              _push2(`</button></div><div class="min-w-0 flex-1" data-v-0201bc14${_scopeId}><h4 class="${ssrRenderClass([habit.is_stagnant ? "text-slate-400 line-through decoration-rose-500/30" : "text-slate-700 dark:text-slate-200", "font-bold truncate text-sm flex items-center gap-1.5"])}" data-v-0201bc14${_scopeId}>${ssrInterpolate(habit.name)} `);
              if (habit.streak > 1) {
                _push2(`<span class="inline-flex items-center gap-0.5 px-1.5 py-0.5 bg-orange-50 dark:bg-orange-500/10 text-orange-600 dark:text-orange-400 rounded-lg text-[10px] font-black animate-pulse shadow-sm border border-orange-100/50 dark:border-orange-500/20" data-v-0201bc14${_scopeId}>${ssrInterpolate(habit.streak)} <span class="text-xs" data-v-0201bc14${_scopeId}>🔥</span></span>`);
              } else {
                _push2(`<!---->`);
              }
              if (habit.is_stagnant) {
                _push2(`<span class="text-[8px] font-black bg-rose-50 text-rose-500 px-1.5 py-0.5 rounded-md uppercase tracking-tighter" data-v-0201bc14${_scopeId}>Dormant</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</h4><div class="flex items-center gap-1 text-[10px] font-medium text-slate-400 dark:text-slate-500 mb-1.5 mt-0.5" data-v-0201bc14${_scopeId}><span data-v-0201bc14${_scopeId}>🎯 Target: ${ssrInterpolate(habit.monthly_target)}</span></div><div class="flex items-center gap-2" data-v-0201bc14${_scopeId}><div class="h-1.5 w-16 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden" data-v-0201bc14${_scopeId}><div class="h-full rounded-full transition-all duration-300" style="${ssrRenderStyle({ width: habit.progress_percent + "%", backgroundColor: habit.color })}" data-v-0201bc14${_scopeId}></div></div></div></div></div><div class="flex items-center px-4 py-3 gap-1.5 pointer-events-auto" data-v-0201bc14${_scopeId}><!--[-->`);
              ssrRenderList(__props.monthDates, (day, dIndex) => {
                _push2(`<div class="w-8 shrink-0 flex justify-center" data-v-0201bc14${_scopeId}><button${ssrRenderAttr("id", `cell-${hIndex}-${dIndex}`)}${ssrIncludeBooleanAttr(day.isFuture) ? " disabled" : ""} tabindex="0" class="${ssrRenderClass([{
                ...
                if (__props.getStatus(habit, day.dateString) === "skipped") {
                  _push2(`<span class="text-xs font-bold animate-in fade-in duration-300" data-v-0201bc14${_scopeId}>-</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</button></div>`);
              });
              _push2(`<!--]--></div><div class="flex shrink-0 sticky right-0 z-30 w-32 bg-white dark:bg-slate-900 group-hover:bg-slate-50 group-hover:dark:bg-slate-800/80 border-l border-slate-100 dark:border-slate-800 p-4 flex-col justify-center shadow-[-10px_0_20px_rgba(255,255,255,0.8)] dark:shadow-[-10px_0_20px_rgba(15,23,42,0.8)]" data-v-0201bc14${_scopeId}><div class="flex justify-between items-end mb-1" data-v-0201bc14${_scopeId}><span class="text-lg font-black text-slate-700 dark:text-slate-200" data-v-0201bc14${_scopeId}>${ssrInterpolate(habit.progress_count)}</span><span class="text-[10px] font-bold text-slate-400 dark:text-slate-500 mb-1" data-v-0201bc14${_scopeId}>${ssrInterpolate(Math.round(habit.progress_percent))}%</span></div><div class="w-full bg-slate-200 dark:bg-slate-800 rounded-full h-1.5 overflow-hidden" data-v-0201bc14${_scopeId}><div class="h-full rounded-full transition-all duration-500" style="${ssrRenderStyle({ width: habit.progress_percent + "%", backgroundColor: habit.color })}" data-v-0201bc14${_scopeId}></div></div></div></div>`);
            } else {
              return [
      ...
      if (__props.localHabits.length === 0) {
        _push(`<div class="hidden md:flex justify-center w-full px-4" data-v-0201bc14><div class="py-20 text-center bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-200/60 dark:border-slate-800 shadow-sm mt-4 w-full max-w-4xl" data-v-0201bc14><div class="flex flex-col items-center gap-4" data-v-0201bc14><span class="text-5xl animate-bounce" data-v-0201bc14>🌱</span><p class="text-sm font-bold text-slate-400 dark:text-slate-500 px-8" data-v-0201bc14>${ssrInterpolate(_ctx.$t("habit_empty", "Belum ada habit aktif. Tambah satu yuk!"))}</p><button class="mt-2 bg-indigo-600 text-white font-black py-2.5 px-6 rounded-xl shadow-lg shadow-indigo-100 dark:shadow-none hover:bg-indigo-700 active:scale-95 transition-all outline-none" data-v-0201bc14> + ${ssrInterpolate(_ctx.$t("habit_btn_add", "Tambah Habit"))}</button></div>`);
        if (__props.hasPrevHabits) {
          _push(`<div class="mt-8 flex justify-center" data-v-0201bc14><button class="px-6 py-3 rounded-xl font-bold text-indigo-600 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 transition" data-v-0201bc14>📂 ${ssrInterpolate(_ctx.$t("habit_salin_btn"))}</button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
...
const HabitGrid = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0201bc14"]]);
export {
