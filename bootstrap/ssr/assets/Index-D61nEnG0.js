import { ref, computed, watch, reactive, onMounted, unref, useSSRContext } from "vue";
...
import CalendarHeader from "./CalendarHeader-CBSFbHC2.js";
import CalendarGrid from "./CalendarGrid-B3PTdTiy.js";
import CalendarEventModal from "./CalendarEventModal-C_CwpWGY.js";
import _sfc_main$2 from "./CalendarDayDetail-BDFpJCQM.js";
import { _ as _sfc_main$1 } from "./NeuralBridge-CPrgCaT4.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-full max-w-[1600px] mx-auto px-4 py-6 sm:px-6 lg:px-8 space-y-6 min-w-0">`);
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(CalendarEventModal, {
