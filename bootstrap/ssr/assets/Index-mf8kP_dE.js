...
import { _ as _sfc_main$4 } from "./OneForMindIcon-BvGLCgx4.js";
import { useForm, router, usePage, Head } from "@inertiajs/vue3";
import dayjs from "dayjs";
import FinanceHeader from "./FinanceHeader-DmJZR4ID.js";
...
import FinanceBatchModal from "./FinanceBatchModal-CF641DSs.js";
...
import { Wallet, Plus, TrendingUp, ArrowRight } from "lucide-vue-next";
import { _ as _sfc_main$3 } from "./NeuralBridge-DnSXs6gB.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="lg:col-span-3 space-y-8 w-full order-2 lg:order-1 pb-24 lg:pb-0"><div class="hidden lg:block"><div class="relative">`);
      ...
      _push(`<!--]--></div><div class="mt-auto flex items-center justify-between">`);
      _push(ssrRenderComponent(unref(ArrowRight), {
        size: 16,
        class: "text-white group-hover:translate-x-1 transition-transform"
      }, null, _parent));
      _push(`</div></div></div></div></div></div><div class="lg:hidden relative">`);
      _push(ssrRenderComponent(FinanceInsights, {
        "expense-stats": localStats.value.expense_by_category,
        "income-stats": localStats.value.income_by_category,
        budgets: localBudgets.value,
