...
import _sfc_main$1 from "./JournalHeader-heXh3toH.js";
import _sfc_main$2 from "./JournalCard-YLLgm_Xj.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-full px-4 py-8 sm:px-6 lg:px-8 md:py-12"><div class="flex items-center justify-between mb-8"><h3 class="text-xl font-black text-slate-800 dark:text-white transition-colors duration-500">${ssrInterpolate(_ctx.$t("journal_history", "Story History"))}</h3></div>`);
