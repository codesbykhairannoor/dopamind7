    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AuthenticatedLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="min-h-screen bg-slate-50 dark:bg-slate-950 pb-40 animate-in fade-in duration-700 px-6 transition-colors duration-500" data-v-abb4b925${_scopeId}><div class="pt-16 pb-12" data-v-abb4b925${_scopeId}><h1 class="text-4xl font-black text-slate-900 dark:text-white tracking-tight mb-2 transition-colors duration-500" data-v-abb4b925${_scopeId}>${ssrInterpolate(_ctx.$t("more_launcher_title"))}</h1><p class="text-slate-400 dark:text-slate-500 font-bold uppercase tracking-[0.2em] text-[10px] transition-colors duration-500" data-v-abb4b925${_scopeId}>${ssrInterpolate(_ctx.$t("more_launcher_subtitle"))}</p></div><div class="grid grid-cols-2 gap-4" data-v-abb4b925${_scopeId}>`);
            if (showModule("planner")) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="w-12 h-12 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 rounded-2xl flex items-center justify-center group-hover:bg-indigo-600 dark:group-hover:bg-indigo-50 transition-all duration-300" data-v-abb4b925${_scopeId2}>`);
                    _push3(ssrRenderComponent(_sfc_main$1, {
                      name: "planner",
                      size: "24",
                      "stroke-width": "2.5"
                    }, null, _parent3, _scopeId2));
                    _push3(`</div><div data-v-abb4b925${_scopeId2}><span class="block font-black text-slate-800 dark:text-slate-100 text-base leading-none mb-1 transition-colors duration-500" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("nav_item_planner"))}</span><span class="text-[10px] font-bold text-slate-400 dark:text-slate-500 transition-colors duration-500" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("nav_desc_planner"))}</span></div>`);
                  } else {
                    return [
            ...
            if (showModule("finance")) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="w-12 h-12 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-2xl flex items-center justify-center group-hover:bg-emerald-600 dark:group-hover:bg-emerald-500 transition-all duration-300" data-v-abb4b925${_scopeId2}>`);
                    _push3(ssrRenderComponent(_sfc_main$1, {
                      name: "finance",
                      size: "24",
                      "stroke-width": "2.5"
                    }, null, _parent3, _scopeId2));
                    _push3(`</div><div data-v-abb4b925${_scopeId2}><span class="block font-black text-slate-800 dark:text-slate-100 text-base leading-none mb-1 transition-colors duration-500" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("nav_item_finance"))}</span><span class="text-[10px] font-bold text-slate-400 dark:text-slate-500 transition-colors duration-500" data-v-abb4b925${_scopeId2}>Wealth Tracking</span></div>`);
                  } else {
                    return [
            ...
            if (showModule("journal")) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="w-12 h-12 bg-teal-50 dark:bg-teal-500/10 text-teal-600 dark:text-teal-400 rounded-2xl flex items-center justify-center group-hover:bg-teal-600 dark:group-hover:bg-teal-500 transition-all duration-300" data-v-abb4b925${_scopeId2}>`);
                    _push3(ssrRenderComponent(_sfc_main$1, {
                      name: "journal",
                      size: "24",
                      "stroke-width": "2.5"
                    }, null, _parent3, _scopeId2));
                    _push3(`</div><div data-v-abb4b925${_scopeId2}><span class="block font-black text-slate-800 dark:text-slate-100 text-base leading-none mb-1 transition-colors duration-500" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("nav_item_journal"))}</span><span class="text-[10px] font-bold text-slate-400 dark:text-slate-500 transition-colors duration-500" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("nav_desc_journal"))}</span></div>`);
                  } else {
                    return [
            ...
            if (showModule("calendar")) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="w-12 h-12 bg-rose-50 dark:bg-rose-500/10 text-rose-600 dark:text-rose-400 rounded-2xl flex items-center justify-center group-hover:bg-rose-600 dark:group-hover:bg-rose-500 transition-all duration-300" data-v-abb4b925${_scopeId2}>`);
                    _push3(ssrRenderComponent(_sfc_main$1, {
                      name: "calendar",
                      size: "24",
                      "stroke-width": "2.5"
                    }, null, _parent3, _scopeId2));
                    _push3(`</div><div data-v-abb4b925${_scopeId2}><span class="block font-black text-slate-800 dark:text-slate-100 text-base leading-none mb-1 transition-colors duration-500" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("nav_item_calendar"))}</span><span class="text-[10px] font-bold text-slate-400 dark:text-slate-500 transition-colors duration-500" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("nav_desc_calendar"))}</span></div>`);
                  } else {
                    return [
            ...
            if (showModule("job")) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="w-12 h-12 bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 rounded-2xl flex items-center justify-center group-hover:bg-blue-600 dark:group-hover:bg-blue-500 transition-all duration-300" data-v-abb4b925${_scopeId2}>`);
                    _push3(ssrRenderComponent(_sfc_main$1, {
                      name: "job",
                      size: "24",
                      "stroke-width": "2.5"
                    }, null, _parent3, _scopeId2));
                    _push3(`</div><div data-v-abb4b925${_scopeId2}><span class="block font-black text-slate-800 dark:text-slate-100 text-base leading-none mb-1 transition-colors duration-500" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("nav_item_jobs"))}</span><span class="text-[10px] font-bold text-slate-400 dark:text-slate-500 transition-colors duration-500" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("nav_desc_jobs"))}</span></div>`);
                  } else {
                    return [
            ...
            if (showModule("goal")) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="w-12 h-12 bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 rounded-2xl flex items-center justify-center group-hover:bg-amber-600 dark:group-hover:bg-amber-500 transition-all duration-300" data-v-abb4b925${_scopeId2}>`);
                    _push3(ssrRenderComponent(_sfc_main$1, {
                      name: "goal",
                      size: "24",
                      "stroke-width": "2.5"
                    }, null, _parent3, _scopeId2));
                    _push3(`</div><div data-v-abb4b925${_scopeId2}><span class="block font-black text-slate-800 dark:text-slate-100 text-base leading-none mb-1 transition-colors duration-500" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("nav_item_goals"))}</span><span class="text-[10px] font-bold text-slate-400 dark:text-slate-500 transition-colors duration-500" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("nav_desc_goals"))}</span></div>`);
                  } else {
                    return [
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full translate-x-1/2 -translate-y-1/2 blur-3xl group-hover:bg-white/20 transition-all duration-500" data-v-abb4b925${_scopeId2}></div><div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6" data-v-abb4b925${_scopeId2}><div data-v-abb4b925${_scopeId2}><div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/20 text-white text-[9px] font-black mb-4 uppercase tracking-[0.2em] backdrop-blur-md border border-white/10" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("more_upgrade_badge", "PREMIUM UPGRADE"))}</div><h4 class="text-2xl font-black mb-2 tracking-tight" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("more_upgrade_title", "Elevate to Elite Performance"))}</h4><p class="text-indigo-100 text-sm font-bold opacity-90 leading-relaxed max-w-md" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("more_upgrade_desc", "Unlock AI-powered life insights, advanced wealth tracking, and seamless external integrations."))}</p></div><div class="flex items-center gap-3 bg-white text-indigo-700 px-6 py-4 rounded-2xl font-black text-sm shadow-xl group-hover:shadow-indigo-500/50 transition-all duration-300" data-v-abb4b925${_scopeId2}>${ssrInterpolate(_ctx.$t("more_upgrade_btn", "Upgrade Now"))} `);
                  _push3(ssrRenderComponent(_sfc_main$1, {
                    name: "arrow-right",
                    size: "18",
                    "stroke-width": "3"
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-abb4b925"]]);
export {
  Index as default
};
