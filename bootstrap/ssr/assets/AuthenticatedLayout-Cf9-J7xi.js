...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("dashboard"),
        class: ["flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all duration-300 group", isActive("dashboard") ? "bg-indigo-50 text-indigo-700 shadow-sm font-bold" : "text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-medium"]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      if (showModule("habit")) {
        _push(ssrRenderComponent(unref(Link), {
          ...
          class: ["flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all duration-300 group", isActive("habits.*") ? "bg-indigo-50 text-indigo-700 shadow-sm font-bold" : "text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-medium"]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
      ...
      if (showModule("planner")) {
        _push(ssrRenderComponent(unref(Link), {
          ...
          class: ["flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all duration-300 group", isActive("planner.*") ? "bg-indigo-50 text-indigo-700 shadow-sm font-bold" : "text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-medium"]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
      ...
      if (showModule("finance")) {
        _push(ssrRenderComponent(unref(Link), {
          ...
          class: ["flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all duration-300 group", isActive("finance.*") ? "bg-indigo-50 text-indigo-700 shadow-sm font-bold" : "text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-medium"]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="/favicon.png?v=2" alt="OneForMind Logo" class="w-8 h-8 transition-transform duration-500 group-hover:rotate-[360deg] group-hover:scale-110"${_scopeId}><span class="font-black text-indigo-950 text-lg tracking-tight"${_scopeId}>OneForMind.</span>`);
          } else {
            return [
              createVNode("img", {
                src: "/favicon.png?v=2",
      ...
      _push(`<button aria-label="Toggle mobile menu" class="text-slate-500 hover:text-indigo-600 transition p-2 rounded-lg hover:bg-slate-50">`);
      ...
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("dashboard"),
        prefetch: "",
        class: ["block px-4 py-4 rounded-2xl font-bold transition flex items-center gap-3 text-lg", isActive("dashboard") ? "bg-indigo-50 text-indigo-700 shadow-sm" : "text-slate-600 hover:bg-slate-50"],
      ...
      if (showModule("habit")) {
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("habits.index"),
          prefetch: "",
          class: ["block px-4 py-4 rounded-2xl font-bold transition flex items-center gap-3 text-lg", isActive("habits.*") ? "bg-indigo-50 text-indigo-700 shadow-sm" : "text-slate-600 hover:bg-slate-50"],
          onClick: ($event) => showingNavigationDropdown.value = false
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
      ...
      if (showModule("planner")) {
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("planner.index"),
          prefetch: "",
          class: ["block px-4 py-4 rounded-2xl font-bold transition flex items-center gap-3 text-lg", isActive("planner.*") ? "bg-indigo-50 text-indigo-700 shadow-sm" : "text-slate-600 hover:bg-slate-50"],
          onClick: ($event) => showingNavigationDropdown.value = false
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
      ...
      if (showModule("finance")) {
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("finance.index"),
          prefetch: "",
          class: ["block px-4 py-4 rounded-2xl font-bold transition flex items-center gap-3 text-lg", isActive("finance.*") ? "bg-indigo-50 text-indigo-700 shadow-sm" : "text-slate-600 hover:bg-slate-50"],
          onClick: ($event) => showingNavigationDropdown.value = false
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
      ...
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("settings.index"),
        prefetch: "",
        class: ["block px-4 py-4 rounded-2xl font-bold transition flex items-center gap-3 text-lg", isActive("settings.*") ? "bg-indigo-50 text-indigo-700 shadow-sm" : "text-slate-600 hover:bg-slate-50"],
        onClick: ($event) => showingNavigationDropdown.value = false
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
