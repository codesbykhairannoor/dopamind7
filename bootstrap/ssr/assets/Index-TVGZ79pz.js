...
import JobTable from "./JobTable-D2Nnzx6M.js";
import _sfc_main$3 from "./JobStats-BpSSUFiH.js";
import _sfc_main$4 from "./JobFilterBar-Bzn_Jmcz.js";
import ResumeAiModal from "./ResumeAiModal-ClAO6eXb.js";
import _sfc_main$5 from "./MasterCvModal-dTNJkdwo.js";
...
import "./JobDatePicker-iUOmUL6O.js";
import "dayjs/plugin/localeData.js";
import "./useJobUI-ByDCvN_C.js";
import "./JobStatusDropdown-DL8PAX9p.js";
import "marked";
import "axios";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="text-[10px] font-black uppercase tracking-widest hidden lg:inline">${ssrInterpolate(hasMasterCv.value ? _ctx.$t("job_master_cv_ready", "CV Ready") : _ctx.$t("job_master_cv_needs_setup", "Setup Master CV"))}</span>`);
      ...
      _push(`</div><span class="hidden sm:inline uppercase text-xs tracking-widest">${ssrInterpolate(_ctx.$t("job_add_row", "Tambah Baris"))}</span></button></div></div></div></div><div class="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-8">`);
