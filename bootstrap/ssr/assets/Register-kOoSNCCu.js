...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="text-center mb-8"><h1 class="text-2xl font-black text-slate-900 mb-1.5 tracking-tight">${ssrInterpolate(_ctx.$t("auth_register_title", "Seconds to sign up!"))}</h1><p class="text-sm font-medium text-slate-500">${ssrInterpolate(_ctx.$t("auth_has_account", "Already have an account?"))} `);
      _push(ssrRenderComponent(unref(Link), {
