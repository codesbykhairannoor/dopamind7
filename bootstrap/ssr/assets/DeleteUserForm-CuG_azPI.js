...
import { _ as _sfc_main$2 } from "./Modal-BOdkfMB5.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "space-y-6" }, _attrs))}><header><h2 class="text-lg font-black text-rose-600 dark:text-rose-400 uppercase tracking-widest flex items-center gap-2 transition-colors duration-500"> ⚠️ ${ssrInterpolate(_ctx.$t("delete_account_title", "Hapus Akun"))}</h2><p class="mt-1 text-sm text-rose-500/80 dark:text-rose-400/80 font-medium transition-colors duration-500">${ssrInterpolate(_ctx.$t("delete_account_desc", "Setelah akun Anda dihapus, semua data dan sumber daya yang terkait akan dihapus secara permanen. Pastikan Anda telah mengunduh data apa pun yang ingin Anda simpan."))}</p></header>`);
      _push(ssrRenderComponent(DangerButton, {
        onClick: confirmUserDeletion,
        class: "!rounded-xl !py-3.5 !px-8 !bg-rose-500 hover:!bg-rose-600 !shadow-lg !shadow-rose-200 dark:!shadow-none !text-[11px] !font-black !uppercase !tracking-widest transition-all active:scale-95 transition-colors duration-500"
      }, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$6, {
              onClick: closeModal,
              class: "flex-1 !py-3.5 !rounded-xl !border-2 !border-slate-200 dark:!border-slate-700 !text-slate-500 dark:!text-slate-400 hover:!bg-slate-50 dark:hover:!bg-slate-800 hover:!text-slate-700 dark:hover:!text-slate-200 justify-center !text-[11px] !font-black !uppercase !tracking-widest transition-colors duration-500"
            }, {
            ...
            _push2(ssrRenderComponent(DangerButton, {
              class: ["flex-1 justify-center !rounded-xl !py-3.5 !bg-rose-600 hover:!bg-rose-700 !text-[11px] !font-black !uppercase !tracking-widest shadow-lg shadow-rose-200 dark:shadow-none transition-colors duration-500", { "opacity-25": unref(form).processing }],
