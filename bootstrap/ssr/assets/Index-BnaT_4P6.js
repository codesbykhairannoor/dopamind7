...
import _sfc_main$5 from "./ProfileTab-e_1kJr6-.js";
import _sfc_main$4 from "./AppearanceTab-DaGLhXUv.js";
import _sfc_main$3 from "./SecurityTab-C49Z1wiR.js";
import _sfc_main$2 from "./BillingTab-CSFga90G.js";
import LegalTab from "./LegalTab-CmBTAEqc.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AuthenticatedLayout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="max-w-6xl mx-auto py-12 px-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-40 transition-all duration-500" data-v-c6281475${_scopeId}><div class="mb-12 text-center md:text-left" data-v-c6281475${_scopeId}><h1 class="text-4xl font-black text-slate-900 dark:text-white tracking-tight transition-colors duration-500" data-v-c6281475${_scopeId}>${ssrInterpolate(_ctx.$t("settings_header", "Account Settings"))}</h1><p class="text-slate-400 dark:text-slate-500 font-bold mt-2 transition-colors duration-500" data-v-c6281475${_scopeId}>${ssrInterpolate(_ctx.$t("settings_subheader", "Customize your productivity experience"))}</p></div><div class="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-indigo-500/5 border border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-center gap-8 mb-10 relative overflow-hidden group transition-all duration-500" data-v-c6281475${_scopeId}><div class="absolute top-0 right-0 w-32 h-32 bg-indigo-500/5 rounded-full translate-x-1/2 -translate-y-1/2" data-v-c6281475${_scopeId}></div><div class="relative shrink-0" data-v-c6281475${_scopeId}>`);
            if ((_a = user.value) == null ? void 0 : _a.avatar_url) {
              _push2(`<img${ssrRenderAttr("src", user.value.avatar_url)} alt="Avatar" class="w-24 h-24 rounded-full object-cover shadow-2xl border-4 border-white dark:border-slate-800" data-v-c6281475${_scopeId}>`);
            } else {
              _push2(`<div class="w-24 h-24 rounded-full bg-indigo-600 dark:bg-indigo-500 text-white flex items-center justify-center font-black text-4xl shadow-2xl border-4 border-white dark:border-slate-800" data-v-c6281475${_scopeId}>${ssrInterpolate(((_c = (_b = user.value) == null ? void 0 : _b.name) == null ? void 0 : _c.charAt(0).toUpperCase()) || "U")}</div>`);
            }
            _push2(`</div><div class="flex-1 text-center md:text-left min-w-0" data-v-c6281475${_scopeId}><h2 class="text-3xl font-black text-slate-800 dark:text-slate-100 truncate leading-tight transition-colors duration-500" data-v-c6281475${_scopeId}>${ssrInterpolate(((_d = user.value) == null ? void 0 : _d.name) || "User")}</h2><p class="text-slate-400 dark:text-slate-500 font-bold mt-1 transition-colors duration-500" data-v-c6281475${_scopeId}>${ssrInterpolate((_e = user.value) == null ? void 0 : _e.email)}</p><div class="flex flex-wrap justify-center md:justify-start gap-2 mt-4" data-v-c6281475${_scopeId}><span class="px-4 py-1.5 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 rounded-full text-[10px] font-black transition-colors duration-500" data-v-c6281475${_scopeId}>Platinum User</span><span class="px-4 py-1.5 bg-slate-50 dark:bg-slate-800/50 text-slate-500 dark:text-slate-400 rounded-full text-[10px] font-black transition-colors duration-500" data-v-c6281475${_scopeId}>Member #${ssrInterpolate((_f = user.value) == null ? void 0 : _f.id)}</span></div></div></div><div class="flex flex-col lg:flex-row gap-8" data-v-c6281475${_scopeId}>`);
            if (_ctx.isMobile) {
              _push2(`<div class="w-full flex overflow-x-auto no-scrollbar gap-2 pb-4 pt-2 -mx-2 px-2 sticky top-0 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-md z-40" data-v-c6281475${_scopeId}><!--[-->`);
              ssrRenderList(tabs, (tab) => {
                _push2(`<button${ssrRenderAttr("id", "mobile-tab-" + tab.id)} class="${ssrRenderClass([activeTab.value === tab.id ? "bg-indigo-600 text-white border-indigo-500 shadow-lg shadow-indigo-200 dark:shadow-none" : "bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400 border-slate-100 dark:border-slate-800", "whitespace-nowrap px-6 py-3 rounded-2xl font-black text-xs transition-all border flex items-center gap-2"])}" data-v-c6281475${_scopeId}><span data-v-c6281475${_scopeId}>${ssrInterpolate(tab.icon)}</span> ${ssrInterpolate(_ctx.$t(tab.tName, tab.name))}</button>`);
              });
              _push2(`<!--]--></div>`);
            } else {
              _push2(`<aside class="w-full lg:w-80 shrink-0" data-v-c6281475${_scopeId}><div class="space-y-6 pt-2" data-v-c6281475${_scopeId}><nav id="desktop-settings-nav" class="space-y-1.5 p-3 bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm relative z-10 transition-all duration-500" data-v-c6281475${_scopeId}><!--[-->`);
              ssrRenderList(tabs, (tab) => {
                _push2(`<button${ssrRenderAttr("id", "tab-" + tab.id)} class="${ssrRenderClass([[
                  activeTab.value === tab.id ? "bg-indigo-600 text-white shadow-xl shadow-indigo-100 dark:shadow-indigo-900/40 border border-indigo-500" : "text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-200",
                  tab.id === "billing" && unref(isExplorer) && activeTab.value !== "billing" ? "ring-2 ring-indigo-500/20 border-indigo-200 dark:border-indigo-800 animate-pulse" : ""
                ], "w-full flex items-center gap-4 p-4 rounded-[1.8rem] transition-all duration-300 group text-left relative overflow-hidden"])}" data-v-c6281475${_scopeId}>`);
                if (tab.id === "billing" && unref(isExplorer)) {
                  _push2(`<div class="absolute top-0 right-0 w-8 h-8 bg-indigo-500/10 rounded-full translate-x-1/2 -translate-y-1/2 shrink-0" data-v-c6281475${_scopeId}></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<span class="text-2xl transition-transform group-hover:scale-110" data-v-c6281475${_scopeId}>${ssrInterpolate(tab.icon)}</span><div class="text-left" data-v-c6281475${_scopeId}><h4 class="${ssrRenderClass([activeTab.value === tab.id ? "text-white" : "text-slate-800 dark:text-slate-200", "text-sm font-black leading-none"])}" data-v-c6281475${_scopeId}>${ssrInterpolate(_ctx.$t(tab.tName, tab.name))}</h4><p class="${ssrRenderClass([activeTab.value === tab.id ? "text-indigo-100" : "text-slate-400", "text-[10px] font-bold mt-1 opacity-70"])}" data-v-c6281475${_scopeId}>${ssrInterpolate(_ctx.$t(tab.tDesc, tab.desc))}</p></div></button>`);
              });
              _push2(`<!--]--></nav><div class="bg-white dark:bg-slate-900 rounded-[2.2rem] p-4 shadow-sm border border-slate-100 dark:border-slate-800 space-y-3 transition-all duration-500" data-v-c6281475${_scopeId}><div class="flex items-center justify-between p-4 bg-slate-50/50 dark:bg-slate-800/50 rounded-[1.5rem] border border-slate-100/50 dark:border-slate-700/50 transition-colors duration-500" data-v-c6281475${_scopeId}><span class="font-black text-slate-800 dark:text-slate-200 text-xs transition-colors duration-500" data-v-c6281475${_scopeId}>${ssrInterpolate(_ctx.$t("settings_lang_label", "Language"))}</span><div class="flex gap-1 p-1 bg-white dark:bg-slate-900 rounded-xl border border-slate-200/50 dark:border-slate-700/50 shadow-inner transition-colors duration-500" data-v-c6281475${_scopeId}><button id="lang-switch-id" class="${ssrRenderClass([currentLocale.value === "id" ? "bg-indigo-600 text-white shadow-lg dark:shadow-none" : "text-slate-400 dark:text-slate-500", "px-4 py-1.5 rounded-lg text-[9px] font-black transition-all"])}" data-v-c6281475${_scopeId}>ID</button><button id="lang-switch-en" class="${ssrRenderClass([currentLocale.value === "en" ? "bg-indigo-600 text-white shadow-lg dark:shadow-none" : "text-slate-400 dark:text-slate-500", "px-4 py-1.5 rounded-lg text-[9px] font-black transition-all"])}" data-v-c6281475${_scopeId}>EN</button></div></div><button id="logout-btn" class="w-full bg-rose-50 dark:bg-rose-500/10 text-rose-500 dark:text-rose-400 font-black py-4 rounded-[1.5rem] border border-rose-100 dark:border-rose-500/20 flex items-center justify-center gap-3 active:scale-[0.98] transition-all hover:bg-rose-100/50 dark:hover:bg-rose-500/20" data-v-c6281475${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$6, {
                name: "logout",
                size: "18",
                "stroke-width": "2.5"
              }, null, _parent2, _scopeId));
              _push2(`<span class="text-[10px] font-black" data-v-c6281475${_scopeId}>Sign Out</span></button></div></div></aside>`);
            }
            _push2(`<main class="flex-grow bg-white dark:bg-slate-900 rounded-[2.5rem] p-6 sm:p-10 border border-slate-100 dark:border-slate-800 shadow-sm min-h-[600px] transition-all duration-500 relative" data-v-c6281475${_scopeId}><div class="max-w-3xl" data-v-c6281475${_scopeId}>`);
            ...
            _push2(`</div>`);
            if (_ctx.isMobile) {
              _push2(`<div class="mt-12 space-y-4 pt-12 border-t border-slate-100 dark:border-slate-800" data-v-c6281475${_scopeId}><div class="flex items-center justify-between p-5 bg-slate-50/50 dark:bg-slate-800/50 rounded-3xl border border-slate-100 dark:border-slate-700" data-v-c6281475${_scopeId}><span class="font-black text-slate-800 dark:text-slate-200 text-xs" data-v-c6281475${_scopeId}>${ssrInterpolate(_ctx.$t("settings_lang_label"))}</span><div class="flex gap-1 p-1 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/50 dark:border-slate-700/50" data-v-c6281475${_scopeId}><button class="${ssrRenderClass([currentLocale.value === "id" ? "bg-indigo-600 text-white" : "text-slate-400", "px-5 py-2 rounded-xl text-[10px] font-black transition-all"])}" data-v-c6281475${_scopeId}>ID</button><button class="${ssrRenderClass([currentLocale.value === "en" ? "bg-indigo-600 text-white" : "text-slate-400", "px-5 py-2 rounded-xl text-[10px] font-black transition-all"])}" data-v-c6281475${_scopeId}>EN</button></div></div><button class="w-full bg-rose-50 dark:bg-rose-500/10 text-rose-500 dark:text-rose-400 font-black py-5 rounded-3xl border border-rose-100 dark:border-rose-500/20 flex items-center justify-center gap-3" data-v-c6281475${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$6, {
                name: "logout",
                size: "20",
                "stroke-width": "2.5"
              }, null, _parent2, _scopeId));
              _push2(`<span class="text-xs font-black" data-v-c6281475${_scopeId}>Sign Out</span></button></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</main></div></div>`);
                      ...
                      createVNode("nav", {
                        ...
                        (openBlock(), createBlock(Fragment, null, renderList(tabs, (tab) => {
                          return createVNode("button", {
                            ...
                            tab.id === "billing" && unref(isExplorer) ? (openBlock(), createBlock("div", {
                              key: 0,
                              class: "absolute top-0 right-0 w-8 h-8 bg-indigo-500/10 rounded-full translate-x-1/2 -translate-y-1/2 shrink-0"
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c6281475"]]);
export {
  Index as default
};
