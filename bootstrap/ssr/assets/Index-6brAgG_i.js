...
import JobTable from "./JobTable-CrQo8MSH.js";
import _sfc_main$3 from "./JobStats-BpSSUFiH.js";
import _sfc_main$4 from "./JobFilterBar-CpjmMXHD.js";
import ResumeAiModal from "./ResumeAiModal-DMiOxJA3.js";
import _sfc_main$5 from "./MasterCvModal-DblYYzQ-.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="min-h-screen bg-slate-50 dark:bg-slate-950 pb-24 transition-colors duration-500"><div class="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 relative z-50 transition-colors duration-500"><div class="w-full min-w-0 px-4 sm:px-6 lg:px-8 py-2"><div class="flex w-full min-w-0 flex-wrap items-center justify-between gap-3 md:flex-nowrap"><div class="flex min-w-0 flex-1 items-center gap-2 md:flex-initial md:max-w-[min(100%,28rem)]"><p class="shrink-0 text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-600 mr-2 border-r border-slate-200 dark:border-slate-800 pr-4">${ssrInterpolate(_ctx.$t("job_page_title", "Job Tracker"))}</p><div class="flex min-w-0 flex-1 items-center gap-1.5 px-3 py-1.5 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-100 dark:border-slate-700/50 overflow-hidden">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "job",
        size: "14",
        class: "text-indigo-500 shrink-0"
      }, null, _parent));
      _push(`<span class="min-w-0 truncate text-[11px] font-bold text-slate-600 dark:text-slate-300 capitalize">${ssrInterpolate(todayDate.value)}</span>`);
      if ((_a = __props.pagination) == null ? void 0 : _a.total) {
        _push(`<span class="shrink-0 ml-1 text-[9px] font-black text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-500/10 px-1.5 py-0.5 rounded-full transition-colors duration-500">${ssrInterpolate(__props.pagination.total)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="flex shrink-0 items-center gap-2 sm:gap-3"><button class="px-4 h-11 rounded-xl border border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all flex items-center gap-2 group relative">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "job",
        size: "16",
      ...
      if (!hasMasterCv.value) {
        _push(`<div class="absolute -top-1 -right-1 w-2 h-2 bg-rose-500 rounded-full border-2 border-white dark:border-slate-900 animate-pulse"></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</button><button class="bg-indigo-600 h-11 text-white font-black px-4 sm:px-6 rounded-xl shadow-lg shadow-indigo-100 dark:shadow-none hover:bg-indigo-700 hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center gap-2 shrink-0 relative overflow-hidden group">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "plus",
        size: "16",
        "stroke-width": "4"
      }, null, _parent));
      _push(`<span class="hidden sm:inline text-[11px] font-bold">${ssrInterpolate(_ctx.$t("job_add_row", "Tambah Baris"))}</span></button></div></div></div></div><div class="w-full max-w-[98%] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-8 min-w-0 overflow-x-hidden transition-all duration-500">`);
