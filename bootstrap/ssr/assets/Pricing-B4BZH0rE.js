import { ref, computed, onMounted, unref, withCtx, createVNode, createTextVNode, createBlock, openBlock, Fragment, renderList, createCommentVNode, toDisplayString, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrRenderList, ssrInterpolate, ssrIncludeBooleanAttr } from "vue/server-renderer";
import { A as AuthenticatedLayout } from "./AuthenticatedLayout-DLBfuybT.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AuthenticatedLayout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-12 px-6 lg:px-12 max-w-[1600px] mx-auto min-h-screen" data-v-b4d0341d${_scopeId}><div class="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8" data-v-b4d0341d${_scopeId}><div class="max-w-2xl animate-in fade-in slide-in-from-left-8 duration-700" data-v-b4d0341d${_scopeId}><div class="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-indigo-600 dark:bg-indigo-500 text-white font-black text-[9px] mb-4 uppercase tracking-[0.2em] shadow-lg shadow-indigo-200 dark:shadow-none" data-v-b4d0341d${_scopeId}> Subscription OS </div><h1 class="text-4xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tighter mb-4" data-v-b4d0341d${_scopeId}> Tingkatkan <span class="text-indigo-600 dark:text-indigo-400" data-v-b4d0341d${_scopeId}>Potensi Anda.</span></h1><p class="text-slate-500 dark:text-slate-400 font-bold leading-relaxed" data-v-b4d0341d${_scopeId}> Pilih level sistem yang sesuai dengan ambisi Anda saat ini. Semua pembaruan di masa mendatang sudah termasuk dalam setiap paket. </p></div><div class="flex items-center gap-4 bg-white dark:bg-slate-800 p-2 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm shrink-0" data-v-b4d0341d${_scopeId}><button class="${ssrRenderClass([!isAnnual.value ? "bg-slate-950 text-white shadow-lg" : "text-slate-400 hover:text-slate-900 dark:hover:text-white", "px-6 py-2.5 rounded-xl text-xs font-black transition-all"])}" data-v-b4d0341d${_scopeId}> Bulanan </button><button class="${ssrRenderClass([isAnnual.value ? "bg-slate-950 text-white shadow-lg" : "text-slate-400 hover:text-slate-900 dark:hover:text-white", "px-6 py-2.5 rounded-xl text-xs font-black transition-all flex items-center gap-2"])}" data-v-b4d0341d${_scopeId}> Tahunan <span class="px-1.5 py-0.5 rounded-md bg-emerald-500 text-[8px] text-white" data-v-b4d0341d${_scopeId}>-40%</span></button></div></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" data-v-b4d0341d${_scopeId}><!--[-->`);
            ssrRenderList(plans.value, (plan, index) => {
              ...
              ], "group relative flex flex-col p-8 rounded-[2.5rem] border transition-all duration-700"])}" data-v-b4d0341d${_scopeId}>`);
              if (plan.tier === unref(userTier)) {
                _push2(`<div class="absolute -top-3 left-8 px-4 py-1 rounded-full bg-emerald-500 text-white text-[8px] font-black uppercase tracking-widest shadow-lg" data-v-b4d0341d${_scopeId}> Aktif Sekarang </div>`);
              } else if (plan.badge) {
                _push2(`<div class="absolute -top-3 left-8 px-4 py-1 rounded-full bg-indigo-600 text-white text-[8px] font-black uppercase tracking-widest shadow-lg" data-v-b4d0341d${_scopeId}>${ssrInterpolate(_ctx.$t(plan.badge))}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="mb-10 flex justify-between items-start" data-v-b4d0341d${_scopeId}><div data-v-b4d0341d${_scopeId}><h3 class="text-[10px] font-black tracking-[0.2em] mb-4 uppercase opacity-50" data-v-b4d0341d${_scopeId}>${ssrInterpolate(_ctx.$t(plan.name))}</h3><div class="flex items-baseline gap-1" data-v-b4d0341d${_scopeId}><span class="text-4xl font-black tracking-tighter text-slate-900 dark:text-white" data-v-b4d0341d${_scopeId}>${ssrInterpolate(plan.price)}</span>`);
              if (plan.slug !== "legendary" && plan.slug !== "explorer") {
                _push2(`<span class="text-xs font-bold text-slate-400" data-v-b4d0341d${_scopeId}>/bln</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
              if (plan.icon) {
                _push2(`<div class="w-12 h-12 rounded-2xl flex items-center justify-center bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform duration-500" data-v-b4d0341d${_scopeId}>`);
              ...
              _push2(`</div><p class="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-8 leading-relaxed min-h-[44px]" data-v-b4d0341d${_scopeId}>${ssrInterpolate(_ctx.$t(plan.desc))}</p><div class="space-y-4 mb-10 flex-grow border-t border-slate-50 dark:border-slate-800 pt-8" data-v-b4d0341d${_scopeId}><!--[-->`);
              ssrRenderList(plan.features, (feat) => {
                _push2(`<div class="flex items-start gap-3" data-v-b4d0341d${_scopeId}><div class="mt-0.5 w-4 h-4 rounded-full bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center shrink-0" data-v-b4d0341d${_scopeId}>`);
                _push2(ssrRenderComponent(_sfc_main$1, {
                  name: "check",
                  size: "10",
                ...
                _push2(`</div><span class="text-[11px] font-black leading-[1.3] text-slate-700 dark:text-slate-200" data-v-b4d0341d${_scopeId}>${ssrInterpolate(_ctx.$t(feat))}</span></div>`);
              });
              ...
              ], "w-full py-5 rounded-[1.75rem] font-black text-xs transition-all duration-300 transform active:scale-95 shadow-xl"])}" data-v-b4d0341d${_scopeId}>${ssrInterpolate(plan.tier === unref(userTier) ? "Sudah Aktif" : plan.tier < unref(userTier) ? "Level Dasar" : _ctx.$t(plan.buttonText))}</button>`);
              if (plan.tier > unref(userTier) && plan.initial) {
                _push2(`<p class="text-center mt-4 text-[9px] font-bold text-indigo-500 animate-pulse" data-v-b4d0341d${_scopeId}>${ssrInterpolate(_ctx.$t(plan.initial))}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            });
            _push2(`<!--]--></div><div class="mt-32 max-w-4xl mx-auto" data-v-b4d0341d${_scopeId}><div class="text-center mb-16" data-v-b4d0341d${_scopeId}><h2 class="text-2xl font-black text-slate-900 dark:text-white mb-2" data-v-b4d0341d${_scopeId}>Matriks Kapasitas Sistem</h2><p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]" data-v-b4d0341d${_scopeId}>Detail Teknis Pembatasan Arsitektur</p></div><div class="space-y-3" data-v-b4d0341d${_scopeId}><!--[-->`);
            ssrRenderList([
              ...
              _push2(`<div class="flex items-center justify-between p-6 rounded-3xl bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 group hover:border-indigo-200 dark:hover:border-indigo-800 transition-all" data-v-b4d0341d${_scopeId}><span class="text-xs font-black text-slate-800 dark:text-slate-200 uppercase tracking-tighter" data-v-b4d0341d${_scopeId}>${ssrInterpolate(f.name)}</span><div class="flex gap-4 sm:gap-12" data-v-b4d0341d${_scopeId}><div class="flex flex-col items-center" data-v-b4d0341d${_scopeId}><span class="text-[8px] font-bold text-slate-400 uppercase" data-v-b4d0341d${_scopeId}>Free</span><span class="${ssrRenderClass([f.explorer === "Terkunci" ? "text-rose-500" : "text-slate-600 dark:text-slate-400", "text-[10px] font-black"])}" data-v-b4d0341d${_scopeId}>${ssrInterpolate(f.explorer)}</span></div><div class="flex flex-col items-center" data-v-b4d0341d${_scopeId}><span class="text-[8px] font-bold text-indigo-400 uppercase" data-v-b4d0341d${_scopeId}>Arch</span><span class="text-[10px] font-black text-indigo-600 dark:text-indigo-400" data-v-b4d0341d${_scopeId}>${ssrInterpolate(f.architect)}</span></div><div class="flex flex-col items-center" data-v-b4d0341d${_scopeId}><span class="text-[8px] font-bold text-amber-500 uppercase" data-v-b4d0341d${_scopeId}>Quant</span><span class="text-[10px] font-black text-amber-600 dark:text-amber-500" data-v-b4d0341d${_scopeId}>${ssrInterpolate(f.quantum)}</span></div></div></div>`);
            });
            _push2(`<!--]--></div></div></div>`);
          } else {
            return [
              createVNode("div", { class: "py-12 px-6 lg:px-12 max-w-[1600px] mx-auto min-h-screen" }, [
                createVNode("div", { class: "mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8" }, [
                  createVNode("div", { class: "max-w-2xl animate-in fade-in slide-in-from-left-8 duration-700" }, [
                    createVNode("div", { class: "inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-indigo-600 dark:bg-indigo-500 text-white font-black text-[9px] mb-4 uppercase tracking-[0.2em] shadow-lg shadow-indigo-200 dark:shadow-none" }, " Subscription OS "),
                    createVNode("h1", { class: "text-4xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tighter mb-4" }, [
                      createTextVNode(" Tingkatkan "),
                      createVNode("span", { class: "text-indigo-600 dark:text-indigo-400" }, "Potensi Anda.")
                    ]),
                    createVNode("p", { class: "text-slate-500 dark:text-slate-400 font-bold leading-relaxed" }, " Pilih level sistem yang sesuai dengan ambisi Anda saat ini. Semua pembaruan di masa mendatang sudah termasuk dalam setiap paket. ")
                  ]),
                ...
                createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(plans.value, (plan, index) => {
                    return openBlock(), createBlock("div", {
                      ...
                      }, " Aktif Sekarang ")) : plan.badge ? (openBlock(), createBlock("div", {
                        key: 1,
                      ...
                      }, toDisplayString(plan.tier === unref(userTier) ? "Sudah Aktif" : plan.tier < unref(userTier) ? "Level Dasar" : _ctx.$t(plan.buttonText)), 11, ["onClick", "disabled"]),
                ...
                createVNode("div", { class: "mt-32 max-w-4xl mx-auto" }, [
                  createVNode("div", { class: "text-center mb-16" }, [
                    createVNode("h2", { class: "text-2xl font-black text-slate-900 dark:text-white mb-2" }, "Matriks Kapasitas Sistem"),
                    createVNode("p", { class: "text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]" }, "Detail Teknis Pembatasan Arsitektur")
                  ]),
                  createVNode("div", { class: "space-y-3" }, [
                    (openBlock(), createBlock(Fragment, null, renderList([
                      ...
                      return createVNode("div", {
                        ...
                        createVNode("span", { class: "text-xs font-black text-slate-800 dark:text-slate-200 uppercase tracking-tighter" }, toDisplayString(f.name), 1),
                        createVNode("div", { class: "flex gap-4 sm:gap-12" }, [
                          createVNode("div", { class: "flex flex-col items-center" }, [
                            ...
                            createVNode("span", {
                              class: ["text-[10px] font-black", f.explorer === "Terkunci" ? "text-rose-500" : "text-slate-600 dark:text-slate-400"]
                            }, toDisplayString(f.explorer), 3)
                          ]),
                          createVNode("div", { class: "flex flex-col items-center" }, [
...
const Pricing = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b4d0341d"]]);
export {
  Pricing as default
};
