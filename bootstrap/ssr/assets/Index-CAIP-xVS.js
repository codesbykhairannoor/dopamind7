  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isExplorer)) {
        ...
        _push(`</div><div><h4 class="text-sm font-black text-white uppercase tracking-widest leading-none mb-1">Neural Consistency Lab</h4><p class="text-[10px] font-bold text-slate-500 uppercase tracking-tighter">Analyze your identity shifts with AI</p></div></div><div class="flex gap-1.5 blur-[1.5px] opacity-30 group-hover:opacity-60 transition-all"><!--[-->`);
        ssrRenderList(12, (i) => {
          _push(`<div class="${ssrRenderClass([i % 3 === 0 ? "bg-indigo-500" : "bg-slate-700", "w-3 h-3 rounded-[3px]"])}"></div>`);
        });
        _push(`<!--]--></div><div class="flex items-center gap-2 text-indigo-400 font-black text-[10px] uppercase tracking-widest"> Unlock Analytics `);
