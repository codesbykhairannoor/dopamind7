...
import FinanceHeader from "./FinanceHeader-BJ8CV00e.js";
import _sfc_main$2 from "./FinanceStats-DtovxEUs.js";
import _sfc_main$4 from "./BudgetSidebar-DTOzfZFR.js";
import _sfc_main$5 from "./TransactionModal-Ct0_JNG9.js";
import _sfc_main$6 from "./BudgetModal-CfxiaRiu.js";
import _sfc_main$7 from "./CategoryModal-DYpCHnR4.js";
...
import _sfc_main$3 from "./FinanceDatePicker-St-Mq15S.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (localTransactions.value.length) {
              _push2(ssrRenderComponent(DailyTrendChart, {
                transactions: localTransactions.value,
              ...
              createVNode("div", { class: "w-full min-h-screen bg-slate-50/50 px-4 sm:px-6 lg:px-8 py-8" }, [
                ...
                createVNode("div", { class: "grid grid-cols-1 lg:grid-cols-5 gap-8 items-start" }, [
                  createVNode("div", { class: "lg:col-span-3 space-y-8 w-full" }, [
                    ...
                    localTransactions.value.length ? (openBlock(), createBlock(DailyTrendChart, {
                      key: 0,
                      transactions: localTransactions.value,
                      currentDate: __props.filters.date
