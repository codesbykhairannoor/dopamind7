              ...
              createVNode("div", { class: "bg-slate-50 dark:bg-slate-950 min-h-screen pb-32 pt-10 px-4 md:px-8" }, [
                        ...
                        (openBlock(true), createBlock(Fragment, null, renderList(plan.features, (feat, fIdx) => {
                          return openBlock(), createBlock("div", {
                            ...
                            feat.isHeader ? (openBlock(), createBlock("p", {
                              key: 0,
                              class: "text-[9px] font-black text-slate-400 uppercase tracking-widest mt-2 mb-1 w-full"
                ...
                createVNode("div", { class: "mt-40 max-w-5xl mx-auto animate-in slide-in-from-bottom-12 duration-1000" }, [
                    ...
                    createVNode("table", { class: "w-full text-left border-collapse" }, [
                      createVNode("thead", null, [
                        createVNode("tr", { class: "bg-slate-50 dark:bg-slate-800/50" }, [
                          createVNode("th", { class: "p-8 text-[10px] font-black uppercase tracking-widest text-slate-400" }, toDisplayString(_ctx.$t("pricing_feature_col_name")), 1),
                          createVNode("th", { class: "p-8 text-[10px] font-black uppercase tracking-widest text-slate-900 dark:text-white text-center" }, "Explorer"),
                          createVNode("th", { class: "p-8 text-[10px] font-black uppercase tracking-widest text-indigo-500 text-center" }, "Architect"),
                          createVNode("th", { class: "p-8 text-[10px] font-black uppercase tracking-widest text-amber-500 text-center" }, "Quantum")
                        ])
                      ]),
                  ...
                  createVNode("div", { class: "mt-16 text-center" }, [
                    createVNode("p", { class: "text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-4" }, toDisplayString(_ctx.$t("pricing_infra_badge")), 1),
                    createVNode("div", { class: "flex flex-wrap justify-center items-center gap-12 opacity-30 grayscale contrast-125" }, [
                      createVNode("div", { class: "flex items-center gap-2" }, [
                        ...
                        createVNode("span", { class: "font-black dark:text-white uppercase tracking-tighter text-[10px]" }, "Asana Strength")
                      ]),
                      createVNode("div", { class: "flex items-center gap-2" }, [
                        createVNode("div", { class: "w-2 h-2 bg-slate-900 dark:bg-white rounded-full" }),
                        createVNode("span", { class: "font-black dark:text-white uppercase tracking-tighter text-[10px]" }, "ClickUp Power")
                      ]),
                      createVNode("div", { class: "flex items-center gap-2" }, [
                        createVNode("div", { class: "w-2 h-2 bg-slate-900 dark:bg-white rounded-full" }),
                        createVNode("span", { class: "font-black dark:text-white uppercase tracking-tighter text-[10px]" }, "Notion Clarity")
                      ])
                    ])
                  ])
                ])
