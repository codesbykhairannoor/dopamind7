  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (showDropdown.value && suggestions.value.length > 0) {
        _push(`<div class="absolute top-full left-0 right-0 mt-1.5 bg-white border border-slate-200 rounded-xl shadow-xl z-50 overflow-hidden"><div class="px-3 py-2 text-[10px] font-black uppercase tracking-widest text-slate-400 border-b border-slate-100"> ✨ ${ssrInterpolate(_ctx.$t("job_filter_autocomplete_label", "Posisi yang kamu lamar"))}</div><!--[-->`);
