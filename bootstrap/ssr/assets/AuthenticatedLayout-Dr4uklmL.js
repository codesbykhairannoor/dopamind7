...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex h-screen bg-slate-50 font-sans overflow-hidden selection:bg-indigo-500 selection:text-white relative" }, _attrs))} data-v-500735e3><aside class="${ssrRenderClass([isSidebarCollapsed.value ? "w-20" : "w-64", "bg-white border-r border-slate-100 hidden md:flex flex-col z-20 shadow-[4px_0_24px_rgba(0,0,0,0.02)] flex-shrink-0 transition-all duration-300 ease-in-out relative"])}" data-v-500735e3><button class="absolute -right-3 top-8 w-6 h-6 bg-white border border-slate-200 rounded-full flex items-center justify-center text-slate-400 hover:text-indigo-600 hover:scale-110 shadow-sm transition-all z-30" data-v-500735e3>`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: !isSidebarCollapsed.value ? "chevron-left" : "chevron-right",
        size: "14",
        "stroke-width": "3"
      }, null, _parent));
      _push(`</button><div class="${ssrRenderClass([isSidebarCollapsed.value ? "justify-center" : "justify-start px-8", "h-20 flex items-center px-6 shrink-0"])}" data-v-500735e3>`);
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center transition-transform duration-500 group-hover:rotate-[360deg] shadow-lg shadow-indigo-100 shrink-0" data-v-500735e3${_scopeId}><img src="/favicon.svg?v=2" alt="Logo" class="w-5 h-5 brightness-0 invert" data-v-500735e3${_scopeId}></div>`);
            if (!isSidebarCollapsed.value) {
              _push2(`<span class="text-lg font-black tracking-tighter text-slate-900 whitespace-nowrap" data-v-500735e3${_scopeId}> OneForMind<span class="text-indigo-600" data-v-500735e3${_scopeId}>.</span></span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(`</div><nav class="${ssrRenderClass([isSidebarCollapsed.value ? "px-3" : "px-4", "flex-1 px-3 space-y-1 overflow-y-auto py-4 custom-scrollbar"])}" data-v-500735e3>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("dashboard"),
        prefetch: "mount",
        cacheFor: "1m",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!isSidebarCollapsed.value) {
              _push2(`<span class="whitespace-nowrap text-sm" data-v-500735e3${_scopeId}>${ssrInterpolate(_ctx.$t("nav_dashboard", "Dashboard"))}</span>`);
            } else {
              _push2(`<!---->`);
            }
            if (_ctx.route().current("dashboard") && !isSidebarCollapsed.value) {
              _push2(`<div class="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-5 bg-indigo-600 rounded-r-full" data-v-500735e3${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm" data-v-500735e3${_scopeId}>${ssrInterpolate(_ctx.$t("habit_page_title", "Habit Tracker"))}</span>`);
              } else {
                _push2(`<!---->`);
              }
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm" data-v-500735e3${_scopeId}>Daily Planner</span>`);
              } else {
                _push2(`<!---->`);
              }
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm" data-v-500735e3${_scopeId}>Finance Plan</span>`);
              } else {
                _push2(`<!---->`);
              }
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm" data-v-500735e3${_scopeId}>Digital Journal</span>`);
              } else {
                _push2(`<!---->`);
              }
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm" data-v-500735e3${_scopeId}>Calendar View</span>`);
              } else {
                _push2(`<!---->`);
              }
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm" data-v-500735e3${_scopeId}>Job Tracker</span>`);
              } else {
                _push2(`<!---->`);
              }
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm" data-v-500735e3${_scopeId}>Goal Tracker</span>`);
              } else {
                _push2(`<!---->`);
              }
      ...
      _push(`</nav><div class="px-3 py-3 border-t border-slate-100 bg-slate-50/30 space-y-1 shrink-0" data-v-500735e3>`);
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!isSidebarCollapsed.value) {
              _push2(`<span class="whitespace-nowrap text-xs font-bold" data-v-500735e3${_scopeId}>${ssrInterpolate(_ctx.$t("nav_settings", "Pengaturan"))}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(`<div class="${ssrRenderClass([isSidebarCollapsed.value ? "flex-col gap-2" : "px-2 py-1", "flex items-center justify-between group"])}" data-v-500735e3>`);
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if ((_a = user.value) == null ? void 0 : _a.avatar_url) {
              _push2(`<img${ssrRenderAttr("src", user.value.avatar_url)} alt="Avatar" class="w-8 h-8 rounded-full object-cover shadow-sm border border-white shrink-0" data-v-500735e3${_scopeId}>`);
            } else {
              _push2(`<div class="w-8 h-8 rounded-full bg-indigo-600 text-white flex items-center justify-center font-bold text-[10px] shadow-md shrink-0" data-v-500735e3${_scopeId}>${ssrInterpolate(((_c = (_b = user.value) == null ? void 0 : _b.name) == null ? void 0 : _c.charAt(0).toUpperCase()) || "U")}</div>`);
            }
            if (!isSidebarCollapsed.value) {
              _push2(`<div class="flex-1 min-w-0 overflow-hidden" data-v-500735e3${_scopeId}><p class="text-[10px] font-black text-slate-800 truncate" data-v-500735e3${_scopeId}>${ssrInterpolate(((_d = user.value) == null ? void 0 : _d.name) || "User")}</p><p class="text-[9px] font-bold text-slate-400 truncate" data-v-500735e3${_scopeId}>${ssrInterpolate(_ctx.$t("edit_profile", "Edit Profil"))}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(`<button type="button" class="w-7 h-7 rounded-full flex items-center justify-center text-slate-400 hover:bg-rose-50 hover:text-rose-500 transition-colors shrink-0"${ssrRenderAttr("title", _ctx.$t("nav_logout", "Keluar"))} data-v-500735e3>`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "logout",
        size: "16",
        "stroke-width": "2.5"
      }, null, _parent));
      _push(`</button></div></div></aside><main class="flex-1 overflow-y-auto relative w-full bg-slate-50/50 custom-scrollbar" data-v-500735e3><div class="md:hidden bg-white/90 backdrop-blur-xl h-16 flex items-center justify-between px-6 border-b border-slate-100 sticky top-0 z-50 shadow-sm" data-v-500735e3>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("dashboard"),
        prefetch: "",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-9 h-9 bg-indigo-600 rounded-xl flex items-center justify-center shadow-md shrink-0" data-v-500735e3${_scopeId}><img src="/favicon.svg?v=2" alt="Logo" class="w-6 h-6 brightness-0 invert" data-v-500735e3${_scopeId}></div><span class="text-lg font-black tracking-tighter text-slate-900" data-v-500735e3${_scopeId}>OneForMind<span class="text-indigo-600" data-v-500735e3${_scopeId}>.</span></span>`);
          } else {
            return [
      ...
      _push(`<button class="text-slate-500 hover:text-indigo-600 transition p-2 rounded-lg hover:bg-slate-50 focus:outline-none" data-v-500735e3>`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: !showingNavigationDropdown.value ? "menu" : "x",
        size: "24",
        "stroke-width": "2.5"
      }, null, _parent));
      _push(`</button></div><div class="md:hidden fixed inset-0 top-16 z-40 bg-slate-50/95 backdrop-blur-2xl overflow-y-auto custom-scrollbar" style="${ssrRenderStyle(showingNavigationDropdown.value ? null : { display: "none" })}" data-v-500735e3><div class="p-6 space-y-6 pb-32" data-v-500735e3>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("profile.edit"),
        prefetch: "",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if ((_a = user.value) == null ? void 0 : _a.avatar_url) {
              _push2(`<img${ssrRenderAttr("src", user.value.avatar_url)} alt="Avatar" class="w-14 h-14 rounded-full object-cover shadow-sm border-2 border-white shrink-0" data-v-500735e3${_scopeId}>`);
            } else {
              _push2(`<div class="w-14 h-14 rounded-full bg-indigo-600 text-white flex items-center justify-center font-black text-xl shadow-md shrink-0" data-v-500735e3${_scopeId}>${ssrInterpolate(((_c = (_b = user.value) == null ? void 0 : _b.name) == null ? void 0 : _c.charAt(0).toUpperCase()) || "U")}</div>`);
            }
            _push2(`<div class="flex-1 min-w-0" data-v-500735e3${_scopeId}><p class="text-base font-black text-slate-800 truncate leading-tight mb-1" data-v-500735e3${_scopeId}>${ssrInterpolate(((_d = user.value) == null ? void 0 : _d.name) || "User")}</p><p class="text-[11px] font-bold uppercase tracking-widest text-indigo-500" data-v-500735e3${_scopeId}>${ssrInterpolate(_ctx.$t("edit_profile", "Edit Profil"))}</p></div><div class="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center text-slate-400" data-v-500735e3${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, {
              name: "chevron-right",
              size: "14",
              "stroke-width": "3"
      ...
      _push(`<div class="bg-white rounded-[2rem] p-3 shadow-sm border border-slate-100 flex flex-col gap-1" data-v-500735e3>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("dashboard"),
        prefetch: "mount",
        cacheFor: "1m",
      ...
      _push(`</div><div class="bg-white rounded-[2rem] p-3 shadow-sm border border-slate-100 flex flex-col gap-1" data-v-500735e3>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("settings.index"),
        prefetch: "",
      ...
      _push(`<div class="h-px w-full bg-slate-100 my-1" data-v-500735e3></div><button type="button" class="w-full px-5 py-4 rounded-[1.5rem] font-bold transition-all flex items-center justify-center gap-3 text-base text-rose-500 bg-rose-50 hover:bg-rose-100 active:scale-[0.98]" data-v-500735e3>`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "logout",
        size: "20"
      }, null, _parent));
      _push(` ${ssrInterpolate(_ctx.$t("nav_logout", "Keluar"))}</button></div></div></div><div class="w-full relative z-0" data-v-500735e3>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></main>`);
      if (showLogoutModal.value) {
        _push(`<div class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6" data-v-500735e3><div class="absolute inset-0 bg-slate-900/40 backdrop-blur-sm" data-v-500735e3></div><div class="relative bg-white w-full max-w-sm rounded-[2.5rem] shadow-2xl border border-slate-100 overflow-hidden transform transition-all animate-in zoom-in-95 duration-300" data-v-500735e3><div class="p-8 text-center" data-v-500735e3><div class="w-20 h-20 bg-rose-50 text-rose-500 rounded-[2rem] flex items-center justify-center mx-auto mb-6 shadow-inner" data-v-500735e3>`);
        _push(ssrRenderComponent(_sfc_main$1, {
          name: "logout",
          size: "40",
          "stroke-width": "2.5"
        }, null, _parent));
        _push(`</div><h3 class="text-2xl font-black text-slate-800 tracking-tight mb-2" data-v-500735e3>${ssrInterpolate(_ctx.$t("modal_logout_title", "Keluar Akun?"))}</h3><p class="text-slate-500 text-sm font-medium leading-relaxed" data-v-500735e3>${ssrInterpolate(_ctx.$t("modal_logout_subtitle", "Sesi Anda akan diakhiri."))}</p></div><div class="p-6 bg-slate-50/80 border-t border-slate-100 flex flex-col gap-3" data-v-500735e3><button class="w-full bg-rose-500 text-white font-black py-4 rounded-2xl shadow-lg shadow-rose-200 hover:bg-rose-600 active:scale-[0.98] transition-all" data-v-500735e3>${ssrInterpolate(_ctx.$t("modal_logout_confirm", "Ya, Keluar"))}</button><button class="w-full bg-white text-slate-500 font-bold py-4 rounded-2xl border border-slate-200 hover:bg-slate-100 active:scale-[0.98] transition-all" data-v-500735e3>${ssrInterpolate(_ctx.$t("modal_logout_cancel", "Batal"))}</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const AuthenticatedLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-500735e3"]]);
export {
