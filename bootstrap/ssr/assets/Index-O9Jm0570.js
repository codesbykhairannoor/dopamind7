...
import GoalStats from "./GoalStats-et9fxmud.js";
import GoalCard from "./GoalCard-DJv5hVAT.js";
import GoalModal from "./GoalModal-C4tm-Bs7.js";
import _sfc_main$1 from "./GoalHeader-k6QiUgm4.js";
...
import "./MilestoneItem-Cm6lvPIn.js";
...
function useGoals(props) {
  ...
  const saveGoal = async (data) => {
    ...
    try {
      ...
      const msg = ((_d = (_c = e.response) == null ? void 0 : _c.data) == null ? void 0 : _d.message) || trans("goal_sync_error");
      fireToast("error", msg);
    } finally {
  ...
  const fireToast = (icon, title) => {
    Swal.fire({
      ...
      titleText: title,
      html: icon === "success" ? `<span style="color: white; font-weight: 700; font-size: 14px;">${title}</span>` : void 0,
