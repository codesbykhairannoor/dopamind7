  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="/favicon.ico?v=2" alt="OneForMind Logo" class="w-8 h-8 transition-transform duration-500 group-hover:rotate-[360deg] group-hover:scale-110"${_scopeId}><span class="font-black text-indigo-950 text-lg tracking-tight"${_scopeId}>OneForMind.</span>`);
          } else {
            return [
              createVNode("img", {
                src: "/favicon.ico?v=2",
