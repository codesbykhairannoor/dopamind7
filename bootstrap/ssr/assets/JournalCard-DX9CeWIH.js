      ...
      _push(ssrRenderComponent(unref(Link), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><h3 class="text-xl font-black text-slate-800 mb-3 line-clamp-2"${_scopeId}>${ssrInterpolate(__props.journal.title || _ctx.$t("journal_untitled", "Cerita Hari Ini"))}</h3><p class="text-sm font-medium text-slate-500 line-clamp-4 flex-1 leading-relaxed"${_scopeId}>${ssrInterpolate(__props.journal.content ? stripHtml(__props.journal.content) : _ctx.$t("journal_no_content", "Tidak ada teks..."))}</p></div>`);
          } else {
            return [
              createVNode("button", {
              ...
              createVNode("div", { class: "p-6 md:p-8 flex flex-col flex-1" }, [
                ...
                createVNode("p", { class: "text-sm font-medium text-slate-500 line-clamp-4 flex-1 leading-relaxed" }, toDisplayString(__props.journal.content ? stripHtml(__props.journal.content) : _ctx.$t("journal_no_content", "Tidak ada teks...")), 1)
              ])
            ];
          }
        }),
