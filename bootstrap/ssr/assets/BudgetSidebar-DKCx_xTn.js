...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-none h-fit flex flex-col gap-6 transition-colors duration-500" }, _attrs))}><div class="flex p-1 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl transition-colors duration-500"><button class="${ssrRenderClass([activeTab.value === "expense" ? "bg-white dark:bg-slate-700 text-indigo-600 dark:text-indigo-400 shadow-sm dark:shadow-none" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300", "flex-1 py-2 text-[11px] font-black uppercase tracking-widest rounded-lg transition-all"])}">${ssrInterpolate(_ctx.$t("expense"))}</button><button class="${ssrRenderClass([activeTab.value === "income" ? "bg-white dark:bg-slate-700 text-emerald-600 dark:text-emerald-400 shadow-sm dark:shadow-none" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300", "flex-1 py-2 text-[11px] font-black uppercase tracking-widest rounded-lg transition-all"])}">${ssrInterpolate(_ctx.$t("income"))}</button></div>`);
      if (activeTab.value === "expense") {
        _push(`<div class="space-y-6"><div class="flex justify-between items-center"><h3 class="font-bold text-slate-800 dark:text-white text-sm transition-colors duration-500">${ssrInterpolate(_ctx.$t("budget_target"))}</h3><button class="text-[10px] font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-500/10 px-2.5 py-1.5 rounded-lg border border-indigo-100 dark:border-indigo-500/20 hover:bg-indigo-100 dark:hover:bg-indigo-500/20 transition duration-300">+ ${ssrInterpolate(_ctx.$t("set_budget"))}</button></div>`);
        if (__props.budgets.length === 0) {
          ...
          _push(`<div class="space-y-4"><div class="p-4 rounded-xl border border-indigo-100 dark:border-indigo-500/20 bg-indigo-50/30 dark:bg-indigo-500/5 flex justify-between items-center shadow-inner dark:shadow-none transition-colors duration-500"><div class="flex flex-col"><span class="text-[11px] uppercase font-bold text-indigo-400 dark:text-indigo-500 tracking-wider transition-colors duration-500">Total Budget</span><span class="text-sm font-black text-slate-700 dark:text-slate-200 mt-0.5 transition-colors duration-500">${ssrInterpolate(unref(formatMoney)(totalBudget.value))}</span></div><div class="text-right flex flex-col"><span class="text-[11px] uppercase font-bold text-slate-400 dark:text-slate-600 tracking-wider transition-colors duration-500">Terpakai</span><span class="${ssrRenderClass([totalBudgetExpense.value > totalBudget.value ? "text-rose-500 dark:text-rose-400" : "text-indigo-600 dark:text-indigo-400", "text-sm font-black mt-0.5"])}">${ssrInterpolate(unref(formatMoney)(totalBudgetExpense.value))}</span></div></div><div class="space-y-3"><!--[-->`);
