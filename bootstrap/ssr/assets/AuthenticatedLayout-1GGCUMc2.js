...
import { _ as _sfc_main$6 } from "./OneForMindIcon-BiMr3Mnd.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.isOpen) {
        ...
        _push(`<!--]--></div></div><div class="max-h-[380px] overflow-y-auto py-2" data-v-19811b12>`);
        if (filteredResults.value.length > 0) {
          _push(`<div data-v-19811b12><!--[-->`);
          ssrRenderList(filteredResults.value, (item) => {
            _push(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<div class="w-9 h-9 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 group-hover:bg-white dark:group-hover:bg-slate-700 group-hover:text-indigo-600 transition-all shadow-sm" data-v-19811b12${_scopeId}>`);
                  _push2(ssrRenderComponent(_sfc_main$6, {
                    name: item.icon,
                    size: "18"
                  }, null, _parent2, _scopeId));
                  _push2(`</div><div class="flex-1" data-v-19811b12${_scopeId}><p class="text-[14px] font-bold text-slate-700 dark:text-slate-200 leading-none" data-v-19811b12${_scopeId}>${ssrInterpolate(item.name)}</p><p class="text-[11px] text-slate-400 mt-1 whitespace-nowrap" data-v-19811b12${_scopeId}>Go to ${ssrInterpolate(item.name)} component</p></div>`);
                  _push2(ssrRenderComponent(_sfc_main$6, {
                    name: "arrow-right",
                    size: "14",
          ...
          _push(`<div class="py-12 px-6 text-center" data-v-19811b12><div class="w-12 h-12 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-3" data-v-19811b12>`);
          _push(ssrRenderComponent(_sfc_main$6, {
            name: "zap",
            size: "20",
            class: "text-slate-400 opacity-50"
          }, null, _parent));
          _push(`</div><p class="text-[13px] font-black text-slate-600 dark:text-slate-300" data-v-19811b12>No matching results</p><p class="text-[11px] text-slate-400 mt-1" data-v-19811b12>Try switching filters or different keywords.</p></div>`);
        }
        _push(`</div><div class="px-5 py-2.5 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between" data-v-19811b12><div class="flex items-center gap-4 text-[10px] text-slate-400 font-bold tracking-wide" data-v-19811b12><span data-v-19811b12>↑↓ Navigate</span><span data-v-19811b12>⏎ Select</span></div><div class="flex items-center gap-1" data-v-19811b12><span class="text-[9px] font-black text-indigo-400 dark:text-indigo-500" data-v-19811b12>OneForMind</span></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const CommandPalette = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-19811b12"]]);
const _sfc_main$1 = {
  __name: "GlobalHeader",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="text-[13px] font-bold text-slate-400 dark:text-slate-500 group-hover:text-slate-500 transition-colors">Search anything...</span></div></button>`);
