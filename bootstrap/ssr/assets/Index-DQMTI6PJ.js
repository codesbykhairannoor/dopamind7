...
import { _ as _sfc_main$3 } from "./OneForMindIcon-Dwf7AvKJ.js";
import { useForm, router, usePage, Head } from "@inertiajs/vue3";
import dayjs from "dayjs";
import FinanceHeader from "./FinanceHeader-DsGBozsL.js";
import _sfc_main$1 from "./FinanceStats-Dry4iwQc.js";
import _sfc_main$4 from "./BudgetSidebar-DlpLOcrG.js";
import TransactionModal from "./TransactionModal-CD6rym4R.js";
import _sfc_main$5 from "./BudgetModal-CgJYjGfu.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (localTransactions.value.length === 0) {
        _push(`<div class="text-center py-12 bg-white rounded-3xl border border-dashed border-slate-200"><div class="mb-4 text-slate-300 flex items-center justify-center">`);
        _push(ssrRenderComponent(_sfc_main$3, {
          name: "finance",
          size: "48",
          "stroke-width": "1.5"
        }, null, _parent));
        _push(`</div><p class="text-slate-400 text-sm font-medium">${ssrInterpolate(_ctx.$t("no_transaction"))}</p></div>`);
      } else {
