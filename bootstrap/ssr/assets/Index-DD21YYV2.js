...
import { _ as _sfc_main$2 } from "./OneForMindIcon-Dwf7AvKJ.js";
import { A as AuthenticatedLayout } from "./AuthenticatedLayout-Dr4uklmL.js";
import Swal from "sweetalert2";
import _sfc_main$1 from "./JournalHeader-CSv9ohyu.js";
import _sfc_main$3 from "./JournalCard-DX9CeWIH.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.journals.length === 0) {
        _push(`<div class="text-center py-20 bg-white rounded-[2.5rem] border border-dashed border-slate-200 max-w-4xl mx-auto"><div class="mb-4 text-indigo-200 flex items-center justify-center">`);
        _push(ssrRenderComponent(_sfc_main$2, {
          name: "journal",
          size: "64",
          "stroke-width": "1.5"
        }, null, _parent));
        _push(`</div><h3 class="mb-2 text-xl font-black text-slate-700">${ssrInterpolate(_ctx.$t("journal_empty_title", "Belum ada cerita."))}</h3><p class="font-medium text-slate-400">${ssrInterpolate(_ctx.$t("journal_empty_subtitle", "Mulai tulis jurnal pertamamu hari ini!"))}</p></div>`);
      } else {
