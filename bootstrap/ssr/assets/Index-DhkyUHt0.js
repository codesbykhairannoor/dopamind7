...
import ResumeAiModal from "./ResumeAiModal-C-YMQkdd.js";
import _sfc_main$5 from "./MasterCvModal-BIZZxDvQ.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="min-h-screen bg-slate-50 dark:bg-slate-950 pb-24 transition-colors duration-500"><div class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 sticky top-16 z-40 shadow-sm transition-colors duration-500"><div class="w-full px-4 sm:px-6 lg:px-8 py-3"><div class="flex items-center justify-between gap-4 max-w-7xl mx-auto"><div class="flex items-center gap-2 w-full md:w-auto"><p class="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-600 mr-2 border-r border-slate-200 dark:border-slate-800 pr-4">${ssrInterpolate(_ctx.$t("job_page_title", "Job Tracker"))}</p><div class="flex items-center gap-1.5 px-3 py-1.5 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-100 dark:border-slate-700/50">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "job",
        size: "14",
        class: "text-indigo-500"
      }, null, _parent));
      _push(`<span class="text-[11px] font-bold text-slate-600 dark:text-slate-300 capitalize">${ssrInterpolate(todayDate.value)}</span>`);
      if ((_a = __props.pagination) == null ? void 0 : _a.total) {
        _push(`<span class="ml-2 text-[9px] font-black text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-500/10 px-1.5 py-0.5 rounded-full transition-colors duration-500">${ssrInterpolate(__props.pagination.total)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="flex items-center gap-3"><button class="px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all flex items-center gap-2 group relative">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "job",
        size: "18",
