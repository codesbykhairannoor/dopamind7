import { onMounted, onUnmounted, computed, ref, mergeProps, useSSRContext, unref, withCtx, renderSlot, watch, createVNode, toDisplayString, createBlock, openBlock, createTextVNode, createCommentVNode, Fragment, renderList } from "vue";
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderStyle, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderAttr } from "vue/server-renderer";
import { Link, usePage, router } from "@inertiajs/vue3";
import { _ as _sfc_main$6 } from "./OneForMindIcon-BvGLCgx4.js";
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.isOpen) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "absolute left-0 top-full mt-2 z-[100] w-full min-w-[320px] max-w-2xl origin-top transition-all duration-200" }, _attrs))} data-v-b3f7bcc8><div class="fixed inset-0 z-[-1]" data-v-b3f7bcc8></div><div class="bg-white dark:bg-slate-900 rounded-2xl shadow-[0_25px_60px_rgba(0,0,0,0.2)] dark:shadow-[0_25px_60px_rgba(0,0,0,0.5)] border border-slate-200 dark:border-slate-800 overflow-hidden" data-v-b3f7bcc8><div class="p-4 border-b border-slate-100 dark:border-slate-800" data-v-b3f7bcc8><div class="relative" data-v-b3f7bcc8><div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none" data-v-b3f7bcc8>`);
        _push(ssrRenderComponent(_sfc_main$6, {
          name: "zap",
          size: "16",
          class: "text-indigo-500"
        }, null, _parent));
        _push(`</div><input type="text"${ssrRenderAttr("value", searchQuery.value)} class="w-full pl-10 pr-12 py-2.5 bg-slate-50 dark:bg-slate-800 border-transparent focus:border-indigo-500 rounded-xl text-sm font-bold text-slate-700 dark:text-white placeholder-slate-400 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none" placeholder="Type to search..." data-v-b3f7bcc8></div><div class="flex items-center gap-2 mt-4 overflow-x-auto pb-1 no-scrollbar" data-v-b3f7bcc8><!--[-->`);
        ssrRenderList(filters, (filter) => {
          _push(`<button class="${ssrRenderClass([activeFilter.value === filter.key ? "bg-indigo-600 border-indigo-600 text-white shadow-md shadow-indigo-100 dark:shadow-none" : "bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:border-indigo-300 dark:hover:border-indigo-700", "flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-black tracking-wide transition-all border shrink-0"])}" data-v-b3f7bcc8>`);
          _push(ssrRenderComponent(_sfc_main$6, {
            name: filter.icon,
            size: "12"
          }, null, _parent));
        ...
        _push(`<!--]--></div></div><div class="max-h-[380px] overflow-y-auto py-2" data-v-b3f7bcc8>`);
        if (filteredResults.value.length > 0) {
          _push(`<div data-v-b3f7bcc8><!--[-->`);
          ssrRenderList(filteredResults.value, (item) => {
            _push(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<div class="w-9 h-9 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 group-hover:bg-white dark:group-hover:bg-slate-700 group-hover:text-indigo-600 transition-all shadow-sm" data-v-b3f7bcc8${_scopeId}>`);
                  _push2(ssrRenderComponent(_sfc_main$6, {
                    name: item.icon,
                    size: "18"
                  }, null, _parent2, _scopeId));
                  _push2(`</div><div class="flex-1" data-v-b3f7bcc8${_scopeId}><p class="text-[14px] font-bold text-slate-700 dark:text-slate-200 leading-none" data-v-b3f7bcc8${_scopeId}>${ssrInterpolate(item.name)}</p><p class="text-[11px] text-slate-400 mt-1 whitespace-nowrap" data-v-b3f7bcc8${_scopeId}>Go to ${ssrInterpolate(item.name)} component</p></div>`);
                  _push2(ssrRenderComponent(_sfc_main$6, {
                    name: "arrow-right",
                    size: "14",
                    class: "text-slate-300 opacity-0 group-hover:opacity-100 transition-all -translate-x-2 group-hover:translate-x-0"
                  }, null, _parent2, _scopeId));
                } else {
                  return [
                    createVNode("div", { class: "w-9 h-9 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 group-hover:bg-white dark:group-hover:bg-slate-700 group-hover:text-indigo-600 transition-all shadow-sm" }, [
                    ...
                    createVNode("div", { class: "flex-1" }, [
                      createVNode("p", { class: "text-[14px] font-bold text-slate-700 dark:text-slate-200 leading-none" }, toDisplayString(item.name), 1),
                      createVNode("p", { class: "text-[11px] text-slate-400 mt-1 whitespace-nowrap" }, "Go to " + toDisplayString(item.name) + " component", 1)
                    ]),
                    createVNode(_sfc_main$6, {
                      name: "arrow-right",
                      size: "14",
          ...
          _push(`<div class="py-12 px-6 text-center" data-v-b3f7bcc8><div class="w-12 h-12 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-3" data-v-b3f7bcc8>`);
          _push(ssrRenderComponent(_sfc_main$6, {
            name: "zap",
            size: "20",
            class: "text-slate-400 opacity-50"
          }, null, _parent));
          _push(`</div><p class="text-[13px] font-black text-slate-600 dark:text-slate-300" data-v-b3f7bcc8>No matching results</p><p class="text-[11px] text-slate-400 mt-1" data-v-b3f7bcc8>Try switching filters or different keywords.</p></div>`);
        }
        _push(`</div><div class="px-5 py-2.5 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between" data-v-b3f7bcc8><div class="flex items-center gap-4 text-[10px] text-slate-400 font-bold tracking-wide" data-v-b3f7bcc8><span data-v-b3f7bcc8>↑↓ Navigate</span><span data-v-b3f7bcc8>⏎ Select</span></div><div class="flex items-center gap-1" data-v-b3f7bcc8><span class="text-[9px] font-black text-indigo-400 dark:text-indigo-500" data-v-b3f7bcc8>OneForMind</span></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const CommandPalette = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-b3f7bcc8"]]);
const _sfc_main$1 = {
  __name: "GlobalHeader",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "h-16 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-b border-slate-100 dark:border-slate-800 sticky top-top z-[70] transition-all duration-500" }, _attrs))}><div class="h-full px-4 flex items-center justify-between gap-4"><div class="flex items-center gap-3 shrink-0"><button class="w-9 h-9 flex items-center justify-center rounded-xl text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-slate-200 transition-all active:scale-90" title="Toggle Sidebar"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg></button>`);
      _push(ssrRenderComponent(unref(Link), {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col h-screen bg-slate-50 dark:bg-slate-950 font-sans overflow-hidden selection:bg-indigo-500 selection:text-white relative transition-colors duration-500" }, _attrs))} data-v-14abd451>`);
      _push(ssrRenderComponent(_sfc_main$1, {
        "is-sidebar-collapsed": isSidebarCollapsed.value,
        onToggleSidebar: toggleSidebar
      }, null, _parent));
      _push(`<div class="flex flex-1 overflow-hidden relative" data-v-14abd451><aside class="${ssrRenderClass([isSidebarCollapsed.value ? "w-[68px]" : "w-[232px]", "bg-white dark:bg-slate-900 border-r border-slate-100 dark:border-slate-800 hidden md:flex flex-col z-20 shadow-[4px_0_24px_rgba(0,0,0,0.02)] dark:shadow-none flex-shrink-0 transition-all duration-300 ease-in-out relative"])}" data-v-14abd451><nav class="${ssrRenderClass([isSidebarCollapsed.value ? "px-2" : "px-2.5", "flex-1 overflow-y-auto py-3 custom-scrollbar space-y-0.5"])}" data-v-14abd451><button class="${ssrRenderClass([isSidebarCollapsed.value ? "justify-center" : "", "w-full flex items-center justify-between px-2 py-1.5 mb-0.5 rounded-lg group transition-all duration-200"])}" data-v-14abd451>`);
      if (isSidebarCollapsed.value) {
        _push(`<div class="h-px bg-slate-100 dark:bg-slate-800 w-full my-2" data-v-14abd451></div>`);
      } else {
        _push(`<!--[--><span class="text-[9px] font-black text-slate-400 dark:text-slate-600 tracking-wide ml-1 group-hover:text-slate-600 dark:group-hover:text-slate-400 transition-colors" data-v-14abd451>${ssrInterpolate(_ctx.$t("nav_core_modules", "System Core"))}</span><div class="${ssrRenderClass([coreExpanded.value ? "" : "-rotate-90", "flex items-center justify-center w-4 h-4 text-slate-300 transition-transform duration-200"])}" data-v-14abd451><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" data-v-14abd451><polyline points="6 9 12 15 18 9" data-v-14abd451></polyline></svg></div><!--]-->`);
      }
      _push(`</button><div class="space-y-0.5" style="${ssrRenderStyle(coreExpanded.value || isSidebarCollapsed.value ? null : { display: "none" })}" data-v-14abd451>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("dashboard"),
        prefetch: "hover",
        "view-transition": "",
        class: ["nav-item group", [
          ...
          isSidebarCollapsed.value ? "justify-center px-0 py-2.5" : "px-2.5 py-2 gap-3"
        ]],
        title: isSidebarCollapsed.value ? _ctx.$t("nav_item_dashboard") : ""
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="${ssrRenderClass([isActive("dashboard") ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300", "nav-icon shrink-0"])}" data-v-14abd451${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$6, {
              name: "dashboard",
              size: "18"
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
            if (!isSidebarCollapsed.value) {
              _push2(`<span class="text-[12px] font-semibold tracking-tight truncate" data-v-14abd451${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_dashboard"))}</span>`);
            } else {
              _push2(`<!---->`);
            }
            if (isActive("dashboard") && !isSidebarCollapsed.value) {
              _push2(`<div class="nav-active-bar" data-v-14abd451${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              createVNode("div", {
                class: ["nav-icon shrink-0", isActive("dashboard") ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300"]
              }, [
                createVNode(_sfc_main$6, {
                  name: "dashboard",
                  size: "18"
              ...
              isActive("dashboard") && !isSidebarCollapsed.value ? (openBlock(), createBlock("div", {
                key: 1,
      ...
      if (showModule("habit")) {
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="${ssrRenderClass([isActive("habits.*") ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300", "nav-icon shrink-0"])}" data-v-14abd451${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$6, {
                name: "habit",
                size: "18"
              }, null, _parent2, _scopeId));
              _push2(`</div>`);
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="text-[12px] font-semibold tracking-tight truncate" data-v-14abd451${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_habit"))}</span>`);
              } else {
                _push2(`<!---->`);
              }
              if (isActive("habits.*") && !isSidebarCollapsed.value) {
                _push2(`<div class="nav-active-bar" data-v-14abd451${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              return [
                createVNode("div", {
                  class: ["nav-icon shrink-0", isActive("habits.*") ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300"]
                }, [
                  createVNode(_sfc_main$6, {
                    name: "habit",
                    size: "18"
                ...
                isActive("habits.*") && !isSidebarCollapsed.value ? (openBlock(), createBlock("div", {
                  key: 1,
                  class: "nav-active-bar"
                })) : createCommentVNode("", true)
              ];
      ...
      if (showModule("planner")) {
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="${ssrRenderClass([isActive("planner.*") ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300", "nav-icon shrink-0"])}" data-v-14abd451${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$6, {
                name: "planner",
                size: "18"
              }, null, _parent2, _scopeId));
              _push2(`</div>`);
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="text-[12px] font-semibold tracking-tight truncate" data-v-14abd451${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_planner"))}</span>`);
              } else {
                _push2(`<!---->`);
              }
              if (isActive("planner.*") && !isSidebarCollapsed.value) {
                _push2(`<div class="nav-active-bar" data-v-14abd451${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              return [
                createVNode("div", {
                  class: ["nav-icon shrink-0", isActive("planner.*") ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300"]
                }, [
                  createVNode(_sfc_main$6, {
                    name: "planner",
                    size: "18"
                ...
                isActive("planner.*") && !isSidebarCollapsed.value ? (openBlock(), createBlock("div", {
                  key: 1,
                  class: "nav-active-bar"
                })) : createCommentVNode("", true)
              ];
      ...
      if (showModule("finance")) {
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="${ssrRenderClass([isActive("finance.*") ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300", "nav-icon shrink-0"])}" data-v-14abd451${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$6, {
                name: "finance",
                size: "18"
              }, null, _parent2, _scopeId));
              _push2(`</div>`);
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="text-[12px] font-semibold tracking-tight truncate" data-v-14abd451${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_finance"))}</span>`);
              } else {
                _push2(`<!---->`);
              }
              if (isActive("finance.*") && !isSidebarCollapsed.value) {
                _push2(`<div class="nav-active-bar" data-v-14abd451${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              return [
                createVNode("div", {
                  class: ["nav-icon shrink-0", isActive("finance.*") ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300"]
                }, [
                  createVNode(_sfc_main$6, {
                    name: "finance",
                    size: "18"
                ...
                isActive("finance.*") && !isSidebarCollapsed.value ? (openBlock(), createBlock("div", {
                  key: 1,
                  class: "nav-active-bar"
                })) : createCommentVNode("", true)
              ];
      ...
      _push(`</div><div class="h-3" data-v-14abd451></div><button class="${ssrRenderClass([isSidebarCollapsed.value ? "justify-center" : "", "w-full flex items-center justify-between px-2 py-1.5 mb-0.5 rounded-lg group transition-all duration-200"])}" data-v-14abd451>`);
      if (isSidebarCollapsed.value) {
        _push(`<div class="h-px bg-slate-100 dark:bg-slate-800 w-full my-2" data-v-14abd451></div>`);
      } else {
        _push(`<!--[--><div class="flex items-center gap-1.5 ml-1" data-v-14abd451><span class="text-[9px] font-black text-slate-400 dark:text-slate-600 tracking-wide group-hover:text-slate-600 dark:group-hover:text-slate-400 transition-colors" data-v-14abd451>${ssrInterpolate(_ctx.$t("nav_platinum_suite", "Platinum Suite"))}</span>`);
        if (unref(isExplorer)) {
          _push(`<div class="w-3 h-3 text-slate-300 dark:text-slate-700" data-v-14abd451><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-v-14abd451><rect x="3" y="11" width="18" height="11" rx="2" ry="2" data-v-14abd451></rect><path d="M7 11V7a5 5 0 0 1 10 0v4" data-v-14abd451></path></svg></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="${ssrRenderClass([platinumExpanded.value ? "" : "-rotate-90", "flex items-center justify-center w-4 h-4 text-slate-300 transition-transform duration-200"])}" data-v-14abd451><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" data-v-14abd451><polyline points="6 9 12 15 18 9" data-v-14abd451></polyline></svg></div><!--]-->`);
      }
      _push(`</button><div class="space-y-0.5" style="${ssrRenderStyle(platinumExpanded.value || isSidebarCollapsed.value ? null : { display: "none" })}" data-v-14abd451>`);
      if (showModule("journal")) {
        _push(`<div class="${ssrRenderClass([[
          isActive("journal.*") ? "nav-item-active" : "nav-item-default",
          isSidebarCollapsed.value ? "justify-center px-0 py-2.5" : "px-2.5 py-2 gap-3",
          !unref(canUse)("journal") ? "opacity-60" : ""
        ], "nav-item group cursor-pointer"])}"${ssrRenderAttr("title", isSidebarCollapsed.value ? _ctx.$t("nav_item_journal") : "")} data-v-14abd451><div class="${ssrRenderClass([isActive("journal.*") ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300", "nav-icon shrink-0"])}" data-v-14abd451>`);
        _push(ssrRenderComponent(_sfc_main$6, {
          name: "journal",
          size: "18"
        }, null, _parent));
        _push(`</div>`);
        if (!isSidebarCollapsed.value) {
          _push(`<span class="text-[12px] font-semibold tracking-tight truncate flex-1" data-v-14abd451>${ssrInterpolate(_ctx.$t("nav_item_journal"))}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (!unref(canUse)("journal") && !isSidebarCollapsed.value) {
          _push(`<div class="w-1.5 h-1.5 rounded-full bg-indigo-400 shrink-0 shadow-[0_0_6px_rgba(129,140,248,0.6)]" data-v-14abd451></div>`);
        } else {
          _push(`<!---->`);
        }
        if (isActive("journal.*") && !isSidebarCollapsed.value) {
          _push(`<div class="nav-active-bar" data-v-14abd451></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (showModule("calendar")) {
        ...
        ], "nav-item group cursor-pointer"])}"${ssrRenderAttr("title", isSidebarCollapsed.value ? _ctx.$t("nav_item_calendar") : "")} data-v-14abd451><div class="${ssrRenderClass([isActive("calendar.*") ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300", "nav-icon shrink-0"])}" data-v-14abd451>`);
        _push(ssrRenderComponent(_sfc_main$6, {
          name: "calendar",
          size: "18"
        }, null, _parent));
        _push(`</div>`);
        if (!isSidebarCollapsed.value) {
          _push(`<span class="text-[12px] font-semibold tracking-tight truncate flex-1" data-v-14abd451>${ssrInterpolate(_ctx.$t("nav_item_calendar"))}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (!unref(canUse)("calendar") && !isSidebarCollapsed.value) {
          _push(`<div class="w-1.5 h-1.5 rounded-full bg-indigo-400 shrink-0 shadow-[0_0_6px_rgba(129,140,248,0.6)]" data-v-14abd451></div>`);
        } else {
          _push(`<!---->`);
        }
        if (isActive("calendar.*") && !isSidebarCollapsed.value) {
          _push(`<div class="nav-active-bar" data-v-14abd451></div>`);
        } else {
          _push(`<!---->`);
        }
      ...
      if (showModule("job")) {
        ...
        ], "nav-item group cursor-pointer"])}"${ssrRenderAttr("title", isSidebarCollapsed.value ? _ctx.$t("nav_item_jobs") : "")} data-v-14abd451><div class="${ssrRenderClass([isActive("jobs.*") ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300", "nav-icon shrink-0"])}" data-v-14abd451>`);
        _push(ssrRenderComponent(_sfc_main$6, {
          name: "job",
          size: "18"
        }, null, _parent));
        _push(`</div>`);
        if (!isSidebarCollapsed.value) {
          _push(`<span class="text-[12px] font-semibold tracking-tight truncate flex-1" data-v-14abd451>${ssrInterpolate(_ctx.$t("nav_item_jobs"))}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (!unref(canUse)("job") && !isSidebarCollapsed.value) {
          _push(`<div class="w-1.5 h-1.5 rounded-full bg-indigo-400 shrink-0 shadow-[0_0_6px_rgba(129,140,248,0.6)]" data-v-14abd451></div>`);
        } else {
          _push(`<!---->`);
        }
        if (isActive("jobs.*") && !isSidebarCollapsed.value) {
          _push(`<div class="nav-active-bar" data-v-14abd451></div>`);
        } else {
          _push(`<!---->`);
        }
      ...
      if (showModule("goal")) {
        ...
        ], "nav-item group cursor-pointer"])}"${ssrRenderAttr("title", isSidebarCollapsed.value ? _ctx.$t("nav_item_goals") : "")} data-v-14abd451><div class="${ssrRenderClass([isActive("goals.*") ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300", "nav-icon shrink-0"])}" data-v-14abd451>`);
        _push(ssrRenderComponent(_sfc_main$6, {
          name: "goal",
          size: "18"
        }, null, _parent));
        _push(`</div>`);
        if (!isSidebarCollapsed.value) {
          _push(`<span class="text-[12px] font-semibold tracking-tight truncate flex-1" data-v-14abd451>${ssrInterpolate(_ctx.$t("nav_item_goals"))}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (!unref(canUse)("goal") && !isSidebarCollapsed.value) {
          _push(`<div class="w-1.5 h-1.5 rounded-full bg-indigo-400 shrink-0 shadow-[0_0_6px_rgba(129,140,248,0.6)]" data-v-14abd451></div>`);
        } else {
          _push(`<!---->`);
        }
        if (isActive("goals.*") && !isSidebarCollapsed.value) {
          _push(`<div class="nav-active-bar" data-v-14abd451></div>`);
        } else {
          _push(`<!---->`);
        }
      ...
      _push(`</div><div class="h-3" data-v-14abd451></div>`);
      if (!unref(isExplorer)) {
        _push(`<!--[--><div class="px-2 py-1.5 mb-0.5" data-v-14abd451>`);
        if (isSidebarCollapsed.value) {
          _push(`<div class="h-px bg-slate-100 dark:bg-slate-800 w-full my-2" data-v-14abd451></div>`);
        } else {
          _push(`<span class="text-[9px] font-black text-indigo-400/80 dark:text-indigo-600/80 tracking-wide ml-1" data-v-14abd451> Neural OS </span>`);
        }
        _push(`</div><div class="${ssrRenderClass([[
          ...
          isSidebarCollapsed.value ? "justify-center px-0 py-2.5" : "px-2.5 py-2 gap-3"
        ], "nav-item group cursor-pointer relative overflow-hidden"])}"${ssrRenderAttr("title", isSidebarCollapsed.value ? _ctx.$t("nav_item_coach", "AI Coach") : "")} data-v-14abd451><div class="shrink-0 text-indigo-500" data-v-14abd451>`);
        _push(ssrRenderComponent(_sfc_main$6, {
          name: "sparkles",
          size: "18"
        }, null, _parent));
        _push(`</div>`);
        if (!isSidebarCollapsed.value) {
          _push(`<span class="text-[12px] font-semibold tracking-tight truncate flex-1" data-v-14abd451>${ssrInterpolate(_ctx.$t("nav_item_coach", "AI Coach"))}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (!isSidebarCollapsed.value) {
          _push(`<span class="text-[8px] font-black text-indigo-500 uppercase bg-indigo-100 dark:bg-indigo-500/20 px-1.5 py-0.5 rounded-full shrink-0" data-v-14abd451>AI</span>`);
        } else {
          _push(`<!---->`);
        }
        if (isActive("coach.*") && !isSidebarCollapsed.value) {
          _push(`<div class="nav-active-bar bg-indigo-500" data-v-14abd451></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><!--]-->`);
      ...
      _push(`</nav></aside><main class="flex-1 overflow-y-auto relative w-full bg-slate-50 dark:bg-slate-950 pb-32 md:pb-0 transition-colors duration-500 custom-scrollbar" data-v-14abd451><div class="w-full relative z-0 px-0 pb-8 md:pb-10" data-v-14abd451>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></main></div>`);
      if (showLogoutModal.value) {
        _push(`<div class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6" data-v-14abd451><div class="absolute inset-0 bg-slate-900/40 dark:bg-slate-950/60 backdrop-blur-sm" data-v-14abd451></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-sm rounded-[2.5rem] shadow-2xl dark:shadow-none border border-slate-100 dark:border-slate-800 overflow-hidden" data-v-14abd451><div class="p-8 text-center" data-v-14abd451><div class="w-20 h-20 bg-rose-50 dark:bg-rose-500/10 text-rose-500 rounded-[2rem] flex items-center justify-center mx-auto mb-6 shadow-inner" data-v-14abd451>`);
        _push(ssrRenderComponent(_sfc_main$6, {
          name: "logout",
          size: "40",
          "stroke-width": "2.5"
        }, null, _parent));
        _push(`</div><h3 class="text-2xl font-black text-slate-800 dark:text-white tracking-tight mb-2" data-v-14abd451>${ssrInterpolate(_ctx.$t("modal_logout_title", "Keluar Akun?"))}</h3><p class="text-slate-500 dark:text-slate-400 text-sm font-medium leading-relaxed" data-v-14abd451>${ssrInterpolate(_ctx.$t("modal_logout_subtitle", "Sesi Anda akan diakhiri."))}</p></div><div class="p-6 bg-slate-50/80 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 flex flex-col gap-3" data-v-14abd451><button class="w-full bg-rose-500 text-white font-black py-4 rounded-2xl shadow-lg shadow-rose-200 dark:shadow-none hover:bg-rose-600 active:scale-[0.98] transition-all" data-v-14abd451>${ssrInterpolate(_ctx.$t("modal_logout_confirm", "Ya, Keluar"))}</button><button class="w-full bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-400 font-bold py-4 rounded-2xl border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-700 active:scale-[0.98] transition-all" data-v-14abd451>${ssrInterpolate(_ctx.$t("modal_logout_cancel", "Batal"))}</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!_ctx.route().current("coach.*")) {
        _push(`<button class="hidden md:block fixed bottom-10 right-10 z-[100] group" data-v-14abd451><div class="relative" data-v-14abd451><div class="absolute inset-0 bg-indigo-500 blur-2xl opacity-20 group-hover:opacity-40 transition-opacity rounded-full" data-v-14abd451></div><div class="relative w-14 h-14 bg-slate-900 dark:bg-indigo-600 rounded-[1.5rem] flex items-center justify-center shadow-2xl transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-2 active:scale-95 ring-4 ring-white dark:ring-slate-950 group-hover:ring-indigo-50 dark:group-hover:ring-indigo-500/20 overflow-hidden" data-v-14abd451><div class="absolute inset-0 bg-gradient-to-tr from-indigo-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" data-v-14abd451></div>`);
        _push(ssrRenderComponent(_sfc_main$6, {
          name: "sparkles",
          size: "24",
          "stroke-width": "2",
        ...
        _push(`<span class="absolute top-3 right-3 w-2.5 h-2.5 bg-emerald-500 border-2 border-white dark:border-slate-900 rounded-full animate-pulse z-20" data-v-14abd451></span></div><div class="absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-slate-900 text-white text-[10px] font-bold px-4 py-2.5 rounded-2xl whitespace-nowrap opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 pointer-events-none shadow-2xl border border-white/10 flex items-center gap-2" data-v-14abd451><span class="w-2 h-2 bg-emerald-500 rounded-full animate-pulse" data-v-14abd451></span> ${ssrInterpolate(_ctx.$t("nav_neural_active"))}</div></div></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const AuthenticatedLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-14abd451"]]);
export {
