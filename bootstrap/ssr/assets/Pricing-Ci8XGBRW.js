...
import { ListChecks, Calendar, Wallet, TrendingUp, Lock, Zap, ShieldCheck, Cloud, Sparkles, Brain, Star, MessageSquare, Globe, Infinity, Shield, ArrowRight } from "lucide-vue-next";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AuthenticatedLayout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="bg-slate-50 dark:bg-slate-950 min-h-screen pb-32 pt-20 px-4 md:px-8" data-v-92cc54aa${_scopeId}><h1 class="text-4xl md:text-6xl font-black text-slate-900 dark:text-white tracking-tighter" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t("pricing_hero_title"))} <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t("pricing_hero_highlight"))}</span></h1><p class="text-slate-500 dark:text-slate-400 font-bold max-w-xl mx-auto leading-relaxed" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t("pricing_hero_desc"))}</p><div class="inline-flex items-center p-1 bg-white dark:bg-slate-900 rounded-[1.8rem] border border-slate-100 dark:border-slate-800 shadow-sm mt-8 scale-110" data-v-92cc54aa${_scopeId}><button class="${ssrRenderClass([!isAnnual.value ? "bg-slate-950 dark:bg-white text-white dark:text-slate-950 shadow-xl" : "text-slate-400 hover:text-slate-600", "px-8 py-3 rounded-[1.6rem] text-xs font-black transition-all"])}" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t("pricing_billing_monthly"))}</button><button class="${ssrRenderClass([isAnnual.value ? "bg-slate-950 dark:bg-white text-white dark:text-slate-950 shadow-xl" : "text-slate-400 hover:text-slate-600", "px-8 py-3 rounded-[1.6rem] text-xs font-black transition-all relative flex items-center gap-2"])}" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t("pricing_billing_yearly"))} <span class="absolute -top-4 -right-2 px-2 py-1 rounded-lg bg-emerald-500 text-[8px] text-white animate-bounce shadow-lg" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t("pricing_billing_save"))}</span></button></div><div class="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" data-v-92cc54aa${_scopeId}><!--[-->`);
            ssrRenderList(plans.value, (plan, index) => {
              ...
              ], "group relative flex flex-col p-8 rounded-[3rem] border transition-all duration-700 bg-white dark:bg-slate-900 shadow-xl shadow-slate-200/50 dark:shadow-none hover:-translate-y-2 hover:shadow-2xl"])}" data-v-92cc54aa${_scopeId}>`);
              if (plan.badge) {
                _push2(`<div class="absolute -top-4 left-1/2 -translate-x-1/2 px-6 py-1.5 rounded-full bg-indigo-600 text-white text-[9px] font-black tracking-wide shadow-xl" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t(plan.badge))}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="mb-8" data-v-92cc54aa${_scopeId}><h3 class="text-xs font-black tracking-wide text-slate-400 dark:text-slate-500 mb-6" data-v-92cc54aa${_scopeId}>${ssrInterpolate(plan.name)}</h3><div class="flex items-baseline gap-2" data-v-92cc54aa${_scopeId}><span class="text-4xl lg:text-5xl font-black text-slate-950 dark:text-white tracking-tighter" data-v-92cc54aa${_scopeId}>${ssrInterpolate(plan.price)}</span>`);
              if (plan.tier > 1) {
                _push2(`<span class="text-[10px] font-bold text-slate-400 mb-1" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t(plan.period))}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div><p class="text-[11px] font-bold text-slate-500 leading-relaxed min-h-[44px] mb-8" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t(plan.desc))}</p><div class="space-y-4 mb-10 flex-grow border-t border-slate-50 dark:border-slate-800 pt-8" data-v-92cc54aa${_scopeId}><!--[-->`);
              ssrRenderList(plan.features, (feat, fIdx) => {
                _push2(`<div class="${ssrRenderClass([feat.isLocked ? "opacity-40" : "", "flex items-start gap-4"])}" data-v-92cc54aa${_scopeId}>`);
                if (feat.isHeader) {
                  _push2(`<p class="text-[9px] font-black text-slate-400 tracking-wide mt-2 mb-1 w-full" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t(feat.text))}</p>`);
                } else {
                  _push2(`<!--[--><div class="mt-1 flex items-center justify-center shrink-0" data-v-92cc54aa${_scopeId}>`);
                  ...
                  _push2(`</div><span class="${ssrRenderClass([feat.isLocked ? "text-slate-500" : "text-slate-700 dark:text-slate-200", "text-[11px] font-black leading-tight"])}" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t(feat.text))}</span><!--]-->`);
                }
                _push2(`</div>`);
              });
              _push2(`<!--]--></div><div class="mt-auto" data-v-92cc54aa${_scopeId}><button${ssrIncludeBooleanAttr(plan.tier <= unref(userTier)) ? " disabled" : ""} class="${ssrRenderClass([[
              ...
              ], "w-full py-5 rounded-[2rem] font-black text-xs transition-all duration-300 transform active:scale-95 flex items-center justify-center gap-3 group/btn shadow-xl shadow-slate-200 dark:shadow-none"])}" data-v-92cc54aa${_scopeId}>${ssrInterpolate(plan.tier === unref(userTier) ? _ctx.$t("pricing_btn_current") : _ctx.$t(plan.buttonText))} `);
              ...
              if (plan.tier > unref(userTier) && plan.initial) {
                _push2(`<p class="text-center mt-4 text-[9px] font-bold text-indigo-500" data-v-92cc54aa${_scopeId}> Guaranteed Lifetime Access </p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
            });
            _push2(`<!--]--></div><div class="mt-40 max-w-5xl mx-auto animate-in slide-in-from-bottom-12 duration-1000" data-v-92cc54aa${_scopeId}><div class="text-center mb-16" data-v-92cc54aa${_scopeId}><h2 class="text-3xl font-black text-slate-900 dark:text-white mb-4" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t("pricing_comparison_title"))}</h2><p class="text-xs font-bold text-slate-400 capitalize tracking-widest" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t("pricing_comparison_subtitle"))}</p></div><div class="bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-100 dark:border-slate-800 overflow-hidden shadow-2xl" data-v-92cc54aa${_scopeId}><table class="w-full text-left border-collapse" data-v-92cc54aa${_scopeId}><thead data-v-92cc54aa${_scopeId}><tr class="bg-slate-50 dark:bg-slate-800/50" data-v-92cc54aa${_scopeId}><th class="p-8 text-[10px] font-black tracking-wide text-slate-400" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t("pricing_feature_col_name"))}</th><th class="p-8 text-[10px] font-black tracking-wide text-slate-900 dark:text-white text-center" data-v-92cc54aa${_scopeId}>Explorer</th><th class="p-8 text-[10px] font-black tracking-wide text-indigo-500 text-center" data-v-92cc54aa${_scopeId}>Architect</th><th class="p-8 text-[10px] font-black tracking-wide text-amber-500 text-center" data-v-92cc54aa${_scopeId}>Quantum</th></tr></thead><tbody class="divide-y divide-slate-50 dark:divide-slate-800" data-v-92cc54aa${_scopeId}><!--[-->`);
            ssrRenderList([
              ...
              _push2(`<tr class="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors" data-v-92cc54aa${_scopeId}><td class="p-8 text-xs font-black text-slate-700 dark:text-slate-200" data-v-92cc54aa${_scopeId}>${ssrInterpolate(row.name)}</td><td class="p-8 text-xs font-bold text-slate-400 text-center" data-v-92cc54aa${_scopeId}>${ssrInterpolate(row.explorer)}</td><td class="p-8 text-xs font-black text-indigo-600 dark:text-indigo-400 text-center" data-v-92cc54aa${_scopeId}>${ssrInterpolate(row.architect)}</td><td class="p-8 text-xs font-black text-amber-600 dark:text-amber-500 text-center" data-v-92cc54aa${_scopeId}>${ssrInterpolate(row.quantum)}</td></tr>`);
            });
            _push2(`<!--]--></tbody></table></div><div class="mt-16 text-center" data-v-92cc54aa${_scopeId}><p class="text-[10px] font-black text-slate-400 tracking-wide mb-4" data-v-92cc54aa${_scopeId}>${ssrInterpolate(_ctx.$t("pricing_infra_badge"))}</p><div class="flex flex-wrap justify-center items-center gap-12 opacity-30 grayscale contrast-125" data-v-92cc54aa${_scopeId}><div class="flex items-center gap-2" data-v-92cc54aa${_scopeId}><div class="w-2 h-2 bg-slate-900 dark:bg-white rounded-full" data-v-92cc54aa${_scopeId}></div><span class="font-black dark:text-white tracking-tight text-[10px]" data-v-92cc54aa${_scopeId}>Asana Strength</span></div><div class="flex items-center gap-2" data-v-92cc54aa${_scopeId}><div class="w-2 h-2 bg-slate-900 dark:bg-white rounded-full" data-v-92cc54aa${_scopeId}></div><span class="font-black dark:text-white tracking-tight text-[10px]" data-v-92cc54aa${_scopeId}>ClickUp Power</span></div><div class="flex items-center gap-2" data-v-92cc54aa${_scopeId}><div class="w-2 h-2 bg-slate-900 dark:bg-white rounded-full" data-v-92cc54aa${_scopeId}></div><span class="font-black dark:text-white tracking-tight text-[10px]" data-v-92cc54aa${_scopeId}>Notion Clarity</span></div></div></div></div></div>`);
          } else {
            return [
...
const Pricing = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-92cc54aa"]]);
export {
  Pricing as default
};
