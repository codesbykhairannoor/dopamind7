    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="bg-slate-50 dark:bg-slate-950 flex flex-col max-h-[85dvh] md:max-h-[85vh] relative overflow-visible transition-all duration-500 border border-slate-200 dark:border-slate-800 shadow-2xl dark:shadow-none rounded-[2.5rem]" data-v-eddc22d0${_scopeId}><div class="px-6 md:px-8 py-6 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center bg-white dark:bg-slate-900 z-20 shrink-0 transition-colors duration-500" data-v-eddc22d0${_scopeId}><div class="flex items-center gap-4 transition-colors duration-500" data-v-eddc22d0${_scopeId}><div class="w-12 h-12 bg-indigo-600 rounded-2xl flex items-center justify-center text-2xl shadow-lg dark:shadow-none shadow-indigo-200 dark:shadow-indigo-900/20 shrink-0" data-v-eddc22d0${_scopeId}> ✨ </div><div data-v-eddc22d0${_scopeId}><h3 class="text-xl font-black text-slate-800 dark:text-white tracking-tight leading-none mb-2 transition-colors duration-500" data-v-eddc22d0${_scopeId}>${ssrInterpolate(__props.form.id ? _ctx.$t("edit_transaction", "Edit transaction") : _ctx.$t("record_transaction", "Record transaction"))}</h3>`);
            if (!__props.form.id) {
              _push2(`<button type="button" class="text-[10px] font-bold tracking-tight px-3 py-1.5 rounded-xl bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-500/20 transition duration-300 flex items-center gap-1.5 active:scale-95 w-fit border border-indigo-100 dark:border-indigo-500/20" data-v-eddc22d0${_scopeId}><span data-v-eddc22d0${_scopeId}>⚡</span> ${ssrInterpolate(_ctx.$t("batch_mode_title", "Collective record"))}</button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><button class="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 hover:bg-rose-100 dark:hover:bg-rose-500/20 hover:text-rose-500 dark:hover:text-rose-400 transition-all active:scale-90 flex items-center justify-center font-bold" data-v-eddc22d0${_scopeId}> ✕ </button></div><div class="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-8 space-y-5" data-v-eddc22d0${_scopeId}><div class="flex bg-slate-100 dark:bg-slate-800 p-1.5 rounded-2xl transition-colors duration-500" data-v-eddc22d0${_scopeId}><button type="button" class="${ssrRenderClass([__props.form.type === "expense" ? "bg-white dark:bg-slate-700 text-rose-600 dark:text-rose-400 shadow-sm dark:shadow-none" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300", "flex-1 py-3 rounded-xl text-[10px] font-bold tracking-tight transition-all flex items-center justify-center gap-2 transition-colors duration-300"])}" data-v-eddc22d0${_scopeId}>`);
            if (__props.form.type === "expense") {
              _push2(`<span data-v-eddc22d0${_scopeId}>🔴</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(` ${ssrInterpolate(_ctx.$t("out", "Expense"))}</button><button type="button" class="${ssrRenderClass([__props.form.type === "income" ? "bg-white dark:bg-slate-700 text-emerald-600 dark:text-emerald-400 shadow-sm dark:shadow-none" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300", "flex-1 py-3 rounded-xl text-[10px] font-bold tracking-tight transition-all flex items-center justify-center gap-2 transition-colors duration-300"])}" data-v-eddc22d0${_scopeId}>`);
            if (__props.form.type === "income") {
              _push2(`<span data-v-eddc22d0${_scopeId}>🟢</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(` ${ssrInterpolate(_ctx.$t("in", "Income"))}</button></div><div data-v-eddc22d0${_scopeId}><label class="${ssrRenderClass([__props.form.type === "expense" ? "text-rose-400 dark:text-rose-400/80" : "text-emerald-400 dark:text-emerald-400/80", "block text-[10px] font-bold tracking-tight mb-2 transition-colors duration-500 ml-1"])}" data-v-eddc22d0${_scopeId}>${ssrInterpolate(_ctx.$t("amount"))}</label><div class="relative group" data-v-eddc22d0${_scopeId}><span class="${ssrRenderClass([__props.form.type === "expense" ? "text-rose-500 dark:text-rose-400" : "text-emerald-500 dark:text-emerald-400", "absolute left-4 top-1/2 -translate-y-1/2 font-black text-lg transition-colors duration-500"])}" data-v-eddc22d0${_scopeId}>${ssrInterpolate(currencySymbol.value)}</span><input type="text"${ssrRenderAttr("value", formatDisplay(__props.form.amount))} placeholder="0" class="${ssrRenderClass([[
            ...
            ], "w-full pl-12 pr-4 h-14 rounded-xl border-2 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 focus:ring-0 font-black text-2xl transition-all dark:text-white"])}" data-v-eddc22d0${_scopeId}></div></div><div data-v-eddc22d0${_scopeId}><label class="block text-[10px] font-bold text-slate-400 dark:text-slate-600 mb-2 transition-colors duration-500 ml-1 tracking-tight" data-v-eddc22d0${_scopeId}>${ssrInterpolate(_ctx.$t("description"))}</label><input${ssrRenderAttr("value", __props.form.title)} type="text"${ssrRenderAttr("placeholder", _ctx.$t("desc_placeholder", "Cth: Kopi, Gaji..."))} class="${ssrRenderClass([{ "!border-rose-300 dark:!border-rose-500/50 !bg-rose-50 dark:!bg-rose-500/10 text-rose-600 dark:text-rose-400 placeholder-rose-300": (_b = __props.form.errors) == null ? void 0 : _b.title }, "w-full px-4 h-12 rounded-xl border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 focus:border-indigo-500 focus:ring-0 font-bold text-sm text-slate-700 dark:text-slate-200 transition-all placeholder:text-slate-300 dark:placeholder:text-slate-700"])}" data-v-eddc22d0${_scopeId}></div><div class="grid grid-cols-2 gap-4" data-v-eddc22d0${_scopeId}><div data-v-eddc22d0${_scopeId}><label class="block text-[10px] font-bold text-slate-400 dark:text-slate-600 mb-2 transition-colors duration-500 ml-1 tracking-tight" data-v-eddc22d0${_scopeId}>${ssrInterpolate(_ctx.$t("category"))}</label><div class="relative" data-v-eddc22d0${_scopeId}><select class="${ssrRenderClass([{ "!border-rose-300 dark:!border-rose-500/50 !bg-rose-50 dark:!bg-rose-500/10 text-rose-600 dark:text-rose-400": (_c = __props.form.errors) == null ? void 0 : _c.category }, "w-full pl-4 pr-8 h-12 rounded-xl border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 focus:border-indigo-500 focus:ring-0 font-bold text-slate-700 dark:text-slate-200 text-sm appearance-none cursor-pointer transition-all"])}" data-v-eddc22d0${_scopeId}><option value="" disabled data-v-eddc22d0${ssrIncludeBooleanAttr(Array.isArray(__props.form.category) ? ssrLooseContain(__props.form.category, "") : ssrLooseEqual(__props.form.category, "")) ? " selected" : ""}${_scopeId}>${ssrInterpolate(_ctx.$t("select_placeholder", "Select category..."))}</option><!--[-->`);
            ssrRenderList(availableCategories.value, (catSlug) => {
              _push2(`<option${ssrRenderAttr("value", catSlug)} data-v-eddc22d0${ssrIncludeBooleanAttr(Array.isArray(__props.form.category) ? ssrLooseContain(__props.form.category, catSlug) : ssrLooseEqual(__props.form.category, catSlug)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(getDetail(catSlug).icon)} ${ssrInterpolate(getDetail(catSlug).name)}</option>`);
            });
            _push2(`<!--]--></select><div class="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400 dark:text-slate-600" data-v-eddc22d0${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5" data-v-eddc22d0${_scopeId}><path d="M19 9l-7 7-7-7" data-v-eddc22d0${_scopeId}></path></svg></div></div></div><div class="relative" data-v-eddc22d0${_scopeId}><label class="block text-[10px] font-bold text-slate-400 dark:text-slate-600 mb-2 transition-colors duration-500 ml-1 tracking-tight" data-v-eddc22d0${_scopeId}>${ssrInterpolate(_ctx.$t("date"))}</label><button type="button" class="w-full px-4 h-12 rounded-xl border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-indigo-300 dark:hover:border-indigo-500/40 font-bold text-slate-700 dark:text-slate-200 text-sm transition-all flex items-center justify-between transition-colors duration-500" data-v-eddc22d0${_scopeId}><span class="truncate" data-v-eddc22d0${_scopeId}>${ssrInterpolate(dateDisplay.value)}</span><span class="text-slate-400 dark:text-slate-600" data-v-eddc22d0${_scopeId}>📅</span></button>`);
            if (showDatePicker.value) {
              _push2(`<div class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-0 sm:absolute sm:bottom-full sm:right-0 sm:mb-2 sm:origin-bottom-right sm:block sm:inset-auto" data-v-eddc22d0${_scopeId}><div class="fixed inset-0 bg-slate-900/40 dark:bg-black/60 backdrop-blur-sm sm:hidden" data-v-eddc22d0${_scopeId}></div>`);
            ...
            _push2(`</div></div></div><div class="px-6 md:px-8 py-5 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 flex gap-3 z-20 shrink-0 transition-colors duration-500 pb-8 md:pb-6" data-v-eddc22d0${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              onClick: __props.close,
              class: "flex-1 !py-3.5 !rounded-xl !text-[11px] !font-bold !border-2 dark:!border-slate-700 !text-slate-400 dark:!text-slate-600 hover:!text-slate-600 dark:hover:!text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 bg-white dark:bg-slate-900 transition-all duration-300"
            }, {
            ...
            _push2(ssrRenderComponent(PrimaryButton, {
              ...
              class: ["flex-[2] !rounded-xl !py-3.5 shadow-xl dark:shadow-none transition-all transform active:scale-95 font-bold text-[11px] justify-center transition-all duration-300", __props.form.type === "expense" ? "!bg-rose-500 hover:!bg-rose-600 shadow-rose-200 dark:shadow-rose-900/40" : "!bg-emerald-500 hover:!bg-emerald-600 shadow-emerald-200 dark:shadow-emerald-900/40"]
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (__props.form.processing) {
                    _push3(`<span class="flex items-center gap-2" data-v-eddc22d0${_scopeId2}><svg class="animate-spin h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" data-v-eddc22d0${_scopeId2}><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-eddc22d0${_scopeId2}></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-eddc22d0${_scopeId2}></path></svg></span>`);
                  } else {
                    _push3(`<span data-v-eddc22d0${_scopeId2}>${ssrInterpolate(_ctx.$t("btn_save_manual"))}</span>`);
                  }
                } else {
                  return [
                    ...
                    ])) : (openBlock(), createBlock("span", { key: 1 }, toDisplayString(_ctx.$t("btn_save_manual")), 1))
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("div", { class: "bg-slate-50 dark:bg-slate-950 flex flex-col max-h-[85dvh] md:max-h-[85vh] relative overflow-visible transition-all duration-500 border border-slate-200 dark:border-slate-800 shadow-2xl dark:shadow-none rounded-[2.5rem]" }, [
                createVNode("div", { class: "px-6 md:px-8 py-6 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center bg-white dark:bg-slate-900 z-20 shrink-0 transition-colors duration-500" }, [
                  createVNode("div", { class: "flex items-center gap-4 transition-colors duration-500" }, [
                    ...
                    createVNode("div", null, [
                      createVNode("h3", { class: "text-xl font-black text-slate-800 dark:text-white tracking-tight leading-none mb-2 transition-colors duration-500" }, toDisplayString(__props.form.id ? _ctx.$t("edit_transaction", "Edit transaction") : _ctx.$t("record_transaction", "Record transaction")), 1),
                      !__props.form.id ? (openBlock(), createBlock("button", {
                        ...
                        createTextVNode(" " + toDisplayString(_ctx.$t("batch_mode_title", "Collective record")), 1)
                ...
                createVNode("div", { class: "flex-1 overflow-y-auto custom-scrollbar p-6 md:p-8 space-y-5" }, [
                  createVNode("div", { class: "flex bg-slate-100 dark:bg-slate-800 p-1.5 rounded-2xl transition-colors duration-500" }, [
                    createVNode("button", {
                      ...
                      class: ["flex-1 py-3 rounded-xl text-[10px] font-bold tracking-tight transition-all flex items-center justify-center gap-2 transition-colors duration-300", __props.form.type === "expense" ? "bg-white dark:bg-slate-700 text-rose-600 dark:text-rose-400 shadow-sm dark:shadow-none" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"]
                    }, [
                      __props.form.type === "expense" ? (openBlock(), createBlock("span", { key: 0 }, "🔴")) : createCommentVNode("", true),
                      createTextVNode(" " + toDisplayString(_ctx.$t("out", "Expense")), 1)
                    ], 10, ["onClick"]),
                    createVNode("button", {
                      type: "button",
                      ...
                      __props.form.type === "income" ? (openBlock(), createBlock("span", { key: 0 }, "🟢")) : createCommentVNode("", true),
                      createTextVNode(" " + toDisplayString(_ctx.$t("in", "Income")), 1)
                    ], 10, ["onClick"])
                  ]),
                  createVNode("div", null, [
                    createVNode("label", {
                      class: ["block text-[10px] font-bold tracking-tight mb-2 transition-colors duration-500 ml-1", __props.form.type === "expense" ? "text-rose-400 dark:text-rose-400/80" : "text-emerald-400 dark:text-emerald-400/80"]
                    }, toDisplayString(_ctx.$t("amount")), 3),
                  ...
                  createVNode("div", null, [
                    createVNode("label", { class: "block text-[10px] font-bold text-slate-400 dark:text-slate-600 mb-2 transition-colors duration-500 ml-1 tracking-tight" }, toDisplayString(_ctx.$t("description")), 1),
                  ...
                  createVNode("div", { class: "grid grid-cols-2 gap-4" }, [
                    createVNode("div", null, [
                      createVNode("label", { class: "block text-[10px] font-bold text-slate-400 dark:text-slate-600 mb-2 transition-colors duration-500 ml-1 tracking-tight" }, toDisplayString(_ctx.$t("category")), 1),
                      createVNode("div", { class: "relative" }, [
                        withDirectives(createVNode("select", {
                          "onUpdate:modelValue": ($event) => __props.form.category = $event,
                          class: ["w-full pl-4 pr-8 h-12 rounded-xl border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 focus:border-indigo-500 focus:ring-0 font-bold text-slate-700 dark:text-slate-200 text-sm appearance-none cursor-pointer transition-all", { "!border-rose-300 dark:!border-rose-500/50 !bg-rose-50 dark:!bg-rose-500/10 text-rose-600 dark:text-rose-400": (_f = __props.form.errors) == null ? void 0 : _f.category }]
                        }, [
                          createVNode("option", {
                            value: "",
                            disabled: ""
                          }, toDisplayString(_ctx.$t("select_placeholder", "Select category...")), 1),
                    ...
                    createVNode("div", { class: "relative" }, [
                      createVNode("label", { class: "block text-[10px] font-bold text-slate-400 dark:text-slate-600 mb-2 transition-colors duration-500 ml-1 tracking-tight" }, toDisplayString(_ctx.$t("date")), 1),
                      createVNode("button", {
                        type: "button",
                ...
                createVNode("div", { class: "px-6 md:px-8 py-5 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 flex gap-3 z-20 shrink-0 transition-colors duration-500 pb-8 md:pb-6" }, [
...
const TransactionModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-eddc22d0"]]);
export {
