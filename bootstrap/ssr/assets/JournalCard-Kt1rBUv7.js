        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.journal.ai_sentiment || __props.isExplorer) {
              ...
              _push2(`<div class="relative z-10 flex flex-col gap-2"${_scopeId}><div class="flex items-center gap-2"${_scopeId}><span class="w-1.5 h-1.5 rounded-full bg-indigo-500 animate-pulse"${_scopeId}></span><span class="text-[9px] font-black text-indigo-600 dark:text-indigo-400 tracking-widest"${_scopeId}>Neural sentiment analysis</span>`);
              if (__props.isExplorer) {
                _push2(`<div class="ml-auto px-1.5 py-0.5 rounded bg-indigo-500 text-white text-[7px] font-black tracking-widest"${_scopeId}>Elite</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            return [
              ...
              createVNode("div", { class: "p-6 md:p-8 flex flex-col flex-1" }, [
                createVNode("div", { class: "flex items-center justify-between mb-4" }, [
                  createVNode("span", { class: "text-[9px] font-black tracking-widest text-slate-400 dark:text-slate-500 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-800 px-3 py-1.5 rounded-lg transition-colors duration-500" }, toDisplayString(formatDate(__props.journal.date)), 1),
                ...
                __props.journal.ai_sentiment || __props.isExplorer ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("div", { class: "relative z-10 flex flex-col gap-2" }, [
                    createVNode("div", { class: "flex items-center gap-2" }, [
                      ...
                      createVNode("span", { class: "text-[9px] font-black text-indigo-600 dark:text-indigo-400 tracking-widest" }, "Neural sentiment analysis"),
                      __props.isExplorer ? (openBlock(), createBlock("div", {
                        key: 0,
                        class: "ml-auto px-1.5 py-0.5 rounded bg-indigo-500 text-white text-[7px] font-black tracking-widest"
