      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (__props.show) {
              ...
              if (_push3) {
                ...
                return [
                  ...
                  createVNode("div", { class: "relative z-10" }, [
                    createVNode("div", { class: "flex justify-between items-center mb-4 md:mb-6" }, [
                      createVNode("span", { class: "text-[10px] sm:text-[11px] font-black tracking-widest bg-white/20 px-3 py-1.5 rounded-xl backdrop-blur-sm border border-white/20" }, toDisplayString(_ctx.$t("calendar_goals", "Goals & milestones")), 1),
            ...
            default: withCtx((_, _push3, _parent2, _scopeId) => {
              if (_push3) {
                ...
                return [
                  ...
                  createVNode("div", { class: "relative z-10" }, [
                    createVNode("div", { class: "flex justify-between items-center mb-4 md:mb-6" }, [
                      createVNode("span", { class: "text-[10px] sm:text-[11px] font-black tracking-widest bg-white/20 px-3 py-1.5 rounded-xl backdrop-blur-sm border border-white/20" }, toDisplayString(_ctx.$t("calendar_planner", "Daily planner")), 1),
          ...
          _push2(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push3, _parent2, _scopeId) => {
              if (_push3) {
                _push3(`<div class="absolute -right-3 -bottom-3 text-6xl opacity-[0.05] group-hover:scale-125 transition-transform duration-700"${_scopeId}>🌱</div><div${_scopeId}><span class="text-[10px] sm:text-[11px] font-black tracking-widest text-emerald-500 mb-2 md:mb-3 block leading-none"${_scopeId}>${ssrInterpolate(_ctx.$t("calendar_habits", "Habits"))}</span>`);
                ...
                return [
                  ...
                  createVNode("div", null, [
                    createVNode("span", { class: "text-[10px] sm:text-[11px] font-black tracking-widest text-emerald-500 mb-2 md:mb-3 block leading-none" }, toDisplayString(_ctx.$t("calendar_habits", "Habits")), 1),
          ...
          _push2(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push3, _parent2, _scopeId) => {
              if (_push3) {
                _push3(`<div class="absolute -right-3 -bottom-3 text-6xl opacity-[0.05] group-hover:scale-125 transition-transform duration-700"${_scopeId}>💸</div><div${_scopeId}><span class="text-[10px] sm:text-[11px] font-black tracking-widest text-rose-500 mb-2 md:mb-3 block leading-none"${_scopeId}>${ssrInterpolate(_ctx.$t("calendar_finance", "Finance"))}</span>`);
                ...
                return [
                  createVNode("div", { class: "absolute -right-3 -bottom-3 text-6xl opacity-[0.05] group-hover:scale-125 transition-transform duration-700" }, "💸"),
                  createVNode("div", null, [
                    createVNode("span", { class: "text-[10px] sm:text-[11px] font-black tracking-widest text-rose-500 mb-2 md:mb-3 block leading-none" }, toDisplayString(_ctx.$t("calendar_finance", "Finance")), 1),
