...
import TransactionModal from "./TransactionModal-h6P_pbXq.js";
...
import FinanceBatchModal from "./FinanceBatchModal-C5vkfJha.js";
...
import { _ as _sfc_main$c } from "./PremiumPreviewModal-BdH6vUzw.js";
import { _ as _sfc_main$3 } from "./NeuralBridge-CJtvqtxu.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isExplorer)) {
        _push(ssrRenderComponent(_sfc_main$4, {
          onClick: ($event) => openPremiumPreview("Finance")
        }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`</div></div><div class="lg:col-span-3 space-y-8 w-full order-2 lg:order-1 pb-24 lg:pb-0"><div class="space-y-4"><div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-1 lg:px-0"><div class="flex items-center gap-2"><h3 class="text-base lg:text-lg font-bold text-slate-800 dark:text-white transition-colors duration-500">${ssrInterpolate(_ctx.$t("daily_history"))}</h3>`);
      if (!unref(filterDate)) {
      ...
      if (unref(isExplorer)) {
        _push(`<div class="absolute inset-0 z-20 rounded-[3rem] overflow-hidden group/locked-vault cursor-pointer transition-all duration-700 border border-slate-100 dark:border-slate-800 shadow-2xl"><div class="absolute inset-0 bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl transition-all duration-700 group-hover/locked-vault:backdrop-blur-none"></div><div class="absolute inset-0 opacity-10 group-hover/locked-vault:opacity-20 transition-opacity duration-1000 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-orange-400 via-transparent to-transparent"></div><div class="relative z-10 h-full flex items-center justify-center p-8 text-center bg-white/50 dark:bg-slate-900/50"><div class="max-w-xs animate-in zoom-in duration-500"><div class="w-20 h-20 bg-gradient-to-br from-orange-400 to-amber-600 dark:from-orange-500 dark:to-amber-700 rounded-3xl flex items-center justify-center mx-auto mb-6 text-white shadow-2xl rotate-3 group-hover/locked-vault:rotate-0 transition-transform">`);
        _push(ssrRenderComponent(unref(Lock), {
          size: 40,
          "stroke-width": "2.5"
        }, null, _parent));
        _push(`</div><h4 class="text-xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Vault architecture</h4><p class="text-xs font-bold text-slate-500 dark:text-slate-400 leading-relaxed mb-6">Manifest your wealth with automated accumulation protocols.</p><div class="inline-flex items-center gap-2 text-[10px] font-black text-orange-600 dark:text-orange-400 tracking-widest uppercase"><span class="w-1.5 h-1.5 rounded-full bg-orange-500 animate-ping"></span>Unlock architect tier</div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`<!--]--></div><div class="mt-auto flex items-center justify-between"><span class="text-[10px] font-black text-indigo-200 tracking-widest">Unlock predictions</span>`);
      _push(ssrRenderComponent(unref(ArrowRight), {
        size: 16,
        class: "text-white group-hover:translate-x-1 transition-transform"
      }, null, _parent));
      _push(`</div></div><div class="absolute inset-0 bg-white/5 backdrop-blur-[1px] opacity-20 transition-opacity group-hover:opacity-0"></div></div></div></div><div class="relative">`);
      if (unref(isExplorer)) {
        _push(ssrRenderComponent(_sfc_main$4, {
          onClick: ($event) => openPremiumPreview("Finance")
        }, null, _parent));
