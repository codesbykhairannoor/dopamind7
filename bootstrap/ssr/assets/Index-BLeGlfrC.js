...
import TransactionModal from "./TransactionModal-GJUxtKTc.js";
import _sfc_main$6 from "./BudgetModal-BYd_Qwgx.js";
import _sfc_main$7 from "./CategoryModal-DzJEpHWn.js";
...
import _sfc_main$8 from "./SavingModal-DY2vbql9.js";
import _sfc_main$9 from "./VaultTransactionModal-Bt0fhf-P.js";
import { Wallet, Lock, Plus, TrendingUp } from "lucide-vue-next";
import { _ as _sfc_main$a } from "./PremiumPreviewModal-BdH6vUzw.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="lg:col-span-3 space-y-8 w-full order-2 lg:order-1 pb-24 lg:pb-0"><div class="space-y-4"><div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-1 lg:px-0"><div class="flex items-center gap-2"><h3 class="text-base lg:text-lg font-bold text-slate-800 dark:text-white transition-colors duration-500">${ssrInterpolate(_ctx.$t("daily_history"))}</h3>`);
      if (!unref(filterDate)) {
      ...
      _push(`</div></div><button class="flex items-center gap-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-3 py-2 lg:px-4 rounded-xl text-[9px] lg:text-[10px] font-black tracking-widest hover:scale-105 transition-all active:scale-95 shadow-lg dark:shadow-none">`);
      _push(ssrRenderComponent(unref(Plus), { size: 14 }, null, _parent));
      _push(`<span class="hidden sm:inline">${ssrInterpolate(unref(isExplorer) ? "Unlock goal" : "Create goal")}</span><span class="sm:hidden">Goal</span></button></div><div class="grid grid-cols-1 md:grid-cols-2 gap-6 relative">`);
      if (unref(isExplorer)) {
        _push(`<div class="absolute inset-0 z-20 backdrop-blur-[2px] bg-white/10 dark:bg-slate-900/10 rounded-[2.5rem] flex items-center justify-center cursor-pointer group/locked-vault transition-all duration-500 border border-transparent hover:border-orange-500/20"><div class="bg-white/90 dark:bg-slate-900/90 p-8 rounded-[2rem] shadow-2xl border border-slate-100 dark:border-slate-800 text-center scale-95 group-hover/locked-vault:scale-100 transition-transform"><div class="w-16 h-16 bg-orange-500/10 rounded-2xl flex items-center justify-center mx-auto mb-4 text-orange-500">`);
        _push(ssrRenderComponent(unref(Lock), {
          size: 32,
          "stroke-width": "2.5"
        }, null, _parent));
        _push(`</div><h4 class="text-lg font-black text-slate-800 dark:text-white mb-2">Vault Integration</h4><p class="text-xs font-bold text-slate-500 dark:text-slate-400 max-w-[200px] mx-auto leading-relaxed"> Join the Architect tier to unlock automated wealth manifestation. </p></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (localSavings.value.length === 0) {
        _push(`<div class="group bg-white dark:bg-slate-900 rounded-[2.5rem] border border-dashed border-slate-200 dark:border-slate-800 p-10 text-center transition-colors col-span-1"><div class="mb-4 text-3xl transform group-hover:scale-110 transition-transform duration-500">🏦</div><h4 class="text-slate-400 font-bold text-[10px] lg:text-sm mb-4">You have no active saving goals yet.</h4><button class="text-[9px] lg:text-[10px] font-bold uppercase tracking-widest text-indigo-600 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900 px-5 py-2 rounded-xl hover:bg-indigo-50 dark:hover:bg-indigo-500/5 transition-all"> Start Saving Now </button></div>`);
      } else {
      ...
      _push(`</div></div><div class="absolute inset-0 bg-white/5 backdrop-blur-[1px] opacity-20 transition-opacity group-hover:opacity-0"></div></div></div></div>`);
