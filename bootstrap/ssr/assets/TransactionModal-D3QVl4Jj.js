    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="bg-slate-50 dark:bg-slate-950 flex flex-col max-h-[85vh] relative overflow-hidden transition-all duration-500 border border-slate-200 dark:border-slate-800 shadow-2xl dark:shadow-none rounded-[2.5rem]" data-v-8c4f7469${_scopeId}><div class="px-6 md:px-8 py-6 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center bg-white dark:bg-slate-900 z-20 shrink-0 transition-colors duration-500" data-v-8c4f7469${_scopeId}><div class="flex items-center gap-4 transition-colors duration-500" data-v-8c4f7469${_scopeId}><div class="w-12 h-12 bg-indigo-600 rounded-2xl flex items-center justify-center text-2xl shadow-lg dark:shadow-none shadow-indigo-200 dark:shadow-indigo-900/20 shrink-0" data-v-8c4f7469${_scopeId}> ✨ </div><div data-v-8c4f7469${_scopeId}><h3 class="text-xl font-black text-slate-800 dark:text-white tracking-tight leading-none mb-2 transition-colors duration-500" data-v-8c4f7469${_scopeId}>${ssrInterpolate(__props.form.id ? _ctx.$t("edit_transaction", "Edit Transaksi") : _ctx.$t("record_transaction", "Catat Transaksi"))}</h3>`);
            if (!__props.form.id) {
              _push2(`<button type="button" class="text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-xl bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-500/20 transition duration-300 flex items-center gap-1.5 active:scale-95 w-fit border border-indigo-100 dark:border-indigo-500/20" data-v-8c4f7469${_scopeId}><span data-v-8c4f7469${_scopeId}>⚡</span> ${ssrInterpolate(_ctx.$t("batch_mode_title", "Batch Mode"))}</button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><button class="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 hover:bg-rose-100 dark:hover:bg-rose-500/20 hover:text-rose-500 dark:hover:text-rose-400 transition-all active:scale-90 flex items-center justify-center font-bold" data-v-8c4f7469${_scopeId}> ✕ </button></div><div class="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-8 space-y-5" data-v-8c4f7469${_scopeId}><div class="flex bg-slate-100 dark:bg-slate-800 p-1.5 rounded-2xl transition-colors duration-500" data-v-8c4f7469${_scopeId}><button type="button" class="${ssrRenderClass([__props.form.type === "expense" ? "bg-white dark:bg-slate-700 text-rose-600 dark:text-rose-400 shadow-sm dark:shadow-none" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300", "flex-1 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 transition-colors duration-300"])}" data-v-8c4f7469${_scopeId}>${ssrInterpolate(_ctx.$t("out", "Keluar"))}</button><button type="button" class="${ssrRenderClass([__props.form.type === "income" ? "bg-white dark:bg-slate-700 text-emerald-600 dark:text-emerald-400 shadow-sm dark:shadow-none" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300", "flex-1 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 transition-colors duration-300"])}" data-v-8c4f7469${_scopeId}>${ssrInterpolate(_ctx.$t("in", "Masuk"))}</button></div><div data-v-8c4f7469${_scopeId}><label class="${ssrRenderClass([__props.form.type === "expense" ? "text-rose-400 dark:text-rose-400/80" : "text-emerald-400 dark:text-emerald-400/80", "block text-[10px] uppercase font-black tracking-widest mb-2 transition-colors duration-500"])}" data-v-8c4f7469${_scopeId}>${ssrInterpolate(_ctx.$t("amount", "Nominal"))}</label><div class="relative group" data-v-8c4f7469${_scopeId}><span class="${ssrRenderClass([__props.form.type === "expense" ? "text-rose-500 dark:text-rose-400" : "text-emerald-500 dark:text-emerald-400", "absolute left-4 top-1/2 -translate-y-1/2 font-black text-lg transition-colors duration-500"])}" data-v-8c4f7469${_scopeId}>${ssrInterpolate(currencySymbol.value)}</span><input type="text"${ssrRenderAttr("value", formatDisplay(__props.form.amount))} placeholder="0" class="${ssrRenderClass([[
            ...
            ], "w-full pl-12 pr-4 h-14 rounded-xl border-2 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 focus:ring-0 font-black text-2xl transition-all dark:text-white"])}" data-v-8c4f7469${_scopeId}></div></div><div data-v-8c4f7469${_scopeId}><label class="block text-[10px] uppercase font-black text-slate-400 dark:text-slate-600 tracking-widest mb-2 transition-colors duration-500" data-v-8c4f7469${_scopeId}>${ssrInterpolate(_ctx.$t("description", "Keterangan"))}</label><input${ssrRenderAttr("value", __props.form.title)} type="text"${ssrRenderAttr("placeholder", _ctx.$t("desc_placeholder", "Cth: Kopi, Gaji..."))} class="${ssrRenderClass([{ "!border-rose-300 dark:!border-rose-500/50 !bg-rose-50 dark:!bg-rose-500/10 text-rose-600 dark:text-rose-400 placeholder-rose-300": (_b = __props.form.errors) == null ? void 0 : _b.title }, "w-full px-4 h-12 rounded-xl border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 focus:border-indigo-500 focus:ring-0 font-bold text-sm text-slate-700 dark:text-slate-200 transition-all placeholder:text-slate-300 dark:placeholder:text-slate-700"])}" data-v-8c4f7469${_scopeId}></div><div class="grid grid-cols-2 gap-4" data-v-8c4f7469${_scopeId}><div data-v-8c4f7469${_scopeId}><label class="block text-[10px] uppercase font-black text-slate-400 dark:text-slate-600 tracking-widest mb-2 transition-colors duration-500" data-v-8c4f7469${_scopeId}>${ssrInterpolate(_ctx.$t("category", "Kategori"))}</label><div class="relative" data-v-8c4f7469${_scopeId}><select class="${ssrRenderClass([{ "!border-rose-300 dark:!border-rose-500/50 !bg-rose-50 dark:!bg-rose-500/10 text-rose-600 dark:text-rose-400": (_c = __props.form.errors) == null ? void 0 : _c.category }, "w-full pl-4 pr-8 h-12 rounded-xl border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 focus:border-indigo-500 focus:ring-0 font-bold text-slate-700 dark:text-slate-200 capitalize text-sm appearance-none cursor-pointer transition-all"])}" data-v-8c4f7469${_scopeId}><option value="" disabled data-v-8c4f7469${ssrIncludeBooleanAttr(Array.isArray(__props.form.category) ? ssrLooseContain(__props.form.category, "") : ssrLooseEqual(__props.form.category, "")) ? " selected" : ""}${_scopeId}>${ssrInterpolate(_ctx.$t("select_placeholder", "Pilih..."))}</option><!--[-->`);
            ssrRenderList(availableCategories.value, (catSlug) => {
              _push2(`<option${ssrRenderAttr("value", catSlug)} data-v-8c4f7469${ssrIncludeBooleanAttr(Array.isArray(__props.form.category) ? ssrLooseContain(__props.form.category, catSlug) : ssrLooseEqual(__props.form.category, catSlug)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(getDetail(catSlug).icon)} ${ssrInterpolate(getDetail(catSlug).name)}</option>`);
            });
            _push2(`<!--]--></select><div class="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400 dark:text-slate-600" data-v-8c4f7469${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5" data-v-8c4f7469${_scopeId}><path d="M19 9l-7 7-7-7" data-v-8c4f7469${_scopeId}></path></svg></div></div></div><div class="relative" data-v-8c4f7469${_scopeId}><label class="block text-[10px] uppercase font-black text-slate-400 dark:text-slate-600 tracking-widest mb-2 transition-colors duration-500" data-v-8c4f7469${_scopeId}>${ssrInterpolate(_ctx.$t("date", "Tanggal"))}</label><button type="button" class="w-full px-4 h-12 rounded-xl border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-indigo-300 dark:hover:border-indigo-500/40 font-bold text-slate-700 dark:text-slate-200 text-sm transition-all flex items-center justify-between transition-colors duration-500" data-v-8c4f7469${_scopeId}><span class="truncate" data-v-8c4f7469${_scopeId}>${ssrInterpolate(dateDisplay.value)}</span><span class="text-slate-400 dark:text-slate-600" data-v-8c4f7469${_scopeId}>📅</span></button>`);
            if (showDatePicker.value) {
              _push2(`<div class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-0 sm:absolute sm:bottom-full sm:right-0 sm:mb-2 sm:origin-bottom-right sm:block sm:inset-auto" data-v-8c4f7469${_scopeId}><div class="fixed inset-0 bg-slate-900/40 dark:bg-black/60 backdrop-blur-sm sm:hidden" data-v-8c4f7469${_scopeId}></div>`);
            ...
            _push2(`</div></div></div><div class="px-6 md:px-8 py-5 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 flex gap-3 z-20 shrink-0 transition-colors duration-500" data-v-8c4f7469${_scopeId}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (__props.form.processing) {
                    _push3(`<span class="flex items-center gap-2" data-v-8c4f7469${_scopeId2}><svg class="animate-spin h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" data-v-8c4f7469${_scopeId2}><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-8c4f7469${_scopeId2}></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-8c4f7469${_scopeId2}></path></svg></span>`);
                  } else {
                    _push3(`<span data-v-8c4f7469${_scopeId2}>${ssrInterpolate(_ctx.$t("btn_save", "Simpan Transaksi"))}</span>`);
                  }
                } else {
                  return [
            ...
            return [
              createVNode("div", { class: "bg-slate-50 dark:bg-slate-950 flex flex-col max-h-[85vh] relative overflow-hidden transition-all duration-500 border border-slate-200 dark:border-slate-800 shadow-2xl dark:shadow-none rounded-[2.5rem]" }, [
...
const TransactionModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8c4f7469"]]);
export {
