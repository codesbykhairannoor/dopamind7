    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="bg-white dark:bg-slate-900 rounded-[2.5rem] flex flex-col max-h-[90vh] relative overflow-hidden transition-all duration-500 border border-slate-100 dark:border-slate-800 shadow-2xl" data-v-d8fc075d${_scopeId}>`);
            if (__props.conflictError) {
              _push2(`<div class="absolute top-0 left-0 right-0 bg-rose-500 text-white text-[10px] font-black px-6 py-3.5 text-center animate-in slide-in-from-top-full z-50 shadow-lg flex items-center justify-center gap-2 tracking-[0.05em]" data-v-d8fc075d${_scopeId}><svg class="w-4 h-4 shrink-0 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3" data-v-d8fc075d${_scopeId}><path d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" data-v-d8fc075d${_scopeId}></path></svg><span data-v-d8fc075d${_scopeId}>${ssrInterpolate(__props.conflictError)}</span></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="${ssrRenderClass([{ "mt-12": __props.conflictError }, "px-8 py-6 border-b border-slate-50 dark:border-slate-800 flex justify-between items-center bg-white dark:bg-slate-900 shrink-0 z-20 transition-colors"])}" data-v-d8fc075d${_scopeId}><div class="flex items-center gap-4" data-v-d8fc075d${_scopeId}><div class="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center text-xl text-white shadow-lg shadow-indigo-100" data-v-d8fc075d${_scopeId}> ✨ </div><div data-v-d8fc075d${_scopeId}><h2 class="text-xl font-black text-slate-800 dark:text-white tracking-tight leading-none mb-1 transition-colors" data-v-d8fc075d${_scopeId}>${ssrInterpolate(_ctx.$t("batch_mode_title"))}</h2><p class="text-[10px] text-slate-400 dark:text-slate-600 font-bold tracking-widest transition-colors" data-v-d8fc075d${_scopeId}>${ssrInterpolate(_ctx.$t("modal_new_simple_title", "Collective scheduling"))}</p></div></div><div class="flex items-center gap-3" data-v-d8fc075d${_scopeId}><button type="button" class="hidden sm:flex text-[10px] font-black tracking-widest px-4 py-2 rounded-xl border-2 border-slate-50 dark:border-slate-800 text-slate-400 dark:text-slate-600 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 hover:text-indigo-600 dark:hover:text-indigo-400 hover:border-indigo-100 dark:hover:border-indigo-500/30 transition-all active:scale-95 items-center gap-2" data-v-d8fc075d${_scopeId}><span data-v-d8fc075d${_scopeId}>↩️</span> ${ssrInterpolate(_ctx.$t("btn_single_mode"))}</button><button class="w-10 h-10 rounded-xl bg-slate-50 dark:bg-slate-800 text-slate-400 dark:text-slate-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 hover:text-rose-500 dark:hover:text-rose-400 transition-all active:scale-90 flex items-center justify-center font-bold" data-v-d8fc075d${_scopeId}> ✕ </button></div></div><div class="flex-1 overflow-y-auto custom-scrollbar bg-slate-50/30 dark:bg-slate-950/30 p-4 md:p-8 transition-colors relative" data-v-d8fc075d${_scopeId}>`);
            if (unref(isExplorer)) {
              _push2(`<div class="absolute inset-x-0 inset-y-0 z-40 backdrop-blur-md bg-white/10 dark:bg-slate-900/10 flex items-center justify-center p-8 text-center animate-in fade-in duration-700" data-v-d8fc075d${_scopeId}><div class="max-w-xs space-y-6" data-v-d8fc075d${_scopeId}><div class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-2xl flex items-center justify-center mx-auto text-2xl shadow-xl shadow-indigo-500/30" data-v-d8fc075d${_scopeId}> ✨ </div><div data-v-d8fc075d${_scopeId}><h3 class="text-xl font-black text-slate-800 dark:text-white mb-2 leading-tight" data-v-d8fc075d${_scopeId}>Master your focus with batch mode</h3><p class="text-sm font-bold text-slate-500 dark:text-slate-400 mb-6 leading-relaxed" data-v-d8fc075d${_scopeId}> Experience high-velocity scheduling. Plan your entire day in seconds with the architect power. </p>`);
            ...
            _push2(`<div class="hidden md:grid grid-cols-12 gap-4 mb-4 px-2 text-[10px] font-bold text-slate-400 dark:text-slate-500 tracking-widest" data-v-d8fc075d${_scopeId}><div class="col-span-5 ml-1" data-v-d8fc075d${_scopeId}>${ssrInterpolate(_ctx.$t("col_activity"))} <span class="text-rose-500" data-v-d8fc075d${_scopeId}>*</span></div><div class="col-span-2 text-center" data-v-d8fc075d${_scopeId}>${ssrInterpolate(_ctx.$t("col_start"))}</div><div class="col-span-2 text-center" data-v-d8fc075d${_scopeId}>${ssrInterpolate(_ctx.$t("col_end"))}</div><div class="col-span-2 text-center" data-v-d8fc075d${_scopeId}>${ssrInterpolate(_ctx.$t("col_priority"))}</div><div class="col-span-1" data-v-d8fc075d${_scopeId}></div></div><div class="${ssrRenderClass([{ "pointer-events-none": unref(isExplorer) }, "space-y-4 md:space-y-3 mt-2"])}" data-v-d8fc075d${_scopeId}><!--[-->`);
            ssrRenderList(__props.form.tasks, (task, index) => {
              _push2(`<div class="bg-white dark:bg-slate-900 md:bg-transparent p-5 md:p-0 rounded-[2rem] md:rounded-none border border-slate-100 dark:border-slate-800 md:border-none shadow-sm md:shadow-none animate-in fade-in slide-in-from-bottom-4 duration-500 group transition-colors" data-v-d8fc075d${_scopeId}><div class="grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-4 items-center md:bg-white md:dark:bg-slate-900 md:p-2.5 md:rounded-2xl md:border md:border-slate-200 md:dark:border-slate-800 md:shadow-sm" data-v-d8fc075d${_scopeId}><div class="col-span-12 md:col-span-5" data-v-d8fc075d${_scopeId}><label class="md:hidden text-[9px] font-bold text-slate-400 dark:text-slate-500 mb-1.5 ml-1 block" data-v-d8fc075d${_scopeId}>${ssrInterpolate(_ctx.$t("col_activity"))}</label>`);
              ...
              }, "w-full border-2 border-slate-200 dark:border-slate-800 rounded-xl text-[10px] py-3 md:py-2.5 pl-3 pr-8 font-bold text-slate-700 dark:text-slate-200 focus:border-indigo-500 focus:ring-0 bg-slate-50 dark:bg-slate-950 appearance-none cursor-pointer transition-all"])}" data-v-d8fc075d${_scopeId}><option${ssrRenderAttr("value", 1)} class="dark:bg-slate-900" data-v-d8fc075d${ssrIncludeBooleanAttr(Array.isArray(task.type) ? ssrLooseContain(task.type, 1) : ssrLooseEqual(task.type, 1)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(_ctx.$t("priority_urgent"))}</option><option${ssrRenderAttr("value", 2)} class="dark:bg-slate-900" data-v-d8fc075d${ssrIncludeBooleanAttr(Array.isArray(task.type) ? ssrLooseContain(task.type, 2) : ssrLooseEqual(task.type, 2)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(_ctx.$t("priority_work"))}</option><option${ssrRenderAttr("value", 3)} class="dark:bg-slate-900" data-v-d8fc075d${ssrIncludeBooleanAttr(Array.isArray(task.type) ? ssrLooseContain(task.type, 3) : ssrLooseEqual(task.type, 3)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(_ctx.$t("priority_normal"))}</option></select><div class="absolute inset-y-0 right-3 flex items-center pointer-events-none text-slate-400" data-v-d8fc075d${_scopeId}><svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="4" data-v-d8fc075d${_scopeId}><path d="M19 9l-7 7-7-7" data-v-d8fc075d${_scopeId}></path></svg></div></div></div><div class="col-span-12 md:col-span-1 flex justify-center items-end md:items-center pt-2 md:pt-0 border-t border-slate-50 dark:border-slate-800 md:border-none mt-2 md:mt-0" data-v-d8fc075d${_scopeId}><button type="button"${ssrIncludeBooleanAttr(__props.form.tasks.length <= 1) ? " disabled" : ""} class="${ssrRenderClass([{ "opacity-0 pointer-events-none": __props.form.tasks.length <= 1 }, "w-full md:w-8 h-10 md:h-8 rounded-xl flex items-center justify-center text-slate-400 hover:text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition-all active:scale-95 gap-2"])}" data-v-d8fc075d${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5" data-v-d8fc075d${_scopeId}><path d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-d8fc075d${_scopeId}></path></svg><span class="md:hidden text-[10px] font-bold" data-v-d8fc075d${_scopeId}>Hapus baris ini</span></button></div></div></div>`);
            });
            _push2(`<!--]--></div><button type="button" class="${ssrRenderClass([{ "pointer-events-none opacity-50": unref(isExplorer) }, "mt-8 w-full py-4 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-[1.5rem] text-slate-400 dark:text-slate-600 font-bold text-[10px] hover:border-indigo-400 dark:hover:border-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-white dark:hover:bg-slate-900 transition-all flex items-center justify-center gap-3 group active:scale-95 shadow-sm"])}" data-v-d8fc075d${_scopeId}><span class="w-6 h-6 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 flex items-center justify-center text-xs group-hover:bg-indigo-600 group-hover:text-white transition-all shadow-sm" data-v-d8fc075d${_scopeId}>+</span> ${ssrInterpolate(_ctx.$t("btn_add_another"))}</button></div><div class="px-8 py-6 bg-white dark:bg-slate-900 border-t border-slate-50 dark:border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-4 shrink-0 transition-colors" data-v-d8fc075d${_scopeId}><div class="text-[10px] font-bold text-slate-400 dark:text-slate-600 flex items-center gap-2" data-v-d8fc075d${_scopeId}><span class="w-2 h-2 rounded-full bg-indigo-500" data-v-d8fc075d${_scopeId}></span> ${ssrInterpolate(_ctx.$t("total_label"))} <span class="text-indigo-600 dark:text-indigo-400 text-sm font-black" data-v-d8fc075d${_scopeId}>${ssrInterpolate(__props.form.tasks.length)}</span> ${ssrInterpolate(_ctx.$t("total_suffix"))}</div><div class="flex gap-3 w-full sm:w-auto" data-v-d8fc075d${_scopeId}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (__props.form.processing) {
                    _push3(`<span data-v-d8fc075d${_scopeId2}>${ssrInterpolate(_ctx.$t("btn_saving"))}</span>`);
                  } else {
                    _push3(`<span data-v-d8fc075d${_scopeId2}>${ssrInterpolate(_ctx.$t("btn_save_all"))}</span>`);
                  }
                } else {
                  return [
...
const PlannerBatchModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d8fc075d"]]);
export {
