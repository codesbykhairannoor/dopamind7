...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-full lg:max-w-[96%] mx-auto p-4 md:p-6 lg:p-8 space-y-6 lg:space-y-8 pb-24" data-v-148041ce>`);
      if (__props.synergy) {
        _push(`<div class="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-600 to-indigo-600 rounded-[2.5rem] p-8 md:p-12 text-white flex flex-col md:flex-row justify-between items-start md:items-center gap-8 border border-indigo-700/50 group" data-v-148041ce><div class="absolute top-0 right-0 -mt-20 -mr-20 w-96 h-96 bg-indigo-500/30 rounded-full blur-[100px] group-hover:bg-indigo-400/40 transition-colors duration-1000" data-v-148041ce></div><div class="absolute bottom-0 left-0 -mb-20 -ml-20 w-80 h-80 bg-white/5 rounded-full blur-[80px]" data-v-148041ce></div><div class="relative z-10 w-full md:w-2/3" data-v-148041ce><div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm mb-6 text-sm font-bold text-indigo-100 tracking-wide" data-v-148041ce><div class="w-2 h-2 rounded-full bg-emerald-400 animate-pulse shadow-[0_0_8px_rgba(52,211,153,0.8)]" data-v-148041ce></div> ${ssrInterpolate(__props.synergy.date_formatted)}</div><h2 class="text-4xl md:text-6xl font-black tracking-tight mb-4 bg-gradient-to-r from-white to-white bg-clip-text text-transparent drop-shadow-sm" data-v-148041ce>${ssrInterpolate(_ctx.$t(greetingKey.value))}, <br class="hidden md:block" data-v-148041ce> ${ssrInterpolate(unref(user).name)}! 👋 </h2><p class="text-white text-lg md:text-xl font-medium max-w-2xl leading-relaxed" data-v-148041ce>${ssrInterpolate(_ctx.$t("dash_hero_subtitle"))}</p></div><div class="relative z-10 w-full md:w-auto flex justify-start md:justify-end" data-v-148041ce><div class="relative flex items-center justify-center w-40 h-40 md:w-48 md:h-48 rounded-[2rem] bg-white/5 border border-white/10 backdrop-blur-xl shadow-2xl rotate-3 group-hover:rotate-0 transition-transform duration-500" data-v-148041ce><svg class="absolute inset-0 w-full h-full -rotate-90 p-4" viewBox="0 0 36 36" data-v-148041ce><path class="text-white/10" stroke-width="3" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" data-v-148041ce></path><path class="text-indigo-400 transition-all duration-1000 ease-out drop-shadow-[0_0_10px_rgba(129,140,248,0.8)]" stroke-dasharray="100, 100"${ssrRenderAttr("stroke-dashoffset", 100 - overallScore.value)} stroke-linecap="round" stroke-width="3" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" data-v-148041ce></path></svg><div class="text-center relative" data-v-148041ce><span class="block text-4xl md:text-5xl font-black text-white drop-shadow-md" data-v-148041ce>${ssrInterpolate(overallScore.value)}<span class="text-xl text-indigo-300" data-v-148041ce>%</span></span><span class="block text-[10px] uppercase tracking-widest text-indigo-200 font-bold mt-1" data-v-148041ce>${ssrInterpolate(_ctx.$t("dash_synergy_today"))}</span>`);
        if (props.trend && props.trend.length > 0) {
          _push(`<div class="mt-4 flex items-end justify-center gap-1 h-8 px-2 py-1 bg-white/10 rounded-lg" data-v-148041ce><!--[-->`);
          ssrRenderList(props.trend, (t, i) => {
            _push(`<div class="w-1.5 bg-indigo-300/60 rounded-full transition-all duration-500 hover:bg-white hover:scale-y-125" style="${ssrRenderStyle({ height: Math.max(20, t.score) + "%" })}"${ssrRenderAttr("title", `${t.day}: ${t.score}%`)} data-v-148041ce></div>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<!---->`);
        ...
        _push(`<div class="h-64 md:h-80 bg-slate-200 rounded-[2.5rem] animate-pulse flex items-center px-12" data-v-148041ce><div class="space-y-4 w-2/3" data-v-148041ce><div class="h-8 w-48 bg-slate-300 rounded-full" data-v-148041ce></div><div class="h-16 w-full bg-slate-300 rounded-2xl" data-v-148041ce></div><div class="h-8 w-3/4 bg-slate-300 rounded-xl" data-v-148041ce></div></div></div>`);
      }
      _push(`<div class="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 overflow-hidden" data-v-148041ce>`);
      if (__props.synergy) {
        _push(`<!--[-->`);
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity duration-500 text-8xl -mt-6 -mr-6 grayscale group-hover:grayscale-0" data-v-148041ce${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                name: "habit",
                size: "120",
                "stroke-width": "1.5"
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="relative z-10" data-v-148041ce${_scopeId}><div class="flex justify-between items-start mb-6" data-v-148041ce${_scopeId}><div class="w-14 h-14 bg-indigo-50 text-indigo-500 rounded-2xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-300 border border-indigo-100" data-v-148041ce${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                name: "habit",
                size: "32"
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="bg-indigo-50 text-indigo-700 px-4 py-1.5 rounded-full text-xs font-black tracking-wider shadow-inner" data-v-148041ce${_scopeId}>${ssrInterpolate(__props.synergy.habits.completed)} / ${ssrInterpolate(__props.synergy.habits.total)}</div></div><h3 class="text-2xl font-black text-slate-800 mb-2" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_habit_title"))}</h3><p class="text-slate-500 text-sm font-medium leading-relaxed" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_habit_desc"))}</p></div><div class="relative z-10 mt-8" data-v-148041ce${_scopeId}><div class="flex justify-between text-xs font-bold mb-3" data-v-148041ce${_scopeId}><span class="text-slate-400 uppercase tracking-wider" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_progress"))}</span><span class="text-indigo-600" data-v-148041ce${_scopeId}>${ssrInterpolate(__props.synergy.habits.percent)}%</span></div><div class="w-full bg-slate-100 h-3 rounded-full overflow-hidden shadow-inner" data-v-148041ce${_scopeId}><div class="bg-indigo-500 h-full rounded-full transition-all duration-1000 ease-out relative overflow-hidden" style="${ssrRenderStyle(`width: ${__props.synergy.habits.percent}%`)}" data-v-148041ce${_scopeId}><div class="absolute inset-0 bg-white/20 w-full animate-[shimmer_2s_infinite]" data-v-148041ce${_scopeId}></div></div></div></div>`);
            } else {
              return [
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div data-v-148041ce${_scopeId}><div class="flex justify-between items-center mb-6" data-v-148041ce${_scopeId}><div class="flex items-center gap-4" data-v-148041ce${_scopeId}><div class="w-14 h-14 bg-slate-50 text-indigo-600 rounded-2xl flex items-center justify-center group-hover:-rotate-12 transition-transform duration-300 border border-slate-200" data-v-148041ce${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                name: "planner",
                size: "32"
              }, null, _parent2, _scopeId));
              _push2(`</div><div data-v-148041ce${_scopeId}><h3 class="text-2xl font-black text-slate-800" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_planner_title"))}</h3><p class="text-slate-500 text-sm font-medium mt-1" data-v-148041ce${_scopeId}>${ssrInterpolate(__props.synergy.planner.completed)} ${ssrInterpolate(_ctx.$t("dash_from"))} ${ssrInterpolate(__props.synergy.planner.total)} ${ssrInterpolate(_ctx.$t("dash_tasks_done"))}</p></div></div><div class="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-indigo-50 group-hover:text-indigo-600 transition-colors" data-v-148041ce${_scopeId}><svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5" data-v-148041ce${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" data-v-148041ce${_scopeId}></path></svg></div></div></div><div class="bg-slate-50/80 rounded-[1.5rem] p-5 mt-2 border border-slate-100/50" data-v-148041ce${_scopeId}><p class="text-xs font-black text-indigo-400 uppercase tracking-widest mb-4" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_upcoming"))}</p>`);
              if (__props.synergy.planner.upcoming.length > 0) {
                _push2(`<div class="space-y-3" data-v-148041ce${_scopeId}><!--[-->`);
                ssrRenderList(__props.synergy.planner.upcoming, (task, index) => {
                  _push2(`<div class="flex items-center gap-4 bg-white p-3.5 rounded-xl border border-slate-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] group-hover:border-indigo-100 transition-colors" style="${ssrRenderStyle(`transition-delay: ${index * 75}ms`)}" data-v-148041ce${_scopeId}><span class="text-xs font-black text-indigo-600 bg-indigo-50 px-2.5 py-1.5 rounded-lg shrink-0 border border-indigo-100/50" data-v-148041ce${_scopeId}>${ssrInterpolate(task.start_time || "--:--")}</span><span class="text-sm font-bold text-slate-700 truncate" data-v-148041ce${_scopeId}>${ssrInterpolate(task.title)}</span></div>`);
                });
                _push2(`<!--]--></div>`);
              } else {
                _push2(`<div class="flex flex-col items-center justify-center py-6 text-center" data-v-148041ce${_scopeId}><div class="text-4xl mb-3 drop-shadow-sm" data-v-148041ce${_scopeId}>✨</div><p class="text-slate-500 font-bold text-sm" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_all_tasks_done"))}</p></div>`);
              }
              _push2(`</div>`);
            } else {
              return [
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="absolute -right-6 -bottom-6 opacity-10 group-hover:scale-110 transition-transform duration-700" data-v-148041ce${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                name: "finance",
                size: "160",
                "stroke-width": "1.5"
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="relative z-10" data-v-148041ce${_scopeId}><div class="w-12 h-12 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center mb-6 border border-white/20 group-hover:scale-110 transition-transform" data-v-148041ce${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                name: "finance",
                size: "28"
              }, null, _parent2, _scopeId));
              _push2(`</div><h3 class="text-xl font-black mb-1" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_finance_title"))}</h3><p class="text-indigo-100 text-sm font-medium opacity-90" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_finance_desc"))}</p></div><div class="relative z-10 mt-8 space-y-4" data-v-148041ce${_scopeId}><div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10 shadow-inner" data-v-148041ce${_scopeId}><p class="text-[10px] font-bold text-indigo-200 uppercase tracking-widest mb-1" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_expense"))}</p><h4 class="text-2xl font-black text-white truncate" data-v-148041ce${_scopeId}>${ssrInterpolate(formatRupiah(__props.synergy.finance.expense))}</h4></div>`);
              if (__props.synergy.finance.income > 0) {
                _push2(`<div class="bg-black/20 backdrop-blur-sm rounded-xl p-3 border border-white/5 flex items-center justify-between" data-v-148041ce${_scopeId}><span class="text-[10px] font-bold text-indigo-200 uppercase tracking-widest" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_income"))}</span><span class="text-sm font-black text-emerald-400 drop-shadow-sm" data-v-148041ce${_scopeId}>+ ${ssrInterpolate(formatRupiah(__props.synergy.finance.income))}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="absolute inset-y-0 right-0 w-2/3 bg-gradient-to-l from-indigo-50/80 to-white/0 pointer-events-none" data-v-148041ce${_scopeId}></div><div class="absolute right-0 bottom-0 p-8 opacity-20 translate-x-4 translate-y-4 group-hover:rotate-12 transition-transform duration-700" data-v-148041ce${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                name: "journal",
                size: "120",
                "stroke-width": "1.5"
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="p-8 md:p-10 flex flex-col justify-between h-full relative z-10" data-v-148041ce${_scopeId}><div data-v-148041ce${_scopeId}><div class="w-14 h-14 bg-white text-indigo-600 rounded-2xl flex items-center justify-center mb-6 group-hover:-rotate-6 transition-transform duration-300 border border-slate-100 shadow-sm" data-v-148041ce${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                name: "journal",
                size: "32"
              }, null, _parent2, _scopeId));
              _push2(`</div><h3 class="text-3xl font-black text-slate-800 mb-3" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_journal_title"))}</h3></div><div class="mt-4" data-v-148041ce${_scopeId}>`);
              if (__props.synergy.journal.is_written) {
                _push2(`<div class="bg-indigo-50/50 border border-indigo-100/50 p-6 rounded-2xl backdrop-blur-sm" data-v-148041ce${_scopeId}><p class="text-slate-600 font-medium leading-relaxed" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_journal_written"))} <span class="text-2xl ml-2 align-middle drop-shadow-sm" data-v-148041ce${_scopeId}>${ssrInterpolate(__props.synergy.journal.mood === "happy" ? "😄" : "✨")}</span></p><div class="mt-4 inline-flex items-center text-sm font-black text-indigo-600 tracking-wide uppercase" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_journal_continue"))} <span class="ml-2 group-hover:translate-x-1 transition-transform" data-v-148041ce${_scopeId}>→</span></div></div>`);
              } else {
                _push2(`<div class="bg-slate-50 border border-slate-100 p-6 rounded-2xl group-hover:bg-indigo-50/50 group-hover:border-indigo-100/50 transition-colors" data-v-148041ce${_scopeId}><p class="text-slate-600 font-medium leading-relaxed italic" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_journal_prompt"))}</p><div class="mt-4 inline-flex items-center text-sm font-black text-indigo-600 tracking-wide uppercase" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_journal_start"))} <span class="ml-2 group-hover:translate-x-1 transition-transform" data-v-148041ce${_scopeId}>→</span></div></div>`);
              }
              _push2(`</div></div>`);
            } else {
              return [
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div data-v-148041ce${_scopeId}><div class="flex justify-between items-center mb-8" data-v-148041ce${_scopeId}><div class="flex items-center gap-4" data-v-148041ce${_scopeId}><div class="w-14 h-14 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-indigo-100" data-v-148041ce${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                name: "calendar",
                size: "32"
              }, null, _parent2, _scopeId));
              _push2(`</div><div data-v-148041ce${_scopeId}><h3 class="text-2xl font-black text-slate-800" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_calendar_title"))}</h3><p class="text-slate-500 text-sm font-medium mt-1" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_calendar_desc"))}</p></div></div></div></div><div class="bg-slate-50/80 rounded-[1.5rem] p-5 border border-slate-100/50 h-full" data-v-148041ce${_scopeId}>`);
              if (__props.synergy.events.length > 0) {
                _push2(`<div class="space-y-4" data-v-148041ce${_scopeId}><!--[-->`);
                ssrRenderList(__props.synergy.events, (evt, i) => {
                  _push2(`<div class="flex gap-4 items-start bg-white p-3.5 rounded-xl border border-slate-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] group-hover:border-indigo-100 transition-colors" style="${ssrRenderStyle(`transition-delay: ${i * 100}ms`)}" data-v-148041ce${_scopeId}><div class="w-3 h-3 rounded-full bg-indigo-500 mt-1.5 shrink-0 shadow-[0_0_10px_rgba(99,102,241,0.6)] animate-pulse" data-v-148041ce${_scopeId}></div><div data-v-148041ce${_scopeId}><p class="text-sm font-black text-slate-700 leading-snug" data-v-148041ce${_scopeId}>${ssrInterpolate(evt.title)}</p><p class="text-[10px] font-bold text-indigo-400 uppercase tracking-widest mt-1" data-v-148041ce${_scopeId}>${ssrInterpolate(evt.start_date === evt.end_date ? _ctx.$t("dash_today_only") : _ctx.$t("dash_ongoing"))}</p></div></div>`);
                });
                _push2(`<!--]--></div>`);
              } else {
                _push2(`<div class="h-full flex flex-col items-center justify-center py-6 text-center" data-v-148041ce${_scopeId}><div class="text-4xl mb-3 opacity-50 grayscale drop-shadow-sm group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-500" data-v-148041ce${_scopeId}>🏖️</div><p class="text-slate-500 font-bold text-sm" data-v-148041ce${_scopeId}>${ssrInterpolate(_ctx.$t("dash_no_events"))}</p></div>`);
              }
              _push2(`</div>`);
            } else {
              return [
        ...
        ssrRenderList(5, (i) => {
          ...
          ])}" data-v-148041ce><div class="w-14 h-14 bg-slate-300 rounded-2xl mb-6" data-v-148041ce></div><div class="h-8 w-1/2 bg-slate-300 rounded-lg mb-4" data-v-148041ce></div><div class="h-20 w-full bg-slate-300 rounded-xl" data-v-148041ce></div></div>`);
        });
        _push(`<!--]-->`);
      }
      _push(`</div></div><!--]-->`);
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-148041ce"]]);
export {
