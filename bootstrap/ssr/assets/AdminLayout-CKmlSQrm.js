...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="flex flex-col"${_scopeId}><span class="text-lg font-bold text-slate-900 dark:text-white tracking-tight"${_scopeId}>OneForMind</span><span class="text-[10px] font-semibold text-slate-400 uppercase tracking-widest leading-none"${_scopeId}>Admin Console</span></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "flex flex-col" }, [
                ...
                createVNode("span", { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-widest leading-none" }, "Admin Console")
              ])
            ];
          }
        }),
      ...
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("dashboard"),
        class: "mt-3 flex items-center justify-center gap-2 py-3 rounded-xl bg-slate-900 dark:bg-slate-700 text-[10px] font-bold uppercase tracking-wider text-white hover:bg-slate-800 transition-all shadow-md"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$1, {
      ...
      if (isLoading.value) {
        _push(`<div class="absolute inset-0 z-50 bg-white/60 dark:bg-slate-900/60 backdrop-blur-[2px] flex items-center justify-center"><div class="flex flex-col items-center gap-4"><div class="w-10 h-10 border-4 border-indigo-500/20 border-t-indigo-500 rounded-full animate-spin"></div><span class="text-[10px] font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-widest animate-pulse">Syncing...</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<header class="h-20 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700/50 flex items-center justify-between px-10 shrink-0"><div class="flex items-center gap-3"><div class="w-2 h-2 rounded-full bg-indigo-500"></div><h2 class="text-xs font-bold text-slate-500 uppercase tracking-widest">Active Session Control</h2></div><div class="flex items-center gap-4"><div class="flex items-center gap-2 px-4 py-2 bg-emerald-50 dark:bg-emerald-500/10 rounded-full border border-emerald-100 dark:border-emerald-500/20"><span class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span><span class="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider">Operational</span></div></div></header><div class="flex-1 overflow-y-auto p-10 bg-slate-50/50 dark:bg-slate-900">`);
