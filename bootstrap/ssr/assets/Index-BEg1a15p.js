...
import GoalStats from "./GoalStats-DBrE-rYj.js";
import GoalCard from "./GoalCard-D5tQeMSW.js";
import GoalModal from "./GoalModal-CINmz6SP.js";
import _sfc_main$1 from "./GoalHeader-BcxKSHRU.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-full max-w-[1600px] mx-auto p-4 md:p-6 lg:p-8 space-y-8 pb-24 min-w-0">`);
      ...
      if (!isMobile.value) {
        ...
        ssrRenderList(unref(localGoals), (goal) => {
          var _a;
          _push(`<div${ssrRenderAttr("id", "mobile-goal-card-" + goal.id)} class="bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-100 dark:border-slate-800 shadow-xl overflow-hidden group active:scale-[0.98] transition-all duration-500 w-full max-w-full"><div class="relative h-40 overflow-hidden">`);
