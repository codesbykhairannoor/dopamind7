...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex h-screen bg-slate-50 dark:bg-slate-950 font-sans overflow-hidden selection:bg-indigo-500 selection:text-white relative transition-colors duration-500" }, _attrs))} data-v-d4a39aa0><aside class="${ssrRenderClass([isSidebarCollapsed.value ? "w-20" : "w-64", "bg-white dark:bg-slate-900 border-r border-slate-100 dark:border-slate-800 hidden md:flex flex-col z-20 shadow-[4px_0_24px_rgba(0,0,0,0.02)] dark:shadow-none flex-shrink-0 transition-all duration-300 ease-in-out relative"])}" data-v-d4a39aa0><button class="absolute -right-3 top-8 w-6 h-6 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full flex items-center justify-center text-slate-400 hover:text-indigo-600 hover:scale-110 shadow-sm dark:shadow-none transition-all z-30" data-v-d4a39aa0>`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: !isSidebarCollapsed.value ? "chevron-left" : "chevron-right",
        size: "14",
        "stroke-width": "3"
      }, null, _parent));
      _push(`</button><div class="${ssrRenderClass([isSidebarCollapsed.value ? "justify-center" : "justify-start px-8", "h-20 flex items-center px-6 shrink-0"])}" data-v-d4a39aa0>`);
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center transition-transform duration-500 group-hover:rotate-[360deg] shadow-lg shadow-indigo-100 dark:shadow-none shrink-0" data-v-d4a39aa0${_scopeId}><img src="/favicon.svg" alt="Logo" class="w-5 h-5 brightness-0 invert" data-v-d4a39aa0${_scopeId}></div>`);
            if (!isSidebarCollapsed.value) {
              _push2(`<span class="text-lg font-black tracking-tighter text-slate-900 dark:text-white whitespace-nowrap" data-v-d4a39aa0${_scopeId}> OneForMind </span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(`</div><nav class="${ssrRenderClass([isSidebarCollapsed.value ? "px-3" : "px-4", "flex-1 px-3 space-y-1 overflow-y-auto py-4 custom-scrollbar"])}" data-v-d4a39aa0><div class="px-3 pt-2 pb-1" data-v-d4a39aa0><span class="text-[9px] font-bold text-slate-400 dark:text-slate-600 uppercase tracking-widest ml-2" data-v-d4a39aa0>${ssrInterpolate(_ctx.$t("nav_core_modules", "System core"))}</span></div>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("dashboard"),
        prefetch: "",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!isSidebarCollapsed.value) {
              _push2(`<span class="whitespace-nowrap text-sm" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_dashboard"))}</span>`);
            } else {
              _push2(`<!---->`);
            }
            if (_ctx.route().current("dashboard") && !isSidebarCollapsed.value) {
              _push2(`<div class="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-5 bg-indigo-600 rounded-r-full" data-v-d4a39aa0${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_habit"))}</span>`);
              } else {
                _push2(`<!---->`);
              }
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_planner"))}</span>`);
              } else {
                _push2(`<!---->`);
              }
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_finance"))}</span>`);
              } else {
                _push2(`<!---->`);
              }
      ...
      _push(`<div class="px-3 pt-6 pb-1" data-v-d4a39aa0><span class="text-[9px] font-bold text-slate-400 dark:text-slate-600 uppercase tracking-widest ml-2" data-v-d4a39aa0>${ssrInterpolate(_ctx.$t("nav_platinum_suite", "Platinum suite"))}</span></div>`);
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm flex items-center justify-between w-full" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_journal"))} `);
                if (!canAccess("journal")) {
                  _push2(`<div class="w-1.5 h-1.5 rounded-full bg-indigo-400 shadow-[0_0_8px_rgba(129,140,248,0.5)]" data-v-d4a39aa0${_scopeId}></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</span>`);
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm flex items-center justify-between w-full" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_calendar"))} `);
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm flex items-center justify-between w-full" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_jobs"))} `);
                if (!canAccess("job")) {
                  _push2(`<div class="w-1.5 h-1.5 rounded-full bg-indigo-400 shadow-[0_0_8px_rgba(129,140,248,0.5)]" data-v-d4a39aa0${_scopeId}></div>`);
                } else {
                  _push2(`<!---->`);
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (!isSidebarCollapsed.value) {
                _push2(`<span class="whitespace-nowrap text-sm flex items-center justify-between w-full" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_goals"))} `);
                if (!canAccess("goal")) {
                  _push2(`<div class="w-1.5 h-1.5 rounded-full bg-indigo-400 shadow-[0_0_8px_rgba(129,140,248,0.5)]" data-v-d4a39aa0${_scopeId}></div>`);
                } else {
                  _push2(`<!---->`);
      ...
      _push(`</nav><div class="px-4 py-3 shrink-0" data-v-d4a39aa0>`);
      _push(ssrRenderComponent(ThemeToggle, { collapsed: isSidebarCollapsed.value }, null, _parent));
      _push(`</div><div class="px-3 py-3 border-t border-slate-100 dark:border-slate-800 bg-slate-50/30 dark:bg-slate-900/50 space-y-1 shrink-0" data-v-d4a39aa0><div class="${ssrRenderClass([isSidebarCollapsed.value ? "flex-col gap-1 w-10 mx-auto" : "mx-1 gap-1", "flex items-center p-1 bg-slate-100/50 dark:bg-slate-800/50 rounded-xl mb-4 border border-slate-200/50 dark:border-slate-700/50 shadow-inner"])}" data-v-d4a39aa0><button class="${ssrRenderClass([currentLocale.value === "id" ? "bg-white dark:bg-slate-700 text-indigo-600 dark:text-indigo-400 shadow-md dark:shadow-none ring-1 ring-slate-200/50" : "text-slate-400 hover:text-slate-600", "flex-1 py-1.5 rounded-lg text-[10px] font-black transition-all duration-300"])}"${ssrRenderAttr("title", isSidebarCollapsed.value ? "Bahasa Indonesia" : "")} data-v-d4a39aa0> ID </button><button class="${ssrRenderClass([currentLocale.value === "en" ? "bg-white dark:bg-slate-700 text-indigo-600 dark:text-indigo-400 shadow-md dark:shadow-none ring-1 ring-slate-200/50" : "text-slate-400 hover:text-slate-600", "flex-1 py-1.5 rounded-lg text-[10px] font-black transition-all duration-300"])}"${ssrRenderAttr("title", isSidebarCollapsed.value ? "English" : "")} data-v-d4a39aa0> EN </button></div>`);
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!isSidebarCollapsed.value) {
              _push2(`<span class="whitespace-nowrap text-xs font-bold" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_settings"))}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(`<div class="${ssrRenderClass([isSidebarCollapsed.value ? "flex-col gap-2" : "px-2 py-1", "flex items-center justify-between group"])}" data-v-d4a39aa0><div class="flex items-center gap-2.5 min-w-0"${ssrRenderAttr("title", isSidebarCollapsed.value ? (_a = user.value) == null ? void 0 : _a.name : "")} data-v-d4a39aa0>`);
      if ((_b = user.value) == null ? void 0 : _b.avatar_url) {
        _push(`<img${ssrRenderAttr("src", user.value.avatar_url)}${ssrRenderAttr("alt", _ctx.$t("nav_avatar", "Avatar"))} class="w-8 h-8 rounded-full object-cover shadow-sm dark:shadow-none border border-white shrink-0" data-v-d4a39aa0>`);
      } else {
        _push(`<div class="w-8 h-8 rounded-full bg-indigo-600 dark:bg-indigo-500 text-white flex items-center justify-center font-bold text-[10px] shadow-md dark:shadow-none shrink-0" data-v-d4a39aa0>${ssrInterpolate(((_d = (_c = user.value) == null ? void 0 : _c.name) == null ? void 0 : _d.charAt(0).toUpperCase()) || "U")}</div>`);
      }
      if (!isSidebarCollapsed.value) {
        _push(`<div class="flex-1 min-w-0 overflow-hidden" data-v-d4a39aa0><p class="text-[10px] font-bold text-slate-800 dark:text-slate-200 truncate" data-v-d4a39aa0>${ssrInterpolate(((_e = user.value) == null ? void 0 : _e.name) || "User")}</p><p class="text-[9px] font-bold text-slate-400 truncate uppercase tracking-widest" data-v-d4a39aa0>${ssrInterpolate(_ctx.$t("nav_active_account", "Active account"))}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><button type="button" class="w-7 h-7 rounded-full flex items-center justify-center text-slate-400 hover:bg-rose-50 hover:text-rose-500 transition-colors shrink-0"${ssrRenderAttr("title", _ctx.$t("nav_logout", "Keluar"))} data-v-d4a39aa0>`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "logout",
        size: "16",
        "stroke-width": "2.5"
      }, null, _parent));
      _push(`</button></div></div></aside><main class="flex-1 overflow-y-auto relative w-full bg-slate-50/50 dark:bg-slate-950 custom-scrollbar pb-32 md:pb-0 transition-colors duration-500" data-v-d4a39aa0><div class="md:hidden fixed bottom-0 left-0 right-0 z-[60] bg-white/95 dark:bg-slate-900/95 backdrop-blur-3xl border-t border-slate-100 dark:border-slate-800 safe-area-pb transition-colors duration-500 shadow-[0_-8px_30px_rgba(0,0,0,0.06)]" data-v-d4a39aa0><div class="flex items-center justify-around h-20 px-2 pt-1 pb-2" data-v-d4a39aa0>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("dashboard"),
        prefetch: "",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="text-[9px] font-black" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_dashboard"))}</span>`);
          } else {
            return [
              createVNode(_sfc_main$1, {
                name: "dashboard",
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="text-[9px] font-black" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_habit"))}</span>`);
            } else {
              return [
                createVNode(_sfc_main$1, {
                  name: "habit",
      ...
      _push(`<button class="${ssrRenderClass([!canAccess("ai") && !isExplorer.value ? "opacity-40 grayscale" : "", "relative -top-3 lg:-top-5 flex-1 flex flex-col items-center transition-all duration-500"])}" data-v-d4a39aa0><div class="w-14 h-14 lg:w-[4.25rem] lg:h-[4.25rem] bg-slate-900 dark:bg-indigo-600 rounded-2xl lg:rounded-[1.75rem] flex items-center justify-center shadow-lg transition-all active:scale-90 border-[4px] border-white dark:border-slate-950 overflow-hidden group" data-v-d4a39aa0><div class="absolute inset-0 bg-gradient-to-tr from-indigo-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" data-v-d4a39aa0></div>`);
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "sparkles",
        size: 20,
        class: "text-white relative z-10"
      }, null, _parent));
      _push(`</div><div class="flex items-center gap-1 mt-1" data-v-d4a39aa0><span class="text-[8px] font-bold text-indigo-600 dark:text-indigo-400 tracking-tight" data-v-d4a39aa0>${ssrInterpolate(canAccess("ai") ? "Neural OS" : "Platinum OS")}</span></div></button>`);
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="text-[9px] font-black" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_more"))}</span>`);
          } else {
            return [
              createVNode(_sfc_main$1, {
                name: "menu",
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="text-[9px] font-black" data-v-d4a39aa0${_scopeId}>${ssrInterpolate(_ctx.$t("nav_item_settings"))}</span>`);
          } else {
            return [
              createVNode(_sfc_main$1, {
                name: "settings",
      ...
      _push(`</div></div><div class="w-full relative z-0" data-v-d4a39aa0>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></main>`);
      if (showLogoutModal.value) {
        _push(`<div class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6" data-v-d4a39aa0><div class="absolute inset-0 bg-slate-900/40 dark:bg-slate-950/60 backdrop-blur-sm" data-v-d4a39aa0></div><div class="relative bg-white dark:bg-slate-900 w-full max-w-sm rounded-[2.5rem] shadow-2xl dark:shadow-none border border-slate-100 dark:border-slate-800 overflow-hidden transform transition-all animate-in zoom-in-95 duration-300" data-v-d4a39aa0><div class="p-8 text-center" data-v-d4a39aa0><div class="w-20 h-20 bg-rose-50 dark:bg-rose-500/10 text-rose-500 rounded-[2rem] flex items-center justify-center mx-auto mb-6 shadow-inner" data-v-d4a39aa0>`);
        _push(ssrRenderComponent(_sfc_main$1, {
          name: "logout",
          size: "40",
          "stroke-width": "2.5"
        }, null, _parent));
        _push(`</div><h3 class="text-2xl font-black text-slate-800 dark:text-white tracking-tight mb-2" data-v-d4a39aa0>${ssrInterpolate(_ctx.$t("modal_logout_title", "Keluar Akun?"))}</h3><p class="text-slate-500 dark:text-slate-400 text-sm font-medium leading-relaxed" data-v-d4a39aa0>${ssrInterpolate(_ctx.$t("modal_logout_subtitle", "Sesi Anda akan diakhiri."))}</p></div><div class="p-6 bg-slate-50/80 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 flex flex-col gap-3" data-v-d4a39aa0><button class="w-full bg-rose-500 text-white font-black py-4 rounded-2xl shadow-lg shadow-rose-200 dark:shadow-none hover:bg-rose-600 active:scale-[0.98] transition-all" data-v-d4a39aa0>${ssrInterpolate(_ctx.$t("modal_logout_confirm", "Ya, Keluar"))}</button><button class="w-full bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-400 font-bold py-4 rounded-2xl border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-700 active:scale-[0.98] transition-all" data-v-d4a39aa0>${ssrInterpolate(_ctx.$t("modal_logout_cancel", "Batal"))}</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!_ctx.route().current("coach.*")) {
        _push(`<button class="hidden md:block fixed bottom-10 right-10 z-[100] group" data-v-d4a39aa0><div class="relative" data-v-d4a39aa0><div class="absolute inset-0 bg-indigo-500 blur-2xl opacity-20 group-hover:opacity-40 transition-opacity rounded-full" data-v-d4a39aa0></div><div class="${ssrRenderClass([!canAccess("ai") && !isExplorer.value ? "grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100" : "", "relative w-16 h-16 bg-slate-900 dark:bg-indigo-600 rounded-[1.8rem] flex items-center justify-center shadow-2xl transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-2 active:scale-95 ring-4 ring-white dark:ring-slate-950 group-hover:ring-indigo-50 dark:group-hover:ring-indigo-500/20 overflow-hidden"])}" data-v-d4a39aa0><div class="absolute inset-0 bg-gradient-to-tr from-indigo-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" data-v-d4a39aa0></div>`);
        _push(ssrRenderComponent(_sfc_main$1, {
          name: "sparkles",
          size: "28",
          "stroke-width": "2",
        ...
        if (canAccess("ai")) {
          _push(`<span class="absolute top-4 right-4 w-3 h-3 bg-emerald-500 border-2 border-white dark:border-slate-900 rounded-full animate-pulse z-20" data-v-d4a39aa0></span>`);
        } else {
          _push(`<span class="absolute top-4 right-4 w-2 h-2 bg-indigo-400 border border-white dark:border-slate-900 rounded-full shadow-[0_0_8px_rgba(129,140,248,0.5)] z-20" data-v-d4a39aa0></span>`);
        }
        _push(`</div><div class="absolute right-full mr-5 top-1/2 -translate-y-1/2 bg-slate-900 text-white text-[10px] font-bold px-5 py-3 rounded-2xl whitespace-nowrap opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 pointer-events-none shadow-2xl border border-white/10 flex items-center gap-2" data-v-d4a39aa0><span class="w-2 h-2 bg-emerald-500 rounded-full animate-pulse" data-v-d4a39aa0></span> Neural assistant active </div></div></button>`);
      } else {
        _push(`<!---->`);
      }
...
const AuthenticatedLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d4a39aa0"]]);
export {
