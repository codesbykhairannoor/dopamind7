...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AuthenticatedLayout }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="hidden sm:inline text-[11px] font-bold">${ssrInterpolate(_ctx.$t("job_add_row", "Tambah Baris"))}</span></button></div></div></div></div><div class="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-8">`);
